...
import com.redxun.digitization.core.dao.DatamigrationModelprogressDao;
...
@Service
public class DatamigrationModelprogressService {
    private static Logger logger = LoggerFactory.getLogger(DatamigrationModelprogressService.class);
    @Autowired
    private DatamigrationModelprogressDao datamigrationModelprogressDao;
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<JSONObject> businessList = datamigrationModelprogressDao.dataListQuery(params);
        int businessListCount = datamigrationModelprogressDao.countDataListQuery(params);
...
//                    }
    ...
    public JsonResult deleteData(String[] ids) {
        ...
        datamigrationModelprogressDao.deleteData(param);
        return result;
    }
    ...
    public void saveBusiness(JsonResult result, String businessDataStr) {
        ...
        for (Object object : businessObjs) {
            ...
            if (StringUtils.isBlank(businessObj.getString("id"))) {
                ...
                datamigrationModelprogressDao.insertData(businessObj);
            } else {
                businessObj.put("UPDATE_BY_", ContextUtil.getCurrentUserId());
                businessObj.put("UPDATE_TIME_", new Date());
                datamigrationModelprogressDao.updateData(businessObj);
            }
        }
    }
}
