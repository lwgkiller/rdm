...
public class BpmSolution extends BaseTenantEntity implements IRightModel {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.solId, rhs.solId).append(this.name, rhs.name).append(this.key, rhs.key)
            .append(this.defKey, rhs.defKey).append(this.descp, rhs.descp).append(this.status, rhs.status)
            .append(this.helpId, rhs.helpId).append(this.tenantId, rhs.tenantId).append(this.createBy, rhs.createBy)
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(-82280557, -700257973).append(this.solId).append(this.name).append(this.key)
            .append(this.defKey).append(this.descp).append(this.status).append(this.helpId).append(this.tenantId)
    ...
    public String toString() {
        return new ToStringBuilder(this).append("solId", this.solId).append("name", this.name).append("key", this.key)
            .append("defKey", this.defKey).append("descp", this.descp).append("status", this.status)
            .append("helpId", this.helpId).append("tenantId", this.tenantId).append("createBy", this.createBy)
