...
public class BpmNodeJump extends BaseTenantEntity {
    ...
    private String busKeyId;

    public String getBusKeyId() {
        return busKeyId;
    }

    public void setBusKeyId(String busKeyId) {
        this.busKeyId = busKeyId;
    }
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.jumpId, rhs.jumpId).append(this.actDefId, rhs.actDefId)
            .append(this.actInstId, rhs.actInstId).append(this.nodeName, rhs.nodeName).append(this.nodeId, rhs.nodeId)
            .append(this.taskId, rhs.taskId).append(this.completeTime, rhs.completeTime)
            .append(this.duration, rhs.duration).append(this.durationVal, rhs.durationVal)
            .append(this.handlerId, rhs.handlerId).append(this.checkStatus, rhs.checkStatus)
            .append(this.jumpType, rhs.jumpType).append(this.remark, rhs.remark).append(this.tenantId, rhs.tenantId)
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(-82280557, -700257973).append(this.jumpId).append(this.actDefId)
            .append(this.actInstId).append(this.nodeName).append(this.nodeId).append(this.taskId)
            .append(this.completeTime).append(this.duration).append(this.durationVal).append(this.handlerId)
            .append(this.checkStatus).append(this.jumpType).append(this.remark).append(this.tenantId)
    ...
    public String toString() {
        return new ToStringBuilder(this).append("jumpId", this.jumpId).append("actDefId", this.actDefId)
            .append("actInstId", this.actInstId).append("nodeName", this.nodeName).append("nodeId", this.nodeId)
            .append("taskId", this.taskId).append("completeTime", this.completeTime).append("duration", this.duration)
            .append("durationVal", this.durationVal).append("handlerId", this.handlerId)
            .append("checkStatus", this.checkStatus).append("jumpType", this.jumpType).append("remark", this.remark)
            .append("tenantId", this.tenantId).append("createBy", this.createBy).append("createTime", this.createTime)
