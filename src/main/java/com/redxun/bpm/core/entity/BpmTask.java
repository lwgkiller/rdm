...
public class BpmTask extends BaseTenantEntity implements IRightModel, Cloneable {
    ...
    @Column(name = "belongSubSysKey")
    @Size(max = 255)
    protected String belongSubSysKey;
    ...
    public String getBelongSubSysKey() {
        return belongSubSysKey;
    }

    public void setBelongSubSysKey(String belongSubSysKey) {
        this.belongSubSysKey = belongSubSysKey;
    }
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.id, rhs.id).append(this.rev, rhs.rev)
            .append(this.executionId, rhs.executionId).append(this.name, rhs.name)
            .append(this.parentTaskId, rhs.parentTaskId).append(this.description, rhs.description)
            .append(this.taskDefKey, rhs.taskDefKey).append(this.owner, rhs.owner).append(this.assignee, rhs.assignee)
            .append(this.delegation, rhs.delegation).append(this.priority, rhs.priority)
            .append(this.createTime, rhs.createTime).append(this.dueDate, rhs.dueDate)
            .append(this.category, rhs.category).append(this.suspensionState, rhs.suspensionState)
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(-82280557, -700257973).append(this.id).append(this.rev).append(this.executionId)
            .append(this.name).append(this.parentTaskId).append(this.description).append(this.taskDefKey)
            .append(this.owner).append(this.assignee).append(this.delegation).append(this.priority)
            .append(this.createTime).append(this.dueDate).append(this.category).append(this.suspensionState)
            .append(this.tenantId).append(this.formKey).toHashCode();
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", this.id).append("rev", this.rev)
            .append("executionId", this.executionId).append("name", this.name).append("parentTaskId", this.parentTaskId)
            .append("description", this.description).append("taskDefKey", this.taskDefKey).append("owner", this.owner)
            .append("assignee", this.assignee).append("delegation", this.delegation).append("priority", this.priority)
            .append("createTime", this.createTime).append("dueDate", this.dueDate).append("category", this.category)
            .append("suspensionState", this.suspensionState).append("tenantId", this.tenantId)
            .append("formKey", this.formKey).toString();
    }
