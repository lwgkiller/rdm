...
public class BpmInst extends BaseTenantEntity implements IRightModel {
	...
	/* 业务键ID */
	@FieldDefine(title = "是否复活")
	@Column(name = "IS_LIVE_")
	@Size(max = 64)
	protected String isLive = MBoolean.NO.name();
	/* 业务键ID */
	@FieldDefine(title = "复活的流程实例")
	@Column(name = "LIVE_INST_ID_")
	@Size(max = 64)
	protected String liveInstId;
...
//	protected String formInstId;
	...
	public String getLiveInstId() {
		return liveInstId;
	}
	
	public void setLiveInstId(String liveInstId) {
		this.liveInstId = liveInstId;
	}
