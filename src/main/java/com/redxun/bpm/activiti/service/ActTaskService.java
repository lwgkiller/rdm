...
public class ActTaskService {
	...
	public void changeStartDest(String actDefId,String targetNodeId) {
		ProcessDefinitionEntity processDefinition = (ProcessDefinitionEntity)repositoryService.getProcessDefinition(actDefId);
		ActivityImpl curAct= processDefinition.getInitial();
		List<PvmTransition> trans= changeActivityTrans(processDefinition, curAct, targetNodeId);
	}
