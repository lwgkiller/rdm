 ...
 */
@Repository
public interface PortraitTeamWorkDao {
    /**
     * 查询
     *
     * @param params
     ...
     * @return json
     * */
    List<Map<String,Object>> getPersonTeamList(JSONObject jsonObject);
    /**
     * 批量导入
     *
     * @param dataList
     * */
    void batchInsertTeamWork(List<Map<String, Object>> dataList);
}
