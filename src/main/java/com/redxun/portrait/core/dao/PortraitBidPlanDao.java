 ...
 */
@Repository
public interface PortraitBidPlanDao {
    /**
     * 查询
     *
     * @param params
     ...
     * @return json
     * */
    List<Map<String, Object>> getPersonBidPlanList(JSONObject jsonObject);
    /**
     * 批量导入
     *
     * @param dataList
     * */
    void batchInsertBidPlan(List<Map<String, Object>> dataList);
}
