 ...
 */
@Repository
public interface PortraitRewardDao {
    /**
     * 查询
     *
     * @param params
     ...
     * @return json
     * */
    List<Map<String,Object>> getPersonRewardList(JSONObject jsonObject);
    /**
     * 批量导入
     *
     * @param dataList
     * */
    void batchInsertReward(List<Map<String, Object>> dataList);
}
