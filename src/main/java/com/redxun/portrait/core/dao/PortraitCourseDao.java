 ...
 */
@Repository
public interface PortraitCourseDao {
    /**
     * 查询
     *
     * @param params
     ...
     * @return json
     * */
    List<Map<String,Object>> getPersonCourseList(JSONObject jsonObject);
     ...
     * @param dataList
     * */
    void batchInsertCourse(List<Map<String, Object>> dataList);
    /**
     * 删除所有数据先
     * */
