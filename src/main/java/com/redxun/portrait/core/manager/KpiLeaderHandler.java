...
public class KpiLeaderHandler
    ...
    public void processStartPreHandle(ProcessStartCmd processStartCmd) {
        logger.info("KpiLeaderHandler processStartPreHandle");
    ...
    public void endHandle(BpmInst bpmInst) {
        logger.info("KpiLeaderHandler Process EndHandler");
    }
    ...
    public String createOrUpdateByFormData(JSONObject formDataJson) {
        ...
        if (StringUtils.isBlank(formDataJson.getString("id"))) {
            kpiLeaderManager.createKpiLeaderFlow(formDataJson);
        } else {
            kpiLeaderManager.updateKpiLeaderFlow(formDataJson);
        }
