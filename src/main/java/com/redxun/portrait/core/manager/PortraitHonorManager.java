...
import com.redxun.portrait.core.dao.PortraitHonorDao;
 ...
 */
@Service
public class PortraitHonorManager {
    private static final Logger logger = LoggerFactory.getLogger(PortraitHonorManager.class);
    @Resource
    PortraitHonorDao portraitHonorDao;
    @Autowired
    OsUserDao osUserDao;
    @Resource
    ...
    public JsonPageResult<?> query(HttpServletRequest request) {
        ...
        try {
            ...
            list = portraitHonorDao.query(params);
            ...
            params = new HashMap<>(16);
            params = CommonFuns.getSearchParam(params, request, false);
            totalList = portraitHonorDao.query(params);
            convertDate(list);
            // 返回结果
            result.setData(list);
    ...
    public JSONObject add(HttpServletRequest request) {
        ...
        try {
            ...
            portraitHonorDao.addObject(objBody);
        } catch (Exception e) {
    ...
    public JSONObject update(HttpServletRequest request) {
        ...
        try {
            ...
            objBody.put("UPDATE_BY_", ContextUtil.getCurrentUserId());
            objBody.put("UPDATE_TIME_",XcmgProjectUtil.getNowUTCDateStr("yyyy-MM-dd HH:mm:ss"));
            portraitHonorDao.updateObject(objBody);
        } catch (Exception e) {
    ...
    public JSONObject remove(HttpServletRequest request) {
        ...
        try {
            ...
            params.put("ids", idList);
            portraitHonorDao.batchDelete(params);
        } catch (Exception e) {
    ...
    public JSONObject getObjectById(String id){
        return portraitHonorDao.getObjectById(id);
    }
