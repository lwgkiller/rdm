...
public class AttachmentForm  implements java.io.Serializable {
    ...
    public synchronized int hashCode() {
        ...
        if (getFdAttachment() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getFdAttachment(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservice.review.xcmg.kmss.landray.com/", "attachmentForm"));
