...
@Service
@Slf4j
public class XcmgProjectAbolishManager {
    private static Logger logger = LoggerFactory.getLogger(XcmgProjectAbolishManager.class);
    @Resource
    ...
    public void add(Map<String, Object> params) {
        ...
        xcmgProjectAbolishDao.add(params);
    ...
    public void update(Map<String, Object> params) {
        ...
        xcmgProjectAbolishDao.update(params);
    }
    ...
    public JsonResult delete(String[] applyIdArr, String[] instIdArr) {
        ...
        for (int i = 0; i < applyIdArr.length; i++) {
            ...
            xcmgProjectAbolishDao.delete(applyId);
            // 删除实例
    ...
    public JsonPageResult<?> queryList(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            List<Map<String, Object>> applyList = xcmgProjectAbolishDao.queryList(params);
    ...
    public List<Map<String, Object>> filterApplyListByDepRole(List<Map<String, Object>> applyList) {
        ...
        if (ConstantUtil.ADMIN.equals(ContextUtil.getCurrentUser().getUserNo())) {
            for (Map<String, Object> oneApply : applyList) {
                if (oneApply.get("currentProcessUser") != null
                        && oneApply.get("currentProcessUser").toString().contains("管理员")) {
    ...
    public JSONObject getBpmSolution(Map<String, Object> param) {
        ...
        List<Map<String, Object>> list = xcmgProjectAbolishDao.getBmpSolution(param);
    ...
    public JSONObject getAbolishInfo(JSONObject postDataJson, HttpServletResponse response, HttpServletRequest request)
        ...
        List<Map<String, String>> list = xcmgProjectAbolishDao.queryAbolishInfo(params);
        JSONObject resultJson = new JSONObject();
        if (list != null && list.size() > 0) {
