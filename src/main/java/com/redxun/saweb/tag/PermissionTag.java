...
public class PermissionTag extends BodyTagSupport {
    ...
    private String getOutput() throws Exception {
        ...
        } else if ("red".equals(this.tag)) {
            content = getLinkTagRed(canAccess, body);
        } else {
    ...
    /**
     * @lwgkiller权限标签新增获取红色按钮的配置
     */
    private StringBuffer getLinkTagRed(boolean canAccess, String body) {
        StringBuffer content = new StringBuffer("<a class=\"mini-button btn-red\" ");
        if (id != null) {
