 ...
 * 
 * @author csx
 * @Email chshxuan@163.com 版权：广州红迅软件有限公司 本源代码受软件著作法保护，请在授权允许范围内使用
 */
public class WebAppUtil implements ApplicationContextAware {
    ...
    private static PropertyPlaceholderConfigurerExt i18nEnProperties = null;

    private static PropertyPlaceholderConfigurerExt i18nZhProperties = null;

    @Override
    public void setApplicationContext(ApplicationContext ctx) {
        applicationContext = ctx;
        // 加载其配置项信息
        configProperties = ctx.getBean("configProperties", PropertyPlaceholderConfigurerExt.class);
        i18nEnProperties = ctx.getBean("i18nEnProperties", PropertyPlaceholderConfigurerExt.class);
        i18nZhProperties = ctx.getBean("i18nZhProperties", PropertyPlaceholderConfigurerExt.class);
    }
    ...
    /**
     * 获得当前Saas中的管理组织机构的域名，该域名下的管理员具有超级权限， 可以管理其他组织架构的数据
     * 
     * @return
     * @throws Exception
     */
    ...
    public static String getI18nEn(String key) {
        String str = i18nEnProperties.getProperty(key);
        if (str == null)
            return "";
        return str;
    }

    public static String getI18nEn(String key, String defaultVal) {
        String str = i18nEnProperties.getProperty(key);
        if (StringUtil.isEmpty(str))
            return defaultVal;
        return str;
    ...
    public static String getI18nZh(String key) {
        String str = i18nZhProperties.getProperty(key);
        if (str == null)
            return "";
        return str;
    }

    public static String getI18nZh(String key, String defaultVal) {
        String str = i18nZhProperties.getProperty(key);
        if (StringUtil.isEmpty(str))
            return defaultVal;
        return str;
