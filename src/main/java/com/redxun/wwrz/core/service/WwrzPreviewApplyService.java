...
@Service
@Slf4j
public class WwrzPreviewApplyService {
    private static Logger logger = LoggerFactory.getLogger(WwrzPreviewApplyService.class);
    @Resource
    ...
    public void add(Map<String, Object> params) {
        ...
        wwrzPreviewApplyDao.add(params);
    }
    ...
    public JsonResult delete(String[] applyIdArr, String[] instIdArr) {
        ...
        for (int i = 0; i < applyIdArr.length; i++) {
            ...
            wwrzPreviewApplyDao.delete(applyId);
            // 删除实例
    ...
    public JsonPageResult<?> queryList(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            List<Map<String, Object>> applyList = wwrzPreviewApplyDao.queryList(params);
