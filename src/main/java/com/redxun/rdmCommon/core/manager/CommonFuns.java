...
public class CommonFuns {
    ...
    public static String getNowLocalDateStr(String formatStr) {
        ...
        String result = DateUtil.formatDate(DateUtil.parseDate(todayStart, formatStr), formatStr);
        return result;
    }
    ...
    /**
     * 处理历史数据 过滤部门 如果部门fromDeptName存在，则取，不然取fromDeptId
     */
     ...
     * 构造字典项
     */
    public static void getCategoryName2Id(Map<String, Object> categoryName2Id,
        List<Map<String, Object>> categoryInfos) {
     ...
     * 构造字典项
     */
    public static void getCategoryKey2Text(Map<String, Object> categoryName2Id,
        List<Map<String, Object>> categoryInfos) {
        if (categoryInfos != null && !categoryInfos.isEmpty()) {
            for (Map<String, Object> oneMap : categoryInfos) {
