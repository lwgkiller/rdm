 ...
 */
@Service
public class InfoPaperManager {
    private static final Logger logger = LoggerFactory.getLogger(InfoPaperManager.class);
    @Resource
    InfoAuthConfigDao infoAuthConfigDao;
    @Resource
    InfoPaperDao infoPaperDao;
    public JsonPageResult<?> query(HttpServletRequest request) {
        ...
        try {
            ...
            list = infoPaperDao.query(params);
            params = new HashMap<>(16);
            params = CommonFuns.getSearchParam(params, request, false);
            totalList = infoPaperDao.query(params);
    ...
    public JSONObject getObjectById(String id){
        return infoPaperDao.getObjectById(id);
    }
    ...
    public JSONObject add(HttpServletRequest request) {
        ...
        try {
            ...
            infoPaperDao.addObject(objBody);
        } catch (Exception e) {
    ...
    public JSONObject update(HttpServletRequest request) {
        ...
        try {
            ...
            infoPaperDao.updatePaper(objBody);
        } catch (Exception e) {
    ...
    public JSONObject remove(HttpServletRequest request) {
        ...
        try {
            ...
            infoPaperDao.batchDelete(params);
        } catch (Exception e) {
