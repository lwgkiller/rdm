 ...
 */
@Service
public class InfoNewsManager {
    private static final Logger logger = LoggerFactory.getLogger(InfoNewsManager.class);
    @Resource
    ...
    public JsonPageResult<?> query(HttpServletRequest request) {
        ...
        try {
            ...
            list = infoNewsDao.query(params);
            params = new HashMap<>(16);
            params = CommonFuns.getSearchParam(params, request, false);
            totalList = infoNewsDao.query(params);
    ...
    public JSONObject getObjectById(String id){
        return infoNewsDao.getObjectById(id);
    }

    public void doSpider(String infoTypeName, String deptId) {
    ...
    public JSONObject update(HttpServletRequest request) {
        ...
        try {
            ...
            infoNewsDao.updateNews(objBody);
        } catch (Exception e) {
            logger.error("Exception in update 更新常", e);
    ...
    public JSONObject remove(HttpServletRequest request) {
        ...
        try {
            ...
            infoNewsDao.batchDelete(params);
        } catch (Exception e) {
            logger.error("Exception in update 删除新闻", e);
            return ResultUtil.result(false, "删除新闻异常！", "");
        }
