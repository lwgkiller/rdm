 ...
 */
@Service
public class InfoProductManager {
    private static final Logger logger = LoggerFactory.getLogger(InfoProductManager.class);
    @Resource
    InfoProductDao infoProductDao;
    @Resource
    ...
    public JsonPageResult<?> query(HttpServletRequest request) {
        ...
        try {
            ...
            list = infoProductDao.query(params);
            params = new HashMap<>(16);
            params = CommonFuns.getSearchParam(params, request, false);
            totalList = infoProductDao.query(params);
    ...
    public JSONObject getObjectById(String id){
        return infoProductDao.getObjectById(id);
    }
    ...
    public JSONObject add(HttpServletRequest request) {
        ...
        try {
            ...
            infoProductDao.addObject(objBody);
        } catch (Exception e) {
    ...
    public JSONObject update(HttpServletRequest request) {
        ...
        try {
            ...
            infoProductDao.updateProduct(objBody);
        } catch (Exception e) {
    ...
    public JSONObject remove(HttpServletRequest request) {
        ...
        try {
            ...
            infoProductDao.batchDelete(params);
        } catch (Exception e) {
