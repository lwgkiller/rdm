 ...
 */
@Service
public class InfoStandardManager {
    private static final Logger logger = LoggerFactory.getLogger(InfoStandardManager.class);
    @Resource
    InfoAuthConfigDao infoAuthConfigDao;
    @Resource
    InfoStandardDao infoStandardDao;
    public JsonPageResult<?> query(HttpServletRequest request) {
        ...
        try {
            ...
            list = infoStandardDao.query(params);
            params = new HashMap<>(16);
            params = CommonFuns.getSearchParam(params, request, false);
            totalList = infoStandardDao.query(params);
    ...
    public JSONObject getObjectById(String id){
        return infoStandardDao.getObjectById(id);
    }
    ...
    public JSONObject add(HttpServletRequest request) {
        ...
        try {
            ...
            infoStandardDao.addObject(objBody);
        } catch (Exception e) {
    ...
    public JSONObject update(HttpServletRequest request) {
        ...
        try {
            ...
            infoStandardDao.updateStandard(objBody);
        } catch (Exception e) {
    ...
    public JSONObject remove(HttpServletRequest request) {
        ...
        try {
            ...
            infoStandardDao.batchDelete(params);
        } catch (Exception e) {
