 ...
 */
public class SpiderNewsContent implements PageProcessor {
    private Logger logger = Logger.getLogger(SpiderNewsContent.class);
    private Site site = Site.me().setUserAgent(
        "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_2) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.65 Safari/537.31")
        .setRetryTimes(3).setSleepTime(1000).setTimeOut(1000);
    private JSONObject configObj;

    public SpiderNewsContent() {}

    public SpiderNewsContent(JSONObject configObj) {
