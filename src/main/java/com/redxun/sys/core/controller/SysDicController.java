...
public class SysDicController extends BaseListController {
    ...
    @Deprecated
    @RequestMapping("getByTreeKeyTopOne")
    @ResponseBody
    public List<SysDic> getByTreeKeyTopOne(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String dicKey = request.getParameter("dicKey");
        return sysDicManager.getByTreeKeyTopOne(dicKey);
    }
    ...
    @ResponseBody
    public List<SysDic> getByParentId(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String parentId = request.getParameter("parentId");
        return sysDicManager.getByParentId(parentId);
    }
}
