...
//            所有的模块都通过跳转的方式访问，例子：   /redirectOut.do?url=http://10.15.9.21:8080/rdm/rdmLoginSSO.do?actSysKey=GKGFFX
            subsystem.setHomeUrl("/redirectOut.do?url="+subsystem.getIp_port()+"/rdmLoginSSO.do?actSysKey="+subsystem.getKey());
