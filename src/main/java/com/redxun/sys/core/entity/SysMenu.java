...
public class SysMenu extends BaseTenantEntity {
    ...
    @Column(name = "gnStatus")
    protected String gnStatus;
    @Column(name = "DESCP_")
    protected String descp;
    @Column(name = "onlineTime")
    protected String onlineTime;
    @Column(name = "developUser")
    protected String developUser;
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.menuId, rhs.menuId).append(this.name, rhs.name)
            .append(this.iconCls, rhs.iconCls).append(this.parentId, rhs.parentId).append(this.depth, rhs.depth)
            .append(this.path, rhs.path).append(this.sn, rhs.sn).append(this.url, rhs.url)
            .append(this.showType, rhs.showType).append(this.createBy, rhs.createBy)
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(-82280557, -700257973).append(this.menuId).append(this.name).append(this.iconCls)
            .append(this.parentId).append(this.depth).append(this.path).append(this.sn).append(this.url)
            .append(this.showType).append(this.createBy).append(this.createTime).append(this.updateBy)
    ...
    public String toString() {
        return new ToStringBuilder(this).append("menuId", this.menuId).append("name", this.name)
            .append("icon", this.iconCls).append("parentId", this.parentId).append("depth", this.depth)
            .append("path", this.path).append("sn", this.sn).append("url", this.url).append("showType", this.showType)
            .append("createBy", this.createBy).append("createTime", this.createTime).append("updateBy", this.updateBy)
