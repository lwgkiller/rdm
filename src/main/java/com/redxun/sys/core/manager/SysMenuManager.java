...
public class SysMenuManager extends MybatisBaseManager<SysMenu> {
     ...
     * @return
     */
    public List<SysMenu> getBySysIdIsBtnMenu(String sysId, String isBtnMenu, String menuName) {
        return sysMenuDao.getBySysIdIsBtnMenu(sysId, isBtnMenu, menuName);
    }
    ...
    public List<SysMenu> getGrantMenusByGroupId(String groupId,String netType) {
        return sysMenuDao.getGrantMenusByGroupId(groupId,netType);
    }
     ...
     * @return
     */
    public List<SysMenu> getGrantMenusBySysIdGroupIds(String sysId, Collection<String> groupIds, String menuName,boolean netType) {
        return sysMenuDao.getGrantMenusBySysIdGroupIds(sysId, groupIds, menuName,netType);
    }
    ...
    public List<SysMenu> getUrlMenuByTenantMgr(String sysId, String tenantId, String isBtnMenu, String menuName) {
        return sysMenuDao.getUrlMenuByTenantMgr(sysId, tenantId, isBtnMenu, menuName);
    }
