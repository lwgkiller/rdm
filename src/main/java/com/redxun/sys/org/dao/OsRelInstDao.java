...
public class OsRelInstDao extends BaseMybatisDao<OsRelInst> {
    private static final Logger logger = LoggerFactory.getLogger(OsRelInstDao.class);
    ...
    public void delByParty2AndTenantId(String userId, String tenantId) {
        ...
        logger.error("!!!!Delete inst, userId {}", userId);
    ...
    public void deleteByRelTypeId(String relTypeId) {
        logger.error("!!!delete inst,relTypeId {}", relTypeId);
    ...
    public void delByParty2(String party2) {
        logger.error("!!!delete inst, userId {}", party2);
    ...
    public void delByGroupIdUserIdRelTypeId(String groupId, String userId, String relTypeId) {
        ...
        params.put("party2", userId);
        params.put("relTypeId", relTypeId);
        logger.error("!!!delete inst, groupId {},userId {}, relTypeId {}", groupId, userId, relTypeId);
     ...
     * @return
     */
    public List<OsRelInst> getBelongGroupsByUserId(String userId, String tenantId) {
        Map<String, Object> params = new HashMap<String, Object>();
     ...
     * @return
     */
    public List<OsRelInst> getByParty1RelTypeIsMain(String party1, String relType, String isMain) {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("party1", party1);
