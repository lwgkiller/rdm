...
public class OsRelTypeController extends BaseListController {
    ...
    protected QueryFilter getQueryFilter(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(tenantId)) {
            queryFilter.addFieldParam("TENANT_ID_", QueryParam.OP_IN,
                "'" + tenantId + "','" + ITenant.PUBLIC_TENANT_ID + "'");
        } else {
    ...
    // @ResponseBody
    // public List<OsRelType> getRelTypesOfGroupUserId(HttpServletRequest request,HttpServletResponse response) throws
    // Exception{
    ...
    public JsonResult del(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isNotEmpty(uId)) {
            ...
            for (String id : ids) {
                ...
                logger.error("!!!delete inst, relTypeId {}", id);
    ...
    @ResponseBody
    public List<OsRelType> listUserRelsExcludeBelong(HttpServletRequest request, HttpServletResponse response)
        throws Exception {
    ...
    @ResponseBody
    public List<OsRelType> getRelTypesOfGroupUser(HttpServletRequest request, HttpServletResponse response)
        throws Exception {
        String dimId = request.getParameter("dimId");
    ...
    @ResponseBody
    public List<OsRelType> getRelTypesOfGroupGroup(HttpServletRequest request, HttpServletResponse response)
        throws Exception {
        String dimId = request.getParameter("dimId");
        int level = RequestUtil.getInt(request, "level", -1);
        String tenantId = getCurTenantId(request);
    ...
    @ResponseBody
    public List<OsRelType> getGroupUserRelations(HttpServletRequest request, HttpServletResponse response)
        throws Exception {
    ...
    @ResponseBody
    public List<OsRelType> getGroupGroupRelations(HttpServletRequest request, HttpServletResponse response)
        throws Exception {
        String instId = getCurTenantId(request);
