 ...
 * */
@Repository
public interface MonthWorkApplyDao {
    /**
     * 获取申请信息
     * @param id
     * @return
    ...
    * */
    ...
    List<JSONObject> getYdzgApplyInfo(JSONObject jsonObject);
    /**
     * 根据任务获取审批信息
     *
     * @param projectId
     ...
     * @return list
     * */
    List<JSONObject> getUnTaskApplyInfo(String projectId);
    /**
     * 根据任务id获取流程信息
     *
     * @param taskId
     * @return list
     * */
    JSONObject getApplyInfoByTaskId(String taskId);
    /**
     * 根据任务id获取流程信息
     *
     * @param params
     * @return list
     * */
    List<JSONObject> getPlanDeptMonthApply(Map<String, Object> params);
    /**
     * 根据任务id获取流程信息
     *
     * @param params
     * @return list
     * */
    List<JSONObject> getUnDeptMonthApply(Map<String, Object> params);
