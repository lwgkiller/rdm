 ...
 */
@Repository
public interface GzxmProjectInfoDao {
    ...
    * 查询挂图作战list
     ...
     * @return json
    * */
    List<JSONObject> getGzxmList(JSONObject jsonObject);
    /**
     * 查询文件
     *
     * @param jsonObject
     * @return
     */
    List<JSONObject> getFileListByMainId(JSONObject jsonObject);
    /**
     * 新增文件
     *
     * @param params
     ...
     * @return json
     * */
    List<JSONObject> getProjectInfoByName(String subjectName);
}
