...
@Service
@Slf4j
public class NdkfjhAddApplyService {
    private static Logger logger = LoggerFactory.getLogger(NdkfjhAddApplyService.class);
    @Resource
    ...
    public void update(Map<String, Object> params) {
        ...
        ndkfjhAddApplyDao.update(params);
    }
    ...
    public JsonResult delete(String[] applyIdArr, String[] instIdArr) {
        ...
        for (int i = 0; i < applyIdArr.length; i++) {
            ...
            ndkfjhAddApplyDao.delete(applyId);
            // 删除实例
    ...
    public JsonPageResult<?> queryList(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            List<Map<String, Object>> applyList = ndkfjhAddApplyDao.queryList(params);
