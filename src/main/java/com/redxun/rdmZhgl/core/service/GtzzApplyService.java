...
@Service
@Slf4j
public class GtzzApplyService {
    private static Logger logger = LoggerFactory.getLogger(GtzzApplyService.class);
    @Resource
    ...
    public JsonPageResult<?> queryList(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            List<Map<String, Object>> applyList = gtzzApplyDao.queryList(params);
    ...
    public JSONObject getBpmSolution(Map<String, Object> param) {
        ...
        List<Map<String, Object>> list = gtzzApplyDao.getBmpSolution(param);
