...
@Service
@Slf4j
public class NdkfjhMonthApplyService {
    private static Logger logger = LoggerFactory.getLogger(NdkfjhMonthApplyService.class);
    @Resource
    ...
    public void add(Map<String, Object> params) {
        ...
        ndkfjhMonthApplyDao.add(params);
    ...
    public void update(Map<String, Object> params) {
        ...
        ndkfjhMonthApplyDao.update(params);
    }
    ...
    public JsonResult delete(String[] applyIdArr, String[] instIdArr) {
        ...
        for (int i = 0; i < applyIdArr.length; i++) {
            ...
            ndkfjhMonthApplyDao.delete(applyId);
            // 删除实例
    ...
    public JsonPageResult<?> queryList(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            List<Map<String, Object>> applyList = ndkfjhMonthApplyDao.queryList(params);
