 ...
 */
@RestController
@RequestMapping("/zhgl/core/awardGroupProgress/")
public class AwardGroupProgressController {

    private Logger logger = LogManager.getLogger(AwardGroupProgressController.class);

    @Resource
    private AwardGroupProgressService awardGroupProgressService;
    ...
    public ModelAndView listPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "rdmZhgl/core/awardGroupProgress.jsp";
    ...
    public JsonPageResult<?> getCpaList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return awardGroupProgressService.getCpaList(request, response, true);
    }
    ...
    public ModelAndView edit(HttpServletRequest request, HttpServletResponse response) {
        ...
        String jspPath = "rdmZhgl/core/agpManagement.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        ...
        if (StringUtils.isNotBlank(awardId)) {
            Map<String, Object> cpaInfo = awardGroupProgressService.queryAgpById(awardId);
    ...
    public JSONObject saveAgp(HttpServletRequest request, HttpServletResponse response) {
        ...
        awardGroupProgressService.saveAgp(result, request);
        return result;
    }
    ...
    public JsonResult removeLbj(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            if (!ids.isEmpty()){
                awardGroupProgressDao.deleteAgp(param);
    ...
    public JSONObject importExcel(HttpServletRequest request, HttpServletResponse response) {
        JSONObject result = new JSONObject();
        awardGroupProgressService.importMaterial(result, request);
        return result;
    }
    ...
    public ResponseEntity<byte[]> importTemplateDownload(HttpServletRequest request, HttpServletResponse response) {
        return awardGroupProgressService.importTemplateDownload();
    }
    ...
    public  Map<String, Object> getIsLbj(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isLbj = awardGroupProgressService.getIsLbj(chineseName,chineseId);
        if (isLbj){
...
//        String fileId = njjdDao.selectFjIdByNjBaseId(formId);
        String fileBasePath = WebAppUtil.getProperty("agpFilePathBase");
...
//        String fileId = njjdDao.selectFjIdByNjBaseId(formId);
    ...
    public ResponseEntity<byte[]> fileDownload(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (jsjlId == null || "".equals(jsjlId)){
                jsjlId = awardGroupProgressDao.selectAgpByFjId(fileId);
            }
    ...
    @RequestMapping("exportAgpList")
    public void exportExcelAgp(HttpServletRequest request, HttpServletResponse response) {
        awardGroupProgressService.exportAgpList(request, response);
    }
