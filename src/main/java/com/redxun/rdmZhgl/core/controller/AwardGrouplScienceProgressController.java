...
import com.redxun.rdmZhgl.core.service.AwardGrouplScienceProgressService;
 ...
 */
@RestController
@RequestMapping("/zhgl/core/awardGrouplScienceProgress/")
public class AwardGrouplScienceProgressController {

    private Logger logger = LogManager.getLogger(AwardGrouplScienceProgressController.class);

    @Resource
    private AwardGrouplScienceProgressService awardGrouplScienceProgressService;
    ...
    public ModelAndView listPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "rdmZhgl/core/awardGrouplScienceProgressEdit.jsp";
    ...
    @ResponseBody
    public JsonPageResult<?> getCpaList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return awardGrouplScienceProgressService.getCpaList(request, response, true);
    }
    ...
    public ModelAndView edit(HttpServletRequest request, HttpServletResponse response) {
        ...
        String jspPath = "rdmZhgl/core/agspeManagement.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        ...
        if (StringUtils.isNotBlank(awardId)) {
            Map<String, Object> cpaInfo = awardGrouplScienceProgressService.queryAgpById(awardId);
     ...
     * @return
     */
    @RequestMapping("saveAgp")
    @ResponseBody
    public JSONObject saveAgp(HttpServletRequest request, HttpServletResponse response) {
        JSONObject result = new JSONObject();
        awardGrouplScienceProgressService.saveAgp(result, request);
        return result;
    }

    @RequestMapping("deleteAgp")
    @ResponseBody
    public JsonResult removeLbj(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            if (!ids.isEmpty()){
                awardGrouplScienceProgressDao.deleteAgp(param);
    ...
    public JSONObject importExcel(HttpServletRequest request, HttpServletResponse response) {
        JSONObject result = new JSONObject();
        awardGrouplScienceProgressService.importMaterial(result, request);
        return result;
    }
    ...
    public ResponseEntity<byte[]> importTemplateDownload(HttpServletRequest request, HttpServletResponse response) {
        return awardGrouplScienceProgressService.importTemplateDownload();
    }
    ...
    public  Map<String, Object> getIsLbj(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isLbj = awardGrouplScienceProgressService.getIsLbj(chineseName,chineseId);
        if (isLbj){
...
//        String fileId = njjdDao.selectFjIdByNjBaseId(formId);
        String fileBasePath = WebAppUtil.getProperty("agspeFilePathBase");
        return rdmZhglFileManager.pdfPreviewOrDownLoad(fileName, fileId, formId, fileBasePath);
    }

    @RequestMapping("cpaOfficePreview")
    @ResponseBody
...
//        String fileId = njjdDao.selectFjIdByNjBaseId(id);
    ...
    @RequestMapping("cpaImagePreview")
    @ResponseBody
...
//        String fileId = njjdDao.selectFjIdByNjBaseId(formId);
    ...
    public ResponseEntity<byte[]> fileDownload(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (jsjlId == null || "".equals(jsjlId)){
                jsjlId = awardGrouplScienceProgressDao.selectAgpByFjId(fileId);
            }
    ...
    @RequestMapping("exportAgspeList")
    public void exportExcelAgspe(HttpServletRequest request, HttpServletResponse response) {
        awardGrouplScienceProgressService.exportAgspeList(request, response);
    }
