...
import com.redxun.rdmZhgl.core.dao.NdkfjhMonthApplyDao;
import com.redxun.rdmZhgl.core.service.NdkfjhMonthApplyService;
 ...
 */
@Controller
@RequestMapping("/rdmZhgl/core/ndkfjh/month/")
public class NdkfjhMonthApplyController extends MybatisListController {
    @Resource
    private CommonBpmManager commonBpmManager;
    @Resource
    private NdkfjhMonthApplyService ndkfjhMonthApplyService;
    @Resource
    private NdkfjhMonthApplyDao ndkfjhMonthApplyDao;
    ...
    public ModelAndView getListPage(HttpServletRequest request,HttpServletResponse response) throws Exception{
        String jspPath = "rdmZhgl/core/ndkfjhMonthApplyList.jsp";
    ...
    * */
    ...
    public ModelAndView getEditPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "rdmZhgl/core/ndkfjhMonthApplyEdit.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            ...
            List<Map<String, String>> nodeVars = commonBpmManager.queryNodeVarsByParam(nodeId,"NDKFJH_MONTH",null);
        ...
        if (StringUtils.isNotBlank(id)) {
            planApplyObj = ndkfjhMonthApplyDao.getObjectById(id);
    ...
    public JsonPageResult<?> queryList(HttpServletRequest request, HttpServletResponse response) {
        return ndkfjhMonthApplyService.queryList(request, response);
    }
    /**
     * 项目作废表单和流程删除
     * */
    ...
    public JsonResult delete(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (StringUtils.isNotEmpty(uIdStr) && StringUtils.isNotEmpty(instIdStr)) {
                ...
                return ndkfjhMonthApplyService.delete(ids, instIds);
            }
        } catch (Exception e) {
    ...
    public ModelAndView edit(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        JSONObject applyObj = new JSONObject();
        if (StringUtils.isNotBlank(id)) {
            abolishApplyObj = ndkfjhMonthApplyDao.getObjectById(id);
