...
import com.redxun.rdmZhgl.core.service.CityProgressAwardService;
 ...
 */
@RestController
@RequestMapping("/zhgl/core/cityProgressAward/")
public class CityProgressAwardController {

    private Logger logger = LogManager.getLogger(CityProgressAwardController.class);

    @Resource
    private CityProgressAwardService cityProgressAwardService;
    ...
    public ModelAndView listPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "rdmZhgl/core/cityProgressAward.jsp";
    ...
    @RequestMapping("exportMaterialList")
    public void exportExcel(HttpServletRequest request, HttpServletResponse response) {
        cityProgressAwardService.exportMaterialList(request, response);
    }
    ...
    public JsonPageResult<?> getCpaList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return cityProgressAwardService.getCpaList(request, response, true);
    }
    ...
    public ModelAndView edit(HttpServletRequest request, HttpServletResponse response) {
        ...
        String jspPath = "rdmZhgl/core/cpaManagement.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        ...
        if (StringUtils.isNotBlank(awardId)) {
            Map<String, Object> cpaInfo = cityProgressAwardService.queryCpaById(awardId);
     ...
     * @return
     */
    @RequestMapping("saveCpa")
    @ResponseBody
    public JSONObject saveCpa(HttpServletRequest request, HttpServletResponse response) {
        JSONObject result = new JSONObject();
        cityProgressAwardService.saveCpa(result, request);
        return result;
    }

    @RequestMapping("deleteCpa")
    @ResponseBody
    public JsonResult removeLbj(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            if(!ids.isEmpty()) {
                cityProgressAwardDao.deleteCpa(param);
    ...
    public JSONObject importExcel(HttpServletRequest request, HttpServletResponse response) {
        JSONObject result = new JSONObject();
        cityProgressAwardService.importMaterial(result, request);
        return result;
    }
    ...
    public ResponseEntity<byte[]> importTemplateDownload(HttpServletRequest request, HttpServletResponse response) {
        return cityProgressAwardService.importTemplateDownload();
    }
    ...
    public  Map<String, Object> getIsLbj(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isLbj = cityProgressAwardService.getIsLbj(chineseName,chineseId);
        if (isLbj){
...
//        String fileId = njjdDao.selectFjIdByNjBaseId(formId);
        String fileBasePath = WebAppUtil.getProperty("cpaFilePathBase");
...
//        String fileId = njjdDao.selectFjIdByNjBaseId(formId);
    ...
    public ResponseEntity<byte[]> fileDownload(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (jsjlId == null || "".equals(jsjlId)){
                jsjlId = cityProgressAwardDao.selectCpaByFjId(fileId);
            }
    ...
    @RequestMapping("exportCpaList")
    public void exportExcelCpa(HttpServletRequest request, HttpServletResponse response) {
        cityProgressAwardService.exportCpaList(request, response);
    }
