...
import com.redxun.rdmZhgl.core.service.YfjbAbolishApplyService;
 ...
 */
@Controller
@RequestMapping("/rdmZhgl/core/yfjb/abolish/")
public class YfjbAbolishApplyController extends MybatisListController {
    @Resource
    ...
    public ModelAndView getListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "rdmZhgl/core/yfjbAbolishApplyList.jsp";
    ...
    public ModelAndView getEditPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "rdmZhgl/core/yfjbAbolishApplyEdit.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            ...
            List<Map<String, String>> nodeVars = commonBpmManager.queryNodeVarsByParam(nodeId, "YFJB-XMZF", null);
        ...
        if (StringUtils.isNotBlank(id)) {
            planApplyObj = yfjbAbolishApplyDao.getObjectById(id);
    ...
    public JsonPageResult<?> queryList(HttpServletRequest request, HttpServletResponse response) {
        return yfjbAbolishApplyService.queryList(request, response);
    }
    ...
    public JsonResult delete(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (StringUtils.isNotEmpty(uIdStr) && StringUtils.isNotEmpty(instIdStr)) {
                ...
                return yfjbAbolishApplyService.delete(ids, instIds);
            }
        } catch (Exception e) {
    ...
    public ModelAndView edit(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        JSONObject applyObj = new JSONObject();
        if (StringUtils.isNotBlank(id)) {
            abolishApplyObj = yfjbAbolishApplyDao.getObjectById(id);
