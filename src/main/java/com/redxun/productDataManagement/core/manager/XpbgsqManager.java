 ...
 * 型谱变更申请
 *
 * @mh 2023年3月14日14:15:44
 */
@Service
public class XpbgsqManager {
    private static final Logger logger = LoggerFactory.getLogger(XpbgsqManager.class);
    @Resource
    ...
    public JsonPageResult<?> queryApplyList(HttpServletRequest request, boolean doPage) {
        ...
        rdmZhglUtil.addOrder(request, params, "product_spectrum_change_apply_base.CREATE_TIME_", "desc");
        ...
        List<JSONObject> applyList = xpbgsqDao.queryApplyList(params);
    ...
    public JSONObject queryApplyDetail(String id) {
        ...
        params.put("id", id);
        JSONObject obj = xpbgsqDao.queryApplyDetail(params);
        if (obj == null) {
            return result;
        }
    ...
    public void createXpbgsq(JSONObject formData) {
        ...
        // 基本信息
        xpbgsqDao.insertXpbgsq(formData);

    }

    public void updateXpbgsq(JSONObject formData) {
        formData.put("UPDATE_BY_", ContextUtil.getCurrentUserId());
        formData.put("UPDATE_TIME_", new Date());
        // 基本信息
        xpbgsqDao.updateXpbgsq(formData);
    }
    ...
    public void saveUploadFiles(HttpServletRequest request) {
        ...
        try {
            ...
            String filePathBase = sysDicManager.getBySysTreeKeyAndDicKey("pdmUploadPosition", "cpxpbgsq").getValue();
            ...
            xpbgsqDao.insertDemand(fileInfo);
        } catch (Exception e) {
    ...
    public List<JSONObject> queryDemandList(JSONObject params) {
        List<JSONObject> demandList = xpbgsqDao.queryDemandList(params);
        return demandList;
    }
