...
import com.redxun.productDataManagement.core.manager.ZsjbbManager;
 ...
 */
@Controller
@RequestMapping("/productDataManagement/core/zsjbb/")
public class ZsjbbController {
    private static final Logger logger = LoggerFactory.getLogger(ZsjbbController.class);
...
//    private YdgztbScheduler ydgztbScheduler;
    ...
    public ModelAndView getListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String applyList = "productDataManagement/core/zsjbbList.jsp";
...
//        mv.addObject("isSuozhang", isSuozhang);
        ...
        boolean isTbAdmin = rdmZhglUtil.judgeIsPointRoleUser(ContextUtil.getCurrentUserId(), "主数据治理报表管理员");
    ...
    public JsonPageResult<?> queryApplyList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return zsjbbManager.queryApplyList(request, true);
    }
    ...
    public JsonResult deleteApply(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            return zsjbbManager.delApplys(ids);
        } catch (Exception e) {
    ...
    public ModelAndView editPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "productDataManagement/core/zsjbbEdit.jsp";
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            List<Map<String, String>> nodeVars = commonBpmManager.queryNodeVarsByParam(nodeId, "ZSJZLBB", null);
    ...
    public JSONObject queryApplyDetail(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return zsjbbManager.queryApplyDetail(id);
    }
    ...
    public Map<String, Object> upload(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            zsjbbManager.saveUploadFiles(request);
    ...
    public ModelAndView openUploadWindow(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "productDataManagement/core/zsjbbFileUpload.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        String applyId = RequestUtil.getString(request, "applyId", "");
    ...
    public ResponseEntity<byte[]> fileDownload(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            String fileBasePath = sysDicManager.getBySysTreeKeyAndDicKey("pdmUploadPosition", "zsjbb").getValue();
    ...
    public List<JSONObject> fileList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List<JSONObject> fileList = zsjbbManager.queryFileList(params);
...
//            String uIdStr = RequestUtil.getString(request, "ids");
//            String[] ids = uIdStr.split(",");
//            return zsjbbManager.chooseYxal(ids);
//        } catch (Exception e) {
...
//            String uIdStr = RequestUtil.getString(request, "ids");
//            String[] ids = uIdStr.split(",");
//            return zsjbbManager.cancelYxal(ids);
//        } catch (Exception e) {
//            logger.error("Exception in confirmApply", e);
//            return new JsonResult(false, e.getMessage());
//        }
//    }
    ...
    public void exportExcel(HttpServletRequest request, HttpServletResponse response) {
        zsjbbManager.exportExecl(request, response);
    }
    ...
    public JSONObject isExistMonthFlow(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<JSONObject> monthFlowList = zsjbbDao.queryExist(param);
    ...
    public JsonResult saveBusiness(HttpServletRequest request, @RequestBody String formDataStr,
        ...
        try {
            ...
            logger.error("Exception in save zsjbb");
            result.setSuccess(false);
            result.setMessage("Exception in save zsjbb");
            return result;
        }
        return result;
    }
