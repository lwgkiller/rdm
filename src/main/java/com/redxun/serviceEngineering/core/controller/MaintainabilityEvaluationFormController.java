...
import com.redxun.serviceEngineering.core.service.MaintainabilityEvaluationFormService;
...
@Controller
@RequestMapping("/serviceEngineering/core/maintainability/evaluationform")
public class MaintainabilityEvaluationFormController {
    private static final Logger logger = LoggerFactory.getLogger(MaintainabilityEvaluationFormController.class);
    @Autowired
    MaintainabilityEvaluationFormService maintainabilityEvaluationFormService;
    @Autowired
    ...
    public ModelAndView dataListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/maintainabilityEvaluationFormList.jsp";
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        return maintainabilityEvaluationFormService.dataListQuery(request, response);
    }

    //..
    @RequestMapping("editPage")
    public ModelAndView editPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/maintainabilityEvaluationFormEdit.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            ...
            List<Map<String, String>> nodeVars = commonBpmManager.queryNodeVarsByParam(nodeId,"evaluationForm",null);
    ...
    public JsonResult deleteBusiness(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            return maintainabilityEvaluationFormService.deleteBusiness(ids, instIds);
        } catch (Exception e) {
    ...
    public JSONObject getDetail(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isNotBlank(businessId)) {
            jsonObject = maintainabilityEvaluationFormService.getDetail(businessId);
        }
        return jsonObject;
    }
    ...
    public ModelAndView fileUploadWindow(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/maintainabilityEvaluationFormFileUpload.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
    ...
    public Map<String, Object> fileUpload(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            maintainabilityEvaluationFormService.saveUploadFiles(request);
    ...
    public List<JSONObject> getFileList(HttpServletRequest request, HttpServletResponse response) {
        ...
        return maintainabilityEvaluationFormService.getFileList(businessIdList);
    }
    ...
    public void delFile(HttpServletRequest request, HttpServletResponse response, @RequestBody String postBody) {
        ...
        maintainabilityEvaluationFormService.deleteOneBusinessFile(fileId, fileName, businessId);
    }
