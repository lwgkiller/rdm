 ...
 */
@Controller
@RequestMapping("/serviceEngineering/core/jswjsq/")
public class JswjsqController {
    private static final Logger logger = LoggerFactory.getLogger(JswjsqController.class);
    ...
    public ModelAndView getListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jswjsqList = "serviceEngineering/core/jswjsqList.jsp";
        ModelAndView mv = new ModelAndView(jswjsqList);
    ...
    public JsonPageResult<?> queryApplyList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return jswjsqManager.queryApplyList(request, true);
    }
    ...
    public JsonResult deleteApply(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            return jswjsqManager.delApplys(ids);
        } catch (Exception e) {
    ...
    public ModelAndView editPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/jswjsqEdit.jsp";
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            List<Map<String, String>> nodeVars = commonBpmManager.queryNodeVarsByParam(nodeId, "JSWJSQ", null);
    ...
    public JSONObject queryApplyDetail(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return jswjsqManager.queryApplyDetail(id);
    }
    ...
    public JSONObject getUserInfoByPartsType(HttpServletRequest request, HttpServletResponse response)
        throws Exception {
        JSONObject jswjsqObj = new JSONObject();
        String partsType = RequestUtil.getString(request, "partsType");
        if (StringUtils.isNotBlank(partsType)) {
            jswjsqObj = jswjsqManager.getUserInfoByPartsType(partsType);
        }
        return jswjsqObj;
    }
