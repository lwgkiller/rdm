...
import com.redxun.serviceEngineering.core.service.SchematicDownloadApplyService;
...
@Controller
@RequestMapping("/serviceEngineering/core/schematicDownloadApply/")
public class SchematicDownloadApplyController {
    private static final Logger logger = LoggerFactory.getLogger(SchematicDownloadApplyController.class);
    ...
    public ModelAndView getListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String url = "serviceEngineering/core/schematicDownloadApplyList.jsp";
    ...
    public JsonPageResult<?> queryApplyList(HttpServletRequest request, HttpServletResponse response) throws Exception {
         return schematicDownloadApplyService.queryApplyList(request, true);
    }
    ...
    public JsonResult deleteApply(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            return schematicDownloadApplyService.delApplys(ids);
        } catch (Exception e) {
    ...
    public ModelAndView editPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/schematicDownloadApplyEdit.jsp";
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            List<Map<String, String>> nodeVars =
                commonBpmManager.queryNodeVarsByParam(nodeId, "schematicDownloadApply", null);
    ...
    public JSONObject queryApplyDetail(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return schematicDownloadApplyService.queryApplyDetail(id);
    }
...
//    获取原理图列表
    public List<JSONObject> demandList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List<JSONObject> demandList = schematicDownloadApplyService.queryDemandList(params);
        return demandList;
    }
    ...
    public JsonResult saveInProcess(HttpServletRequest request, @RequestBody String data, HttpServletResponse response)
        ...
        schematicDownloadApplyService.saveInProcess(result, data);
        return result;
    }
}
