...
import com.redxun.serviceEngineering.core.service.SparepartsDataCollectService;
...
@Controller
@RequestMapping("/serviceEngineering/core/sparepartsDataCollect")
public class SparepartsDataCollectController {
    private static final Logger logger = LoggerFactory.getLogger(SparepartsDataCollectController.class);
    @Autowired
    ...
    public ModelAndView dataListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/sparepartsDataCollectList.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        mv.addObject("currentUserId", ContextUtil.getCurrentUserId());
        mv.addObject("currentUserNo", ContextUtil.getCurrentUser().getUserNo());
        mv.addObject("currentUserName", ContextUtil.getCurrentUser().getFullname());
        String sparepartsDataCollectAdmin =
                sysDicManager.getBySysTreeKeyAndDicKey("serviceEngineeringGroups", "sparepartsDataCollectAdmin").getValue();
        mv.addObject("sparepartsDataCollectAdmin", sparepartsDataCollectAdmin);
        List<JSONObject> nodeSetListWithName =
                commonBpmManager.getNodeSetListWithName("sparepartsDataCollect", "userTask", "endEvent");
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        return sparepartsDataCollectService.dataListQuery(request, response);
    }

    //..
    @RequestMapping("editPage")
    public ModelAndView editPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/sparepartsDataCollectEdit.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            ...
            List<Map<String, String>> nodeVars =
                    commonBpmManager.queryNodeVarsByParam(nodeId, "sparepartsDataCollect", null);
    ...
    public JsonResult deleteBusiness(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            return sparepartsDataCollectService.deleteBusiness(ids, instIds);
        } catch (Exception e) {
    ...
    public JSONObject getDetail(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isNotBlank(businessId)) {
            jsonObject = sparepartsDataCollectService.getDetail(businessId);
        }
        return jsonObject;
    }
    ...
    public ModelAndView fileUploadWindow(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/sparepartsDataCollectFileUpload.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
    ...
    public Map<String, Object> fileUpload(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            sparepartsDataCollectService.saveUploadFiles(request);
    ...
    public List<JSONObject> getFileList(HttpServletRequest request, HttpServletResponse response) {
        ...
        return sparepartsDataCollectService.getFileList(businessIdList);
    }
    ...
    public void delFile(HttpServletRequest request, HttpServletResponse response, @RequestBody String postBody) {
        ...
        sparepartsDataCollectService.deleteOneBusinessFile(fileId, fileName, businessId);
    }
    ...
    public ResponseEntity<byte[]> PdfPreview(HttpServletRequest request, HttpServletResponse response) {
        ...
        String filePathBase = sysDicManager
                .getBySysTreeKeyAndDicKey("serviceEngineeringUploadPosition", "sparepartsDataCollect").getValue();
    ...
    public void exportExcel(HttpServletRequest request, HttpServletResponse response) {
        sparepartsDataCollectService.exportList(request, response);
    }
}
