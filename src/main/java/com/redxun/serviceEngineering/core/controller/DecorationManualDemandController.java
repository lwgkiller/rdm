...
@Controller
@RequestMapping("/serviceEngineering/core/decorationManualDemand")
public class DecorationManualDemandController {
    private static final Logger logger = LoggerFactory.getLogger(DecorationManualDemandController.class);
    @Autowired
    ...
    public ModelAndView dataListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/decorationManualDemandList.jsp";
        ...
        List<JSONObject> nodeSetListWithName =
                commonBpmManager.getNodeSetListWithName("decorationManualDemand", "userTask", "endEvent");
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        return decorationManualDemandService.dataListQuery(request, response);
    }

    //..
    @RequestMapping("editPage")
    public ModelAndView editPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/decorationManualDemandEdit.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            ...
            List<Map<String, String>> nodeVars =
                    commonBpmManager.queryNodeVarsByParam(nodeId, "decorationManualDemand", null);
        ...
        mv.addObject("isDecorationManualAdmin",
                commonInfoManager.judgeUserIsPointRole("装修手册管理员", ContextUtil.getCurrentUserId()));
        return mv;
    }
    ...
    public JsonResult deleteBusiness(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            return decorationManualDemandService.deleteBusiness(ids, instIds);
        } catch (Exception e) {
    ...
    public JSONObject getDetail(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isNotBlank(businessId)) {
            jsonObject = decorationManualDemandService.getDetail(businessId);
        }
        return jsonObject;
    }
    ...
    public List<JSONObject> getItemList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return decorationManualDemandService.getItemList(params);
    }

    //..
    @RequestMapping("getItemListExp")
    @ResponseBody
    public List<JSONObject> getItemListExp(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String repUserId = RequestUtil.getString(request, "repUserId", "");
        JSONObject params = new JSONObject();
        params.put("repUserId", repUserId);
        return decorationManualDemandService.getItemListExp(params);
    }
    ...
    public JsonResult saveBusiness(HttpServletRequest request, @RequestBody String formDataStr,
        ...
        try {
            ...
            if (StringUtils.isBlank(formDataJson.getString("id"))) {
                decorationManualDemandService.createBusiness(formDataJson);
            } else {
                decorationManualDemandService.updateBusiness(formDataJson);
            }
        } catch (Exception e) {
    ...
    public ModelAndView fileUploadWindow(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/decorationManualDemandFileUpload.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
    ...
    public Map<String, Object> fileUpload(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            decorationManualDemandService.saveUploadFiles(request);
    ...
    public List<JSONObject> getFileList(HttpServletRequest request, HttpServletResponse response) {
        ...
        return decorationManualDemandService.getFileList(businessIdList);
    }
    ...
    public void delFile(HttpServletRequest request, HttpServletResponse response, @RequestBody String postBody) {
        ...
        decorationManualDemandService.deleteOneBusinessFile(fileId, fileName, businessId);
    }
    ...
    public void exportExcel(HttpServletRequest request, HttpServletResponse response) {
        decorationManualDemandService.exportList(request, response);
    }

    //..
    @RequestMapping("createCollect")
    @ResponseBody
    public JsonResult createCollect(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            JSONObject params = new JSONObject();
            params.put("demandId", RequestUtil.getString(request, "demandId"));
            params.put("demandItemId", RequestUtil.getString(request, "demandItemId"));
            params.put("instructions", RequestUtil.getString(request, "instructions"));
            params.put("collectType", RequestUtil.getString(request, "collectType"));
            return decorationManualDemandService.createCollect(params);
        } catch (Exception e) {
    ...
    @ResponseBody
    public JsonResult syncManual(HttpServletRequest request, HttpServletResponse response, @RequestBody String postBody) throws Exception {
        try {
            return decorationManualDemandService.syncManual(postBody);
        } catch (Exception e) {
            logger.error("Exception in syncManual", e);
            return new JsonResult(false, e.getMessage());
        }
    }
}
