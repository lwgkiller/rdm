...
import com.redxun.serviceEngineering.core.service.SparepartsVerificationService;
...
@Controller
@RequestMapping("/serviceEngineering/core/sparepartsVerification")
public class SparepartsVerificationController {
    private static final Logger logger = LoggerFactory.getLogger(SparepartsVerificationController.class);
    @Autowired
    ...
    public ModelAndView dataListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/sparepartsVerificationList.jsp";
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        return sparepartsVerificationService.dataListQuery(request, response);
    }
    ...
    public JsonResult deleteData(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            return sparepartsVerificationService.deleteData(ids);
        } catch (Exception e) {
    ...
    public JsonResult saveBusiness(HttpServletRequest request, @RequestBody String businessDataStr,
        ...
        sparepartsVerificationService.saveBusiness(result, businessDataStr);
        return result;
    }
}
