...
import com.redxun.serviceEngineering.core.service.CustomsDeclarationSupplementService;
...
@Controller
@RequestMapping("/serviceEngineering/core/customsDeclarationSupplement")
public class CustomsDeclarationSupplementController {
    private static final Logger logger = LoggerFactory.getLogger(CustomsDeclarationSupplementController.class);
    @Autowired
    ...
    public ModelAndView dataListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/customsDeclarationSupplementList.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        mv.addObject("currentUserId", ContextUtil.getCurrentUserId());
        mv.addObject("currentUserNo", ContextUtil.getCurrentUser().getUserNo());
        mv.addObject("currentUserName", ContextUtil.getCurrentUser().getFullname());
        List<JSONObject> nodeSetListWithName =
                commonBpmManager.getNodeSetListWithName("customsDeclarationSupplement", "userTask", "endEvent");
    ...
    public ModelAndView editPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/customsDeclarationSupplementEdit.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            ...
            List<Map<String, String>> nodeVars =
                    commonBpmManager.queryNodeVarsByParam(nodeId, "customsDeclarationSupplement", null);
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        return customsDeclarationSupplementService.dataListQuery(request, response);
    }
    ...
    public JsonResult deleteBusiness(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            return customsDeclarationSupplementService.deleteBusiness(ids, instIds);
        } catch (Exception e) {
    ...
    public JSONObject getDetail(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String businessId = RequestUtil.getString(request, "businessId");
        jsonObject = customsDeclarationSupplementService.getDetail(businessId);
        return jsonObject;
    }
    ...
    public void exportItemList(HttpServletRequest request, HttpServletResponse response) {
        customsDeclarationSupplementService.exportItemList(request, response);
    }
    ...
    public JSONObject importItem(HttpServletRequest request, HttpServletResponse response) {
        ...
        customsDeclarationSupplementService.importItem(result, request);
        return result;
    }
}
