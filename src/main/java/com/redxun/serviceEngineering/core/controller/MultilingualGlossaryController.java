...
import com.redxun.serviceEngineering.core.service.MultilingualGlossaryService;
import com.redxun.xcmgProjectManager.core.util.XcmgProjectUtil;

@Controller
@RequestMapping("/serviceEngineering/core/multilingualGlossary")
public class MultilingualGlossaryController {
    ...
    public ModelAndView dataListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/multilingualGlossaryList.jsp";
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        return multilingualGlossaryService.dataListQuery(request, response);
    }

    // ..
    @RequestMapping("editPage")
    public ModelAndView editPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/multilingualGlossaryEdit.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            ...
            List<Map<String, String>> nodeVars =
                commonBpmManager.queryNodeVarsByParam(nodeId, "multilingualGlossary", null);
    ...
    public JsonResult deleteBusiness(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            return multilingualGlossaryService.deleteBusiness(ids, instIds);
        } catch (Exception e) {
    ...
    public JSONObject getDetail(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isNotBlank(businessId)) {
            jsonObject = multilingualGlossaryService.getDetail(businessId);
        }
        return jsonObject;
    }
    ...
    public List<JSONObject> getItemList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String businessId = RequestUtil.getString(request, "businessId", "");
        return multilingualGlossaryService.getItemList(businessId);
    }
    ...
    public JSONObject importExcel(HttpServletRequest request, HttpServletResponse response) {
        ...
        multilingualGlossaryService.importExcel(result, request);
        return result;
    }
