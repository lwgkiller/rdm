 ...
 */
@Controller
@RequestMapping("/serviceEngineering/core/manualFileDownloadApply/")
public class ManualFileDownloadApplyController {
    private static final Logger logger = LoggerFactory.getLogger(ManualFileDownloadApplyController.class);
    @Autowired
    private CommonBpmManager commonBpmManager;
    @Autowired
    private ManualFileDownloadApplyManager manualFileDownloadApplyManager;
    @Resource
    ...
    public ModelAndView getListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String zjManList = "serviceEngineering/core/manualFileDownloadApplyList.jsp";
    ...
    public JsonPageResult<?> queryApplyList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return manualFileDownloadApplyManager.queryApplyList(request, true);
    }
    ...
    public JsonResult deleteApply(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            return manualFileDownloadApplyManager.delApplys(ids);
        } catch (Exception e) {
    ...
    public ModelAndView editPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/manualFileDownloadApplyEdit.jsp";
        ...
        if (StringUtils.isNotBlank(nodeId)) {
            List<Map<String, String>> nodeVars = commonBpmManager.queryNodeVarsByParam(nodeId, "CBSCXZSQ", null);
    ...
    public JSONObject queryApplyDetail(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return manualFileDownloadApplyManager.queryApplyDetail(id);
    }
    ...
    public List<JSONObject> demandList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List<JSONObject> demandList = manualFileDownloadApplyManager.queryDemandList(params);
        return demandList;
    }
    ...
    public List<JSONObject> fileList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List<JSONObject> fileList = manualFileDownloadApplyManager.queryFileList(params);
        return fileList;
    }
    ...
    public JsonResult saveInProcess(HttpServletRequest request, @RequestBody String data, HttpServletResponse response)
        ...
        manualFileDownloadApplyManager.saveInProcess(result, data);
        return result;
    }
    ...
    public ResponseEntity<byte[]> txxyBorrowPreview(HttpServletRequest request, HttpServletResponse response) {
        ...
        String fileBasePath = sysDicManager
            .getBySysTreeKeyAndDicKey("serviceEngineeringUploadPosition", "manualFileDownloadApply").getValue();
        switch (fileType) {
            case "pdf":
    ...
    public void deleteFiles(HttpServletRequest request, HttpServletResponse response, @RequestBody String postBody) {
        ...
        manualFileDownloadApplyDao.deleteFile(param);
        String fileBasePath = sysDicManager
            .getBySysTreeKeyAndDicKey("serviceEngineeringUploadPosition", "manualFileDownloadApply").getValue();
    ...
    public ModelAndView openUploadWindow(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/manualFileDownloadApplyUpload.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        return mv;
    }
    ...
    public Map<String, Object> upload(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            manualFileDownloadApplyManager.saveUploadFiles(request);
