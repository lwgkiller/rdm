...
import com.redxun.serviceEngineering.core.service.HgxFuncArchiveService;
import com.redxun.sys.core.manager.SysDicManager;
import com.redxun.xcmgProjectManager.core.util.XcmgProjectUtil;

@Controller
@RequestMapping("/serviceEngineering/core/funcArchive")
public class HgxFuncArchiveController {
    private static final Logger logger = LoggerFactory.getLogger(HgxFuncArchiveController.class);
    @Autowired
    HgxFuncArchiveService hgxFuncArchiveService;
    ...
    public ModelAndView dataListPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String jspPath = "serviceEngineering/core/hgxFuncArchiveList.jsp";
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        return hgxFuncArchiveService.dataListQuery(request, response);
    }

    // ..
    @RequestMapping("Preview")
    public void Preview(HttpServletRequest request, HttpServletResponse response) {
        hgxFuncArchiveService.Preview(request, response);
    }
    ...
    public ResponseEntity<byte[]> Download(HttpServletRequest request, HttpServletResponse response) {
        ...
        return hgxFuncArchiveService.Download(request, id, description);
    }

    // ..
    @RequestMapping("EditPage")
    public ModelAndView EditPage(HttpServletRequest request, HttpServletResponse response) {
        String jspPath = "serviceEngineering/core/hgxFuncArchiveEdit.jsp";
        ModelAndView mv = new ModelAndView(jspPath);
        String id = RequestUtil.getString(request, "id");
        String action = RequestUtil.getString(request, "action");
        JSONObject obj = new JSONObject();
        if (StringUtils.isNotBlank(id)) {
            obj = hgxFuncArchiveService.queryDataById(id);
        }
    ...
    public JSONObject deleteBusiness(HttpServletRequest request, @RequestBody String requestBody,
        ...
        hgxFuncArchiveService.deleteBusiness(result, id, fileName);
        return result;
    }
    ...
    public JSONObject saveBusiness(HttpServletRequest request, HttpServletResponse response) {
        JSONObject result = new JSONObject();
        hgxFuncArchiveService.saveBusiness(result, request);
        return result;
    }

    @RequestMapping("exportData")
    public void exportData(HttpServletRequest request, HttpServletResponse response) {
        hgxFuncArchiveService.exportData(request, response);
    }
    ...
    public void zipFileDownload(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (filePathList.size() != 0) {
                // 创建临时路径，存放压缩文件
                String downFile = XcmgProjectUtil.getNowUTCDateStr("yyyyMMddHHmmss") + "-Func.zip";
    ...
    public JsonResult updateVersion(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            String id = RequestUtil.getString(request, "id");
            return hgxFuncArchiveService.updateVersion(id);
        } catch (Exception e) {
