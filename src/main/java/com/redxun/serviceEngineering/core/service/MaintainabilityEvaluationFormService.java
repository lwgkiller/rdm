...
@Service
public class MaintainabilityEvaluationFormService {
    private static Logger logger = LoggerFactory.getLogger(MaintainabilityEvaluationFormService.class);
    @Autowired
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<Map<String, Object>> businessList = maintainabilityEvaluationFormDao.dataListQuery(params);
        for (Map<String, Object> business : businessList) {
            ...
            //获取附件名称列表
            List<String> FileNamesList = maintainabilityEvaluationFormDao.getFileNamesListByMainId(business.get("id"));
            //如果有附件名称
        ...
        int businessListCount = maintainabilityEvaluationFormDao.countDataListQuery(params);
...
//                    }
    ...
    public JsonResult deleteBusiness(String[] ids, String[] instIds) {
        ...
        String filePathBase = sysDicManager.getBySysTreeKeyAndDicKey(
                "serviceEngineeringUploadPosition", "evaluationForm").getValue();
        ...
        maintainabilityEvaluationFormDao.deleteBusinessFile(param);
        maintainabilityEvaluationFormDao.deleteBusiness(param);
    ...
    public List<JSONObject> getBusinessFileList(List<String> businessIdList) {
        ...
        businessFileList = maintainabilityEvaluationFormDao.queryFileList(param);
        return businessFileList;
    }

    //..
    public JSONObject getDetail(String businessId) {
        JSONObject jsonObject = maintainabilityEvaluationFormDao.queryDetailById(businessId);
        if (jsonObject == null) {
    ...
    public void createBusiness(JSONObject formData) {
        ...
        maintainabilityEvaluationFormDao.insertBusiness(formData);
    }
    ...
    public void updateBusiness(JSONObject formData) {
        ...
        maintainabilityEvaluationFormDao.updateBusiness(formData);
    }
    ...
    public List<JSONObject> getFileList(List<String> businessIdList) {
        ...
        Map<String, Object> param = new HashMap<>();
        param.put("businessIds", businessIdList);
        fileList = maintainabilityEvaluationFormDao.queryFileList(param);
        return fileList;
    }
    ...
    public void saveUploadFiles(HttpServletRequest request) {
        ...
        try {
            ...
            maintainabilityEvaluationFormDao.addFileInfos(fileInfo);
        } catch (Exception e) {
