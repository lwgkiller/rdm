...
@Service
public class SparepartsVerificationService {
    private static Logger logger = LoggerFactory.getLogger(SparepartsVerificationService.class);
    @Autowired
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<JSONObject> businessList = sparepartsVerificationDao.dataListQuery(params);
        int businessListCount = sparepartsVerificationDao.countDataListQuery(params);
...
//                    }
    ...
    public JsonResult deleteData(String[] ids) {
        ...
        sparepartsVerificationDao.deleteData(param);
        return result;
    }
    ...
    public void saveBusiness(JsonResult result, String businessDataStr) {
        ...
        for (Object object : businessObjs) {
            ...
            if (StringUtils.isBlank(businessObj.getString("id"))) {
                ...
                sparepartsVerificationDao.insertData(businessObj);
            } else {
                businessObj.put("UPDATE_BY_", ContextUtil.getCurrentUserId());
                businessObj.put("UPDATE_TIME_", new Date());
                sparepartsVerificationDao.updateData(businessObj);
            }
        }
    }
    ...
    public Integer getSparepartsVerificationTotal(String postDataStr) {
        ...
        return sparepartsVerificationDao.getSparepartsVerificationTotal(postDataJson);
    }
}
