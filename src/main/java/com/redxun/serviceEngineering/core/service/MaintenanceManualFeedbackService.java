...
@Service
public class MaintenanceManualFeedbackService {
    private static Logger logger = LoggerFactory.getLogger(MaintenanceManualFeedbackService.class);
    @Autowired
    private MaintenanceManualFeedbackDao maintenanceManualFeedbackDao;
    @Autowired
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<Map<String, Object>> businessList = maintenanceManualFeedbackDao.dataListQuery(params);
        ...
        int businessListCount = maintenanceManualFeedbackDao.countDataListQuery(params);
...
//                    }
    ...
    public JsonResult deleteBusiness(String[] ids, String[] instIds) {
        ...
        String filePathBase = sysDicManager.getBySysTreeKeyAndDicKey(
                "serviceEngineeringUploadPosition", "maintenanceManualFeedback").getValue();
        ...
        maintenanceManualFeedbackDao.deleteBusinessFile(param);
        maintenanceManualFeedbackDao.deleteBusiness(param);
    ...
    public List<JSONObject> getBusinessFileList(List<String> businessIdList) {
        ...
        businessFileList = maintenanceManualFeedbackDao.queryFileList(param);
        return businessFileList;
    }

    //..
    public JSONObject getDetail(String businessId) {
        JSONObject jsonObject = maintenanceManualFeedbackDao.queryDetailById(businessId);
        if (jsonObject == null) {
    ...
    //..busunessNo,applyUser,applyDep自动生成
    public void createBusiness(JSONObject formData) {
        formData.put("id", IdUtil.getId());
        formData.put("busunessNo", sysSeqIdManager.genSequenceNo("maintenanceManualFeedback", ContextUtil.getCurrentTenantId()));
        ...
        maintenanceManualFeedbackDao.insertBusiness(formData);
    }
    ...
    public void updateBusiness(JSONObject formData) {
        ...
        maintenanceManualFeedbackDao.updateBusiness(formData);
    }
    ...
    public List<JSONObject> getFileList(List<String> businessIdList) {
        ...
        Map<String, Object> param = new HashMap<>();
        param.put("businessIds", businessIdList);
        fileList = maintenanceManualFeedbackDao.queryFileList(param);
        return fileList;
    }
    ...
    public void saveUploadFiles(HttpServletRequest request) {
        ...
        try {
            ...
            maintenanceManualFeedbackDao.addFileInfos(fileInfo);
        } catch (Exception e) {
