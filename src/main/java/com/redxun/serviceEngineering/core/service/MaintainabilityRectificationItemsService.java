...
@Service
public class MaintainabilityRectificationItemsService {
    private static Logger logger = LoggerFactory.getLogger(MaintainabilityRectificationItemsService.class);
    @Autowired
    ...
    public JsonPageResult<?> dataListQuery(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<Map<String, Object>> businessList = maintainabilityRectificationItemsDao.dataListQuery(params);
        for (Map<String, Object> business : businessList) {
            ...
            //获取附件名称列表
            List<String> FileNamesList = maintainabilityRectificationItemsDao.getFileNamesListByMainId(business.get("id"));
            //如果有附件名称
        ...
        int businessListCount = maintainabilityRectificationItemsDao.countDataListQuery(params);
...
//                    }
    ...
    public JsonResult deleteBusiness(String[] ids, String[] instIds) {
        ...
        String filePathBase = sysDicManager.getBySysTreeKeyAndDicKey(
                "serviceEngineeringUploadPosition", "rectificationItems").getValue();
        ...
        maintainabilityRectificationItemsDao.deleteBusinessFile(param);
        maintainabilityRectificationItemsDao.deleteBusiness(param);
    ...
    public List<JSONObject> getBusinessFileList(List<String> businessIdList) {
        ...
        businessFileList = maintainabilityRectificationItemsDao.queryFileList(param);
        return businessFileList;
    }

    //..
    public JSONObject getDetail(String businessId) {
        JSONObject jsonObject = maintainabilityRectificationItemsDao.queryDetailById(businessId);
        if (jsonObject == null) {
    ...
    public void createBusiness(JSONObject formData) {
        ...
        maintainabilityRectificationItemsDao.insertBusiness(formData);
    }
    ...
    public void updateBusiness(JSONObject formData) {
        ...
        maintainabilityRectificationItemsDao.updateBusiness(formData);
    }
    ...
    public List<JSONObject> getFileList(List<String> businessIdList) {
        ...
        Map<String, Object> param = new HashMap<>();
        param.put("businessIds", businessIdList);
        fileList = maintainabilityRectificationItemsDao.queryFileList(param);
        return fileList;
    }
    ...
    public void saveUploadFiles(HttpServletRequest request) {
        ...
        try {
            ...
            maintainabilityRectificationItemsDao.addFileInfos(fileInfo);
        } catch (Exception e) {
