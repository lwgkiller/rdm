...
<div class="mini-toolbar">
    <div class="searchBox">
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                <li style="margin-right: 15px"><span class="text" style="width:auto">附属机具板块: </span>
                    <input name="fsjjTypeId" class="mini-combobox" onvaluechanged="searchFrm()"
                ...
                <li style="margin-right: 15px"><span class="text" style="width:auto">附属机具类别: </span><input class="mini-textbox" style="width: 150px" name="typeName"/></li>
...
<div class="mini-fit" style="height: 100%;">
    <div id="listGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/gkgf/core/fsjj/listData.do" idField="id"
        ...
        <div property="columns">
            ...
            <div field="plateName" name="plateName" width="120" headerAlign="center" align="center" allowSort="false">附属机具板块</div>
            <div field="typeName" width="120" headerAlign="center" align="center" allowSort="false">附属机具类别</div>
            <div field="sortIndex" width="120" headerAlign="center" align="center" allowSort="false">排序</div>
...
<script type="text/javascript">
    ...
    listGrid.on("load", function () {
        listGrid.mergeColumns(["plateName"]);
    });
    if (!isAdmin) {
    ...
    function addItems() {
        var action = "add";
        let url = jsUseCtxPath + "/gkgf/core/fsjj/editPage.do?action="+action;
        var title = "新增";
        mini.open({
            title: title,
            url: url,
    ...
    function viewForm(id,action) {
        var url= jsUseCtxPath +"/gkgf/core/fsjj/editPage.do?action="+action+"&id="+id;
        var title = "修改";
        if(action=='view'){
            title = "查看";
        }
    ...
    function removeRow() {
        ...
        mini.confirm("确定取消选中记录？", "提示", function (action) {
            if (action != 'ok') {
                ...
                if (ids.length > 0) {
                    _SubmitJson({
                        url: jsUseCtxPath + "/gkgf/core/fsjj/remove.do",
                        method: 'POST',
                        data: {ids: ids.join(',')},
