	...
	<div class="mini-fit" style="height: 100%;">
		<div id="fileGrid" class="mini-datagrid" style="height: 99%" allowResize="false"
			...
			<div property="columns">
				...
				<div field="fileName" align="center" headerAlign="center" >附件名称</div>
				<div field="fileDesc" align="center" headerAlign="center" >描述</div>
				<div field="userName" align="center"  headerAlign="center" >上传人</div>
...
<script type="text/javascript">
	...
	var url=jsUseCtxPath+"/gkgf/core/apply/files.do";
    ...
    function uploadFile() {
		mini.open({
			title: "附件列表",
			url: jsUseCtxPath + "/gkgf/core/apply/fileUploadWindow.do?detailId=" + detailId+"&fileType="+fileType,
			width: 1000,
			height: 500,
			showModal: false,
			allowResize: true,
    ...
    function fileInfoRenderer(e) {
            var record = e.record;
		    var s = '';
            s += returnPreviewSpan(record.fileName, record.id, record.detailId, coverContent,"gkgfFileUrl");
	...
	function deleteFile(record) {
		mini.confirm("确定删除？", "确定？",
				function (action) {
					if (action == "ok") {
						var url = jsUseCtxPath + "/gkgf/core/apply/delFile.do";
						var data = {
	...
	function downFile(record) {
		...
		detailId.attr("value", record.detailId);
		var fileId = $("<input>");
		...
		fileUrl.attr("value", "gkgfFileUrl");
		$("body").append(form);
