...
<body>
								...
								<div class="mini-fit">
									...
									<form id="form1" class="form-outer" style="border:none;">
										<div class="form-inner">
											...
											<table style="width: 100%" class="table-detail column-four table-align" cellpadding="0" cellspacing="1">
												...
												<tr>
													<td>图　　标</td>
													<td>
														<input name="icon" id="icon" value="${bpmSolution.icon}" text="${bpmSolution.icon}" class="mini-buttonedit" onbuttonclick="selectIcon" style="width: 85%"/>
                                                ...
                                                <tr>
                                                    <td>所属应用模块</td>
                                                    <td>
                                                        <input name="belongSubSysKey" id="belongSubSysKey" textField="name"
                                                               valueField="key" emptyText="请选择..."
                                                               value="${bpmSolution.belongSubSysKey}" required="true"
                                                               class="mini-combobox" style="width: 90%"/>
                                                    </td>
                                                </tr>
												<tr>
													<td>解决方案描述</td>
	...
	<script type="text/javascript">
		...
		$(function(){
		    //查询应用模块列表
            $.ajax({
                url: __rootPath + '/sys/core/subsystem/queryAllSubSystem.do',
                type: 'post',
                contentType: 'application/json',
                async:false,
                success: function (returnData) {
                    if (returnData) {
                        mini.get("belongSubSysKey").load(returnData);
                    }
                }
            });
