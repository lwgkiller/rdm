				...
				<table class="table-detail column-two table-align" style="width:100%;">
					...
					<tr class="rtable">
						...
						<td colspan="2" style="text-align: left">
							...
							<span class="del_user">
								<a class="mini-button btn-red"  onclick="clearGroups('rgroupIds')">清空</a>
							</span>
						</td>
					</tr>
					<tr class="rtable">
						...
						<td colspan="2">
							...
							<span class="del_user">
								<a class="mini-button btn-red"  onclick="clearUsers('ruserIds')">清空</a>
							</span>
						</td>
					</tr>
					...
					<tr class="atable">
						...
						<td style="text-align: left;">
							...
							<span class="del_user">
								<a class="mini-button btn-red"  onclick="clearGroups('printAgroupIds')">清空</a>
							</span>
						</td>
					</tr>
					<tr class="atable">
						<td style="text-align: left">
							...
							<span class="del_user">
								<a class="mini-button btn-red"  onclick="clearUsers('printAuserIds')">清空</a>
							</span>
						</td>
					</tr>
					<tr class="atable">
						...
						<td style="text-align: left">
							...
							<span class="del_user">
								<a class="mini-button btn-red"  onclick="clearGroups('downAgroupIds')">清空</a>
							</span>
						</td>
					</tr>
					<tr class="atable">
						<td style="text-align: left">
							...
							<span class="del_user">
								<a class="mini-button btn-red"  onclick="clearUsers('downAuserIds')">清空</a>
							</span>
						</td>
					</tr>
