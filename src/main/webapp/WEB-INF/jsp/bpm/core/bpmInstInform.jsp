...
<link rel="stylesheet" type="text/css" href="${ctxPath}/styles/commons${index}.css">
...
<div class="mini-fit">
	<div class="form-container">
		<div
			...
			<table class="table-detail column-four table-align" border="1" cellspacing="0" cellpadding="0" >
	...
	<script type="text/javascript">
		...
		function discardInst(){
			...
			if(!confirm('项目终止后不可恢复，确定要作废该流程吗?')){
				return;
			}
			_SubmitJson({
