...
<script type="text/javascript">
	...
	function addUser(){
		var url="${ctxPath}/bpm/core/bpmSolUser/edit.do?actDefId=${param.actDefId}&solId=${param.solId}&nodeId=${param.nodeId}&groupType=${param.groupType}&nodeName=${param.nodeName}";
