		...
		<div class="mini-tabs" style="width: 100%; height: 100%;">
			...
			<div title="任务基本信息">
				...
				<table style="width: 100%" class="table-detail column_2_m" cellpadding="0" cellspacing="1">
					...
					<tr>
						<th>事项标题</th>
						<td colspan="3"><a>${bpmTask.description}</a></td>
					</tr>
					<tr>
						<th>流程定义</th>
						<td colspan="3"><a>${bpmDef.subject}</a></td>
					</tr>
					<tr>
						<th>任务名称</th>
						<td>${bpmTask.name}</td>
				...
				<form id="userForm">
					<table style="width: 100%" class="table-detail column_2_m" cellpadding="0" cellspacing="1">
						...
						<tr>
							<th>候选用户</th>
							<td><input id="userLinks" name="userLinks" allowInput="false" class="mini-textboxlist" style="width: 90%;" value="${canUserIds}" text="${canUserNames}" readonly=true /> </td>
							<th>候选用户组</th>
							<td><input id="groupLinks" name="groupLinks" allowInput="false" class="mini-textboxlist" style="width: 90%;" value="${canGroupIds}" text="${canGroupNames}" readonly=true /> </td>
						</tr>
					</table>
				</form>
			</div>
