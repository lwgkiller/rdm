...
<div class="mini-fit">
<div id="configForm" class="form-container" style="width: 100%;height:100%">
	<div id="baseTab" class="mini-tabs" activeIndex="0" style="width: 100%; height: 100%;">
		<div title="选项配置" style="height: 100%" >
			<table class="table-detail column-four table-align" cellspacing="1"
		...
		<div title="事件与接口" >
			...
			<table class="table-detail column-two table-align" cellspacing="1"
				   cellpadding="0" style="width: 100%">
		...
		<div  title="人员配置"
			 url="${ctxPath}/bpm/core/bpmSolution/nodeUser.do?actDefId=${param['actDefId'] }&nodeId=${param['nodeId']}&nodeType=${param['nodeType']}&solId=${param['solId']}&groupType=task&nodeName=${actNodeDef['nodeName']}">
		</div>
		<div title="抄送配置"
		...
		<div  title="节点提醒" >
			<table class="table-detail column-two table-align" cellspacing="1" cellpadding="0" style="width: 100%;padding:5px;">
				<tr>
					<td>节点提醒文字</td>
					<td>
...
<script type="text/javascript">
	...
	var jumpTypeData=[
        ...
        {jumpType:'BACK_SPEC',jumpTypeName:'驳回节点'},
