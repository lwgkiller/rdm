...
<body>
				 ...
				 <div class="mini-toolbar" >
					<div class="searchBox">
					 ...
					 <ul class="toolBtnBox">
						 ...
						 <li>
							 <a class="mini-button"  onclick="onLiveProcess" >流程复活</a>
						 </li>
						 <li>
				...
				<div class="mini-fit rx-grid-fit" style="height: 100%;">
					...
					>
						<div property="columns">
							...
							<div field="treeName" width="60"  >分类</div>
							<div field="billNo" sortField="bill_no_" width="80"  allowSort="true">单号</div>
							<div field="subject" sortField="subject_" width="160"  allowSort="true">事项</div>
							<div field="status" sortField="status_"   width="60"  allowSort="true" renderer="onStatusRenderer">运行状态</div>
							<div field="isLive" sortField="IS_LIVE_"   width="60" headerAlign="" allowSort="true" renderer="onIsLiveRenderer">复活状态</div>
							<div field="taskNodes" width="80"  >当前节点</div>
							<div field="taskNodeUsers"    width="80" >当前节点处理人</div>
							<div field="createBy" sortField="create_by_"  width="60"  allowSort="true">发起人</div>
							<div field="createTime" sortField="create_time_"  width="60"  allowSort="true">创建时间</div>
						</div>
					</div>
				</div>
		    </div>
	...
	winHeight="450" winWidth="700" entityTitle="流程实例"
		...
		<script type="text/javascript">
	        ...
	        function onIsLiveRenderer(e) {
	            var record = e.record;
	            var isLive = record.isLive;
	            
	            var arr = [ {'key' : 'YES','value' : '已复活','css' : 'red'}, 
	   		                {'key' : 'NO','value' : '未复活','css' : 'green'}
	   		             ];
	   		
	   			return $.formatItemValue(arr,isLive);
	        }
	      ...
	      //复活流程实例
	        function onLiveProcess(){
	        	var sel=grid.getSelected();
	        	if(!sel || (sel.status!="SUCCESS_END" && sel.status!="ABORT_END")) {
					mini.alert("无法复活未结束的流程！");
	        		return;
	        	}
	        	if(sel.isLive=="YES"){
	        		mini.alert("无法复活已复活的流程！");
	        		return;
	        	}
	        	_OpenWindow({
	       			iconCls:'icon-group',
	       			title:'复活流程实例['+sel.subject+']',
	       			url:__rootPath+'/bpm/core/bpmInst/liveSelect.do?instId='+sel.instId,
	       			width:700,
	       			height:600,
	       			ondestroy:function(action){
	       				if(action!='ok')return;
	       				...
	       				_SubmitJson({
	    	        		url:__rootPath+'/bpm/core/bpmInst/liveProcess.do',
	    	        		method:'POST',
	    	        		data:{
	    	        			actInstId:sel.actInstId,
