...
<script type="text/html;" id="rightTemplate">
			...
			<#
				for(var i = 0; i<sub.length;i++){
					...
					var buttonRight=obj.buttonRight;
			...
			<table id="table_<#=obj.name#>" class="subTable" name="<#=obj.name#>" comment="<#=obj.comment#>" relationType="<#=relationType#>">
				...
				<tr>
					<td style="background-color:white;">
						...
						<ul>
							<#
								for(var button in buttonRight){
							#>
<li><span>
<#=button#>:
</span>
<input name="<#=button#>" textName="<#=button#>Name" class="mini-popupedit"  textField="names" 
							valueField="ids" popupWidth="auto" showClose="true"
							showPopupOnClick="true" onshowpopup="showPopup" onhidepopup="hidePopup"
                			popup="#settingPanel"  multiSelect="true" allowInput="false" oncloseclick="_ClearButtonEdit" />
</li>
	...
	<div class="mini-fit">
		<div class="form-container">
			<form id="form1" method="post">
				<input type="hidden" class="mini-hidden" name="actDefId" value="${param.actDefId}" />
				<input type="hidden" class="mini-hidden" name="solId" value="${param.solId}" />
				<input type="hidden" class="mini-hidden" name="nodeId" value="${param.nodeId}" />
				<input type="hidden" class="mini-hidden" name="formAlias" value="${param.formAlias}" />
				<div id="divForm"></div>
			</form>

			<div style="display:none">
					<input id="rightEditor" class="mini-popupedit"  textField="names" valueField="edit" popupWidth="auto"
						showPopupOnClick="true" showClose="true" popupHeight="260"
			 ...
			 <div id="settingPanel" class="mini-panel" title="设置权限"  style="width:550px;height:250px;overflow: hidden" visible="false"
					...
					<div>
						...
						<form id="viewForm">
							<table class="table-detail column-four table-align" cellpadding="0" cellspacing="1" style="width:100%">
								<tr id="everyoneTr">
									<td width="80">所有人</td>
									<td width="*">
