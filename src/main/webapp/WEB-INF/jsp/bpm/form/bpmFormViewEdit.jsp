...
<ul id="popupToolMenu" class="mini-menu" style="display:none;">
	<c:if test="${not empty bpmFormView.boDefId}">
		<li  id="${ctxPath}/sys/bo/sysBoDef/manage.do?boDefId=${bpmFormView.boDefId}" onclick="showTool">元数据结构</li>
	</c:if>
...
<div class="topToolBar">
	<div>
		...
		<a class="mini-button"  plain="true" onclick="nextStep">发布&元数据</a>
		...
		<div id="mainLayout" class="mini-layout" style="width:100%;height:100%;">
							...
							<li class="toobar_left">
								<div>
									...
									<ul class="toobar_li_ul">
										...
										<li><a plugin="mini-grid-div" ><i class="iconfont icon-tiaojian"></i>模板二控件</a></li>
									</ul>
									<div>表单控件</div>
									<ul class="toobar_li_ul">
										...
										<li><a  plugin="mini-checkbox"><i class="iconfont icon-fuxuank1"></i>复选框</a></li>
										<li><a  plugin="mini-radiobuttonlist"><i class="iconfont icon-danxuank"></i>单选按钮</a></li>
										<li><a  plugin="mini-checkboxlist"><i class="iconfont icon-fuxuan1"></i>复选按钮</a></li>
			...
			<div title="center" region="center"  showHeader="false">
				<div class="mini-fit" id="fitHeight">
					<div id="templateView" style="width: 100%!important;box-sizing: border-box" name="templateView" type="text/plain"></div>
...
<script type="text/javascript">
	...
	function editHeight(){
		...
		var toolBar_h = 46;
       if(windowWidth < 1470 ){
            $("#templateView").height(height_fit - toolBar_h - 59 );
        }else {
            $("#templateView").height(height_fit - toolBar_h - 33 );
        }
	}
