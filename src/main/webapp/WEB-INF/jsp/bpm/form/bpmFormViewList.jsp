...
<body>
	...
	<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
	    <div title="业务表单分类" region="west" width="180" showSplitIcon="true" showCollapseButton="false" showProxy="false" >
	        ...
	        <div class="mini-toolbar" >
				<div class="searchBox">
					<form id="searchForm" >
						<ul>
							<li>
								<span class="text">表单名称：</span><input class="mini-textbox" name="Q_NAME__S_LK"/>
							</li>
							<li>
