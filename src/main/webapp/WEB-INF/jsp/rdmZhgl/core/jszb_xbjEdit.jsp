...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/jszb_xbjEdit.js?version=${static_res_version}" type="text/javascript"></script>
    ...
    <div class="form-container" style="margin: 0 auto; width: 80%;">
        <form id="formJszb" method="post">
            ...
            <table class="table-detail grey" cellspacing="1" cellpadding="0">
                ...
                <tr>
                    <td style="width: 14%">询比价总价或项目预算：</td>
                    <td style="width: 30%;">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <div id="fileListGrid" class="mini-datagrid" style="width: 100%; height:auto"
                             ...
                             idField="ckId" url="${ctxPath}/zhgl/core/jszb/getJszbFileTypeList.do?type=询比价流程"
