...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/ndkfjhMonthApplyList.js?version=${static_res_version}"
...
<div class="mini-fit" style="height: 100%;">
    <div id="applyListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/rdmZhgl/core/ndkfjh/month/queryList.do"
        ...
        <div property="columns">
            ...
            <div field="yearMonth" width="100" headerAlign="center" align="center" allowSort="false">申请年月</div>
