        ...
        <ul>
            <li class="gs-w" data-row="1" data-col="1" data-sizex="6" data-sizey="3">
                <header class="deskHome-header">
                    <p class="span-header"><spring:message code="page.monthWorkUnFinish.name" /></p>
                </header>
                <div id="deskHomeProgress" class="containerBox">
                    <div id="planGrid" class="mini-datagrid" allowResize="true" style="max-height: 360px"
                         url="${ctxPath}/rdmZhgl/core/monthWork/unFinishPlan.do" idField="id" showPager="false"
                        ...
                        <div property="columns">
                            ...
                            <div field="rowNum" name="rowNum" align="center" headerAlign="center" width="40px"><spring:message code="page.monthWorkUnFinish.name1" /></div>
                            <div field="projectName" name="projectName" width="200px" headerAlign="center"
                                 align="center"
                                 allowSort="false"><spring:message code="page.monthWorkUnFinish.name2" />
                            </div>
                            <div field="number" name="number" width="150px" headerAlign="center" align="center"
                                 allowSort="false"><spring:message code="page.monthWorkUnFinish.name3" />
                            </div>
                            <div field="processRate" name="processRate" width="150px" headerAlign="center"
                                 align="center" allowSort="false"><spring:message code="page.monthWorkUnFinish.name4" />
                            </div>
                            <div field="processStatus" name="processStatus" width="150px" headerAlign="center"
                                 align="center" allowSort="false"><spring:message code="page.monthWorkUnFinish.name5" />
                            </div>
                            <div field="startEndDate" name="startEndDate" width="200px" headerAlign="center"
                                 align="center"
                                 allowSort="false"><spring:message code="page.monthWorkUnFinish.name6" />
                            </div>
                            <div field="stageName" name="stageName" width="100px" headerAlign="center" align="center"
                                 allowSort="false">
                                <spring:message code="page.monthWorkUnFinish.name7" />
                            </div>
                            <div field="responseMan" name="responseMan" width="100px" headerAlign="center"
                                 align="center"
                                 allowSort="false"><spring:message code="page.monthWorkUnFinish.name8" />
                            </div>
                            <div field="workContent" width="250px" headerAlign="center" align="left" allowSort="false">
                                <spring:message code="page.monthWorkUnFinish.name9" />
                            </div>
                            <div field="finishFlag" width="250px" headerAlign="center" align="left" allowSort="false">
                                <spring:message code="page.monthWorkUnFinish.name10" />
                            </div>
                            <div field="planResponseMan" width="100px" headerAlign="center" align="center"
                                 allowSort="false"><spring:message code="page.monthWorkUnFinish.name11" />
                            </div>
                            <div field="responseDeptId" width="150px" headerAlign="center" align="center"
                                 allowSort="false"><spring:message code="page.monthWorkUnFinish.name12" />
                            </div>
                            <div field="isCompanyLevel" name="isCompanyLevel" width="100px" headerAlign="center"
                                 align="center"
                                 renderer="onCompany" allowSort="false"><spring:message code="page.monthWorkUnFinish.name13" />
                            </div>
                            <div field="finishStatus" name="finishStatus" width="100px" headerAlign="center"
                                 align="center"
                                 allowSort="false" renderer="onFinish"><spring:message code="page.monthWorkUnFinish.name14" />
                            </div>
                            <div field="remark" name="remark" width="200px" headerAlign="center" align="center"
                                 allowSort="false"><spring:message code="page.monthWorkUnFinish.name15" />
                            </div>
                            <div field="isDelayApply" name="isDelayApply" width="150px" headerAlign="center"
                                 align="center"
                                 allowSort="false" renderer="onDelayApplyRate"><spring:message code="page.monthWorkUnFinish.name16" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <li class="gs-w" data-row="4" data-col="1" data-sizex="6" data-sizey="3">
                <header class="deskHome-header">
                    <p class="span-header"><spring:message code="page.monthWorkUnFinish.name17" /></p>
                </header>
                <div id="unPlanBox" class="containerBox">
                    <div id="unPlanListGrid" class="mini-datagrid" style="max-height: 360px" allowResize="true"
                         url="${ctxPath}/rdmZhgl/core/monthUnProjectPlan/unFinishPlan.do" idField="id" showPager="false"
                         allowCellWrap="true"
                         multiSelect="true" showColumnsMenu="false" sizeList="[10,20,50,100,200]"
                         allowAlternating="true"
                         pagerButtons="#pagerButtons">
                        <div property="columns">
                            <div type="checkcolumn" field="mainId" name="mainId" width="30px"></div>
                            ...
                            <div field="taskName" name="taskName" width="200px" headerAlign="center" align="center"
                                 allowSort="false">
                                <spring:message code="page.monthWorkUnFinish.name18" />
                            </div>
                            <div field="projectCode" name="projectCode" width="150px" headerAlign="center"
                                 align="center" allowSort="false">
                                <spring:message code="page.monthWorkUnFinish.name19" />
                            </div>
                            <div field="processRate" name="processRate" width="150px" headerAlign="center"
                                 align="center" allowSort="false"><spring:message code="page.monthWorkUnFinish.name4" />
                            </div>
                            ...
                            <div field="taskFrom" name="taskFrom" width="150px" headerAlign="center" align="center"
                                 allowSort="false">
                                <spring:message code="page.monthWorkUnFinish.name20" />
                            </div>
                            <div field="startEndDate" name="startEndDate" width="200px" headerAlign="center"
                                 align="center"
                                 allowSort="false"><spring:message code="page.monthWorkUnFinish.name21" />
                            </div>
                            <div field="stageId" name="stageId" width="100px" headerAlign="center" align="center"
                                 allowSort="false">
                                <spring:message code="page.monthWorkUnFinish.name22" />
                            </div>
                            <div field="responseMan" name="responseMan" width="100px" headerAlign="center"
                                 align="center"
                                 allowSort="false"><spring:message code="page.monthWorkUnFinish.name23" />
                            </div>
                            <div field="workContent" width="250px" headerAlign="center" align="left" allowSort="false">
                                <spring:message code="page.monthWorkUnFinish.name9" />
                            </div>
            ...
            <li class="gs-w" data-row="7" data-col="1" data-sizex="6" data-sizey="3">
                <header class="deskHome-header">
                    <p class="span-header"><spring:message code="page.monthWorkUnFinish.name24" /></p>
                    </span>
                </header>
                <div id="unPlanTaskBox" class="containerBox">
                    <div id="unPlanTaskGrid" class="mini-datagrid" style="min-height: 660px;max-height: 750px"
                         allowResize="true"
                         url="${ctxPath}/rdmZhgl/core/monthUnPlanTask/unFinishPlan.do" idField="id" showPager="false"
                         allowCellWrap="true"
                         multiSelect="true" showColumnsMenu="false" sizeList="[10,20,50,100,200]"
                         allowAlternating="true"
                         pagerButtons="#pagerButtons">
...
<script type="text/javascript">
    ...
    var yearMonthStart = "${yearMonthStart}";
    var yearMonthEnd = "${yearMonthEnd}";
    var deptId = "${deptId}";
    ...
    unPlanListGrid.on("load", function () {
        unPlanListGrid.mergeColumns(["mainId", "rowNum", "taskName", "projectCode","processRate","processStatusText", "taskFrom", "startEndDate", "responseMan", "isCompanyLevel", "finishStatus", "remark","stageId"]);
    });
    ...
    function loadPlanGrid() {
        var paramArray = [{name: "yearMonthStart", value: yearMonthStart}
            , {name: "yearMonthEnd", value: yearMonthEnd}
            , {name: "deptId", value: deptId}
            , {name: "finishStatus", value: finishStatus}
        ];
        var data = {};
