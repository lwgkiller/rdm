...
<div class="mini-fit" style="height: 100%;">
    <div id="itemGrid" class="mini-datagrid" style=" height: 100%;" allowResize="false"
         url="${ctxPath}/rdmZhgl/core/gzxm/subject/items.do?mainId=${mainId}"
        ...
        <div property="columns">
            ...
            <div field="planStartDate" width="100px" headeralign="center" allowsort="true" align="center"
                ...
                计划开始时间<span
                    style="color: #ff0000">*</span>
                <input property="editor" required="true" class="mini-datepicker" allowinput="false"  required style="width:100%;"/>
            </div>
            <div field="planEndDate" width="100px" headeralign="center" allowsort="true" align="center"
                 dateFormat="yyyy-MM-dd">
                计划结束时间<span
                    style="color: #ff0000">*</span>
                <input property="editor" required="true" class="mini-datepicker" allowinput="false"  style="width:100%;"/>
            </div>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        if (data.length > 0) {
            ...
            if (needReload) {
                ...
                $.ajax({
                    url: jsUseCtxPath + "/rdmZhgl/core/gzxm/subject/dealData.do",
                    data: json,
                    type: "post",
    ...
    function showFilePage(taskId,editable) {
        mini.open({
            title: "文件列表",
            url: jsUseCtxPath + "/rdmZhgl/core/gzxm/project/fileWindow.do?taskId=" + taskId + "&fileType=2&editable="+editable+"&gzxmAdmin="+gzxmAdmin+"&isReporter="+isReporter,
            width: 1000,
            height: 500,
            showModal: false,
            allowResize: true,
