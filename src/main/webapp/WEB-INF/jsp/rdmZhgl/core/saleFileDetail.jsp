...
<div id="detailToolBar" class="topToolBar" style="display: none">
    <div>
        <a id="closeWindow" class="mini-button" onclick="CloseWindow()"><spring:message code="page.saleFileDetail.name" /></a>
    </div>
</div>
<div class="mini-fit">
				...
				<tr>
					...
					<td colspan="3">
						<div id="fileListGrid" class="mini-datagrid" style="width: 100%; height: 85%" allowResize="false"
							 idField="id"
                             url="${ctxPath}/rdmZhgl/core/saleFile/saleFileList.do?fileModel=sq
