...
<head>
	...
	<script src="${ctxPath}/scripts/rdmZhgl/apeManagement.js?version=${static_res_version}"
...
<div id="detailToolBar" class="topToolBar">
	<div>
		<a id="saveStandard" class="mini-button" onclick="saveApe('${awardId}')">保存修改</a>
				...
				<tr>
					...
					<td colspan="3">
						<textarea id="commendUnit" name="commendUnit" class="mini-textarea rxc" plugins="mini-textarea" style="width:98%;"
								  label="表彰单位或部门" datatype="varchar" allowinput="true"
								  emptytext="请输入表彰单位或部门..." mwidth="80" wunit="%" mheight="200" hunit="px"></textarea>
