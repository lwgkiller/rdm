	 ...
	 <div class="mini-toolbar" >
	 	<div class="searchBox">
			<form id="searchForm" class="search-form" style="margin-bottom: 25px">
				<ul >
                    <input id="gslclb" name="gslclb" value="招标流程" class="mini-hidden"/>
                    <li style="margin-right: 15px">
                        <span class="text" style="width:auto">招标部门: </span>
	...
	<div class="mini-fit" style="height: 100%;">
		<div id="jszbListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false" onlyCheckSelection="true"
			...
			<div property="columns">
                ...
                <div field="zbbmName"  width="70" headerAlign="center" align="center" allowSort="false">招标部门</div>
                <div field="jbrName"  width="60" headerAlign="center" align="center" allowSort="false">经办人</div>
                <div field="zbName" align="center" width="80" headerAlign="center" allowSort="false">招标项目名称</div>
				<div field="xmNum"  width="80" headerAlign="center" align="center" allowSort="false">项目编号</div>
				<div field="zbjg" width="80"  allowSort="true" headerAlign="center" align="center" >招标总价或项目预算</div>
                <div field="zbzzxs"  width="70" headerAlign="center" align="center" allowSort="false">招标组织形式</div>
                <div field="zbxs"  width="70" headerAlign="center" align="center" allowSort="false">招标形式</div>
