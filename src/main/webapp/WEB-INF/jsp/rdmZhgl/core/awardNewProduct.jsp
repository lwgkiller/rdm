...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/awardNewProduct.js?version=${static_res_version}"
    ...
    <div class="searchBox">
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            ...
            <ul>
                ...
                <li style="margin-right: 15px">
                    <span class="text" style="width:auto">表彰单位或部门: </span>
                ...
                <div id="moreBox">
                    <ul>
                        <li style="margin-right: 15px">
                            <span class="text" style="width:auto">证书编号: </span>
                            <input class="mini-textbox" id="certificateNumber" name="certificateNumber">
                        </li>
                        <li style="margin-right: 15px">
                ...
                <li style="margin-left: 10px">
                    ...
                    <a id="addId" class="mini-button" style="margin-right: 5px" plain="true"
                       onclick="openAnpEditWindow('add','')">新增</a>
                    <a id="deletedId" class="mini-button btn-red" style="margin-right: 5px" plain="true"
                       onclick="removeAnp()">删除</a>
                    <a id="importMaterialName" class="mini-button" style="margin-right: 5px" plain="true"
                       onclick="importAnpMaterialName()">批量导入</a>
                    <a class="mini-button" style="margin-right: 5px" plain="true" onclick="exportAnp()">导出</a>
                </li>
            </ul>
...
<div class="mini-fit" style="height: 100%;">
    ...
    <div id="anpListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         onlyCheckSelection="true"
         url="${ctxPath}/zhgl/core/awardNewProduct/getAnpList.do" idField="id"
        ...
        <div property="columns">
            ...
            <div name="certificateNumber" field="certificateNumber" width="80" headerAlign="center" align="center" allowSort="true">
                证书编号
            </div>
            <div name="honor" field="honor" width="80" headerAlign="center" align="center" allowSort="true">荣誉</div>
            <div name="commendUnit" field="commendUnit" width="80" headerAlign="center" align="center" allowSort="true">
                表彰单位或部门
            </div>
            ...
            <div name="validity" field="validity" width="80" headerAlign="center" align="center" allowSort="true">
                有效期
            </div>
...
<!--导出Excel相关HTML-->
<form id="excelForm" action="${ctxPath}/zhgl/core/awardNewProduct/exportAnpList.do" method="post"
      target="excelIFrame">
    <input type="hidden" name="filter" id="filter"/>
</form>
<iframe id="excelIFrame" name="excelIFrame" style="display: none;"></iframe>

<div id="importWindow" title="新产品奖导入窗口" class="mini-window" style="width:750px;height:280px;"
     showModal="true" showFooter="false" allowResize="true">
    <p style="display: inline-block;color: red;font-size:15px;vertical-align: middle">
    </p>
    <div style="display: inline-block;float: right;">
        <a id="importBtn" class="mini-button" onclick="importAnpMaterial()">导入</a>
        ...
        <form id="formImport" method="post">
            <table class="table-detail" cellspacing="1" cellpadding="0">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <a href="#" style="color:blue;text-decoration:underline;" onclick="downAmpImportTemplate()">新产品奖导入模板.xls</a>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var anpListGrid = mini.get("anpListGrid");
    ...
    function onActionRenderer(e) {
        ...
        var id = record.id;
        var s = '';
        s += '<span  title="查看" onclick="openAnpEditWindow(\'detail\',\'' + id + '\')">查看</span>';
        if(whetherJxry(currentUserRoles)){
            s += '<span  title="修改" onclick="openAnpEditWindow(\'update\',\'' + id + '\')">编辑</span>';

            s += '<span  title="删除" onclick="removeAnp(' + JSON.stringify(record).replace(/"/g, '&quot;') + ')">删除</span>';
        }else {
    ...
    function onActionRendererCpa(e) {
        ...
        if(record.fileName){
            //预览按钮添加
            cellHtml = returnAnpPreviewSpan(record.fileName, record.fileId,  record.id, coverContent);
            //增加下载按钮 某些节点/用户提供下载功能 （未做）

            cellHtml += '&nbsp;&nbsp;&nbsp;<span title="下载" style="color:#409EFF;cursor: pointer;" ' +
                'onclick="downLoadAnpFile(\'' + record.fileName + '\',\'' + record.fileId + '\',\'' + record.id + '\')">下载</span>';
        }else {
    ...
    function clearFormUpgrade() {
        ...
        mini.get("certificateNumber").setValue("");
...
<redxun:gridScript gridId="anpListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>