...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/saleFilesList.js?version=${static_res_version}"
...
<div class="mini-toolbar">
    <div class="searchBox">
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                <li style="margin-right: 15px"><span class="text" style="width:auto"><spring:message code="page.saleFilesList.name" />: </span>
                    <input id="fileType" name="fileType" class="mini-combobox rxc" plugins="mini-combobox"
                           style="width:100%;height:34px" label="<spring:message code="page.saleFilesList.name1" />：" onvaluechanged="searchFrm()"
                           length="50"
                           only_read="false"  allowinput="false" mwidth="100"
                           wunit="%" mheight="34" hunit="px" shownullitem="true" multiSelect="false"
                           textField="text" valueField="key_" emptyText="<spring:message code="page.saleFilesList.name2" />..."
                           url="${ctxPath}/sys/core/commonInfo/getDicItem.do?dicType=saleFile_WJFL"
                           nullitemtext="<spring:message code="page.saleFilesList.name2" />..." emptytext="<spring:message code="page.saleFilesList.name2" />..."/>
                </li>
...
<div class="mini-fit" style="height: 100%;">
    <div id="dataListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/rdmZhgl/core/saleFile/saleFiles.do?applyType=${applyType}&fileModel=sq" idField="id"
...
<script type="text/javascript">
    ...
    function getDetail(designModel,saleModel,fileType,language) {
        var action = "detail";
        var url = jsUseCtxPath + "/rdmZhgl/core/saleFile/filesDetail.do?action=" + action + "&designModel=" + designModel
