...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/gtzzView.js?version=${static_res_version}" type="text/javascript"></script>
</head>
<body>
<div>
...
<div class="mini-fit" style="margin-top: 10px">
    <div id="itemGrid" class="mini-datagrid" style=" height: 100%;" allowResize="true"
        ...
        <div property="columns">
            ...
            <div field="projectName" displayfield="projectName" width="200px" headerAlign="center"
                 align="left">
                项目名称
            </div>
            ...
            <div field="remark" displayfield="remark" width="200px" headerAlign="center" align="left">
                备注
            </div>
...
<script type="text/javascript">
    ...
    // itemGrid.frozenColumns(0, 4);
    itemGrid.on("load", function () {
        itemGrid.mergeColumns(["finishProcessName"]);
    });
    var valueStr = '';
    ...
    function onDrawCell(e) {
        ...
        if (field == 'remark') {
            if (actEndDate) {
                e.cellHtml = '<span style="">已完成</span>';
