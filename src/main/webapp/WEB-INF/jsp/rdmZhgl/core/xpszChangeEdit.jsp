...
<head>
	...
	<script src="${ctxPath}/scripts/rdmZhgl/xpszChangeEdit.js?version=${static_res_version}" type="text/javascript"></script>
...
<div class="mini-fit">
	<div class="form-container" style="margin:0 auto; width: 100%;">
		<form id="productApplyForm" method="post">
			...
			<input id="mainIds" name="mainIds" class="mini-hidden"/>
			<table class="table-detail grey"  cellspacing="1" cellpadding="0">
				<caption >
					新品试制变更申请单
				</caption>
				<tr>
					<td style="text-align: center">延期开始节点：</td>
					<td >
                    ...
                    <td style="text-align: center">延期结束节点：</td>
                    <td >
                ...
                <tr>
                    ...
                    <td align="center" colspan="1" rowspan="1">
                        <input name="delayDays" required class="mini-spinner" minValue="1" maxValue="1000" style="width:100%;height:34px">
                    </td>
                </tr>
				<tr>
					...
					<td colspan="3">
						<textarea id="reason" name="reason" class="mini-textarea rxc" plugins="mini-textarea" style="width:99%;height:100px;line-height:25px;"
								  label="申请理由" datatype="varchar" length="500" vtype="length:500" minlen="0" allowinput="true" required
		...
		<div class="mini-fit" style="height:  100%;">
			<div id="productGrid" class="mini-datagrid" allowResize="true" style="height: 100%"
				...
				<div property="columns">
					...
					<div field="processStatus" name="processStatus" width="100px" headerAlign="center" align="center" renderer="onProcessStatus">进度状态</div>
					...
					<div field="" width="240px" headerAlign="center" align="center">挖掘机械研究院
						<div property="columns" align="center">
							<div field="zkjdh_date" width="100px" headeralign="center" align="center" dateFormat="yyyy-MM-dd">
								召开交底会、发试制通知单
							</div>
						</div>
					</div>
					...
					<div field="" width="240px" headerAlign="center" align="center">制造管理部
						<div property="columns" align="center">
							<div field="jblczt_date" width="100px" headeralign="center" align="center" dateFormat="yyyy-MM-dd">
								具备量产状态
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	<%--var itemJsonArray = JSON.parse(listData);--%>
