...
<html>
<head>
	<title>新产品奖编辑页面</title>
	<%@include file="/commons/edit.jsp"%>
	<link href="${ctxPath}/styles/list.css?static_res_version=${static_res_version}" rel="stylesheet" type="text/css" />
	<script src="${ctxPath}/scripts/rdmZhgl/anpManagement.js?version=${static_res_version}"
...
<div id="detailToolBar" class="topToolBar">
	<div>
		<a id="saveStandard" class="mini-button" onclick="saveAnp('${awardId}')">保存修改</a>
	...
	<div class="form-container" style="margin: 0 auto">
		<form id="formStandard" method="post">
			...
			<table class="table-detail" cellspacing="1" cellpadding="0">
				...
				<tr>
					<td style="width: 14%">表彰单位或部门：</td>
					<td colspan="3">
						<textarea id="commendUnit" name="commendUnit" class="mini-textarea rxc" plugins="mini-textarea" style="width:98%;"
				...
				<tr>
					...
					<td colspan="3">
						<textarea id="validity" name="validity" class="mini-textarea rxc" plugins="mini-textarea" style="width:98%;"
								  label="有效期" datatype="varchar" allowinput="true"
								  emptytext="请输入有效期..." mwidth="80" wunit="%" mheight="200" hunit="px"></textarea>
