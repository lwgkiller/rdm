...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/zljsjdsFileUpload.js?version=${static_res_version}" type="text/javascript"></script>
...
<div class="mini-panel" id="fileUploadDiv" style="width: 100%; height: 100%" showfooter="true" bodystyle="padding:0" borderStyle="border:0"
    ...
    <div id="multiupload1" class="mini-datagrid"  allowSortColumn="false" multiSelect="false" idField="id"
        ...
        <div property="columns">
            ...
            <div field="fileType" width="100" headerAlign="center">
                ...
                <input id="fileType" property="editor" class="mini-combobox" style="width:90%;"
                       ...
                       data="[{id:'技术交底书',text:'技术交底书'},{id:'检索报告',text:'检索报告'}]"
