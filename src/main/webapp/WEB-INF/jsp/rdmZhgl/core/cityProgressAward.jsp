...
<html>
<head>
    <title>市级及以上科技进步奖列表</title>
    <%@include file="/commons/list.jsp" %>
    <script src="${ctxPath}/scripts/rdmZhgl/cityProgressAward.js?version=${static_res_version}"
            ...
            <ul>
                ...
                <li style="margin-left: 10px">
                    ...
                    <a id="addId" class="mini-button" style="margin-right: 5px" plain="true"
                       onclick="openCpaEditWindow('add','')">新增</a>
                    <a id="deletedId" class="mini-button btn-red" style="margin-right: 5px" plain="true"
                       onclick="removeCpa()">删除</a>
                    <a id="importMaterialName" class="mini-button" style="margin-right: 5px" plain="true"
                       onclick="importMaterialName()">批量导入</a>
                    <a class="mini-button" style="margin-right: 5px" plain="true" onclick="exportCpa()">导出</a>
                </li>
            </ul>
...
<div class="mini-fit" style="height: 100%;">
    ...
    <div id="cpaListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         onlyCheckSelection="true"
         url="${ctxPath}/zhgl/core/cityProgressAward/getCpaList.do" idField="id"
        ...
        <div property="columns">
            ...
            <div name="certificateNumber" field="certificateNumber" width="80" headerAlign="center" align="center"
                 allowSort="true">证书编号
            </div>
            ...
            <%--<div name="portrayalPointPersonName" field="portrayalPointPersonName" width="80" headerAlign="center"
                 align="center" allowSort="true">画像积分人员
            </div>--%>
...
<!--导出Excel相关HTML-->
<form id="excelForm" action="${ctxPath}/zhgl/core/cityProgressAward/exportCpaList.do" method="post"
      target="excelIFrame">
    <input type="hidden" name="filter" id="filter"/>
</form>
<iframe id="excelIFrame" name="excelIFrame" style="display: none;"></iframe>

<div id="importWindow" title="市级及以上科技进步奖导入窗口" class="mini-window" style="width:750px;height:280px;"
        ...
        <form id="formImport" method="post">
            <table class="table-detail" cellspacing="1" cellpadding="0">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <a href="#" style="color:blue;text-decoration:underline;" onclick="downCpaImportTemplate()">市级及以上科技进步奖导入模板.xls</a>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var cpaListGrid = mini.get("cpaListGrid");
    ...
    function onActionRenderer(e) {
        ...
        var id = record.id;
        var s = '';
        s += '<span  title="查看" onclick="openCpaEditWindow(\'detail\',\'' + id + '\')">查看</span>';
        if(whetherJxry(currentUserRoles)){

            s += '<span  title="修改" onclick="openCpaEditWindow(\'update\',\'' + id + '\')">编辑</span>';

            s += '<span  title="删除" onclick="removeCpa(' + JSON.stringify(record).replace(/"/g, '&quot;') + ')">删除</span>';
        }else {
    ...
    function onActionRendererCpa(e) {
        ...
        if(record.fileName){
            //预览按钮添加
            cellHtml = returnCpaPreviewSpan(record.fileName, record.fileId,  record.id, coverContent);
            //增加下载按钮 某些节点/用户提供下载功能 （未做）

            cellHtml += '&nbsp;&nbsp;&nbsp;<span title="下载" style="color:#409EFF;cursor: pointer;" ' +
                'onclick="downLoadJsjlFile(\'' + record.fileName + '\',\'' + record.fileId + '\',\'' + record.id + '\')">下载</span>';
        }else {
...
<redxun:gridScript gridId="cpaListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>