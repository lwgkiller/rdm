...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/awardPatentEdit.js?version=${static_res_version}"
            ...
            <ul>
                ...
                <li style="margin-left: 10px">
                    ...
                    <a id="addId" class="mini-button" style="margin-right: 5px" plain="true"
                       onclick="openApeEditWindow('add','')">新增</a>
                    <a id="deletedId" class="mini-button btn-red" style="margin-right: 5px" plain="true"
                       onclick="removeApe()">删除</a>
                    <a id="importMaterialName" class="mini-button" style="margin-right: 5px" plain="true"
                       onclick="importApeMaterialName()">批量导入</a>
                    <a class="mini-button" style="margin-right: 5px" plain="true" onclick="exportApe()">导出</a>
                </li>
            </ul>
...
<div class="mini-fit" style="height: 100%;">
    ...
    <div id="apeListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         onlyCheckSelection="true"
         url="${ctxPath}/zhgl/core/awardPatent/getApeList.do" idField="id"
        ...
        <div property="columns">
            ...
            <div name="commendUnit" field="commendUnit" width="80" headerAlign="center" align="center" allowSort="true">表彰单位或部门</div>
...
<!--导出Excel相关HTML-->
<form id="excelForm" action="${ctxPath}/zhgl/core/awardPatent/exportApeList.do" method="post"
      target="excelIFrame">
    <input type="hidden" name="filter" id="filter"/>
</form>
<iframe id="excelIFrame" name="excelIFrame" style="display: none;"></iframe>

<div id="importWindow" title="专利奖导入窗口" class="mini-window" style="width:750px;height:280px;"
     showModal="true" showFooter="false" allowResize="true">
    <p style="display: inline-block;color: red;font-size:15px;vertical-align: middle">
    </p>
    <div style="display: inline-block;float: right;">
        <a id="importBtn" class="mini-button" onclick="importApeMaterial()">导入</a>
        ...
        <form id="formImport" method="post">
            <table class="table-detail" cellspacing="1" cellpadding="0">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <a href="#" style="color:blue;text-decoration:underline;" onclick="downApeImportTemplate()">专利奖导入模板.xls</a>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var apeListGrid = mini.get("apeListGrid");
    ...
    function onActionRenderer(e) {
        ...
        var id = record.id;
        var s = '';
        s += '<span  title="查看" onclick="openApeEditWindow(\'detail\',\'' + id + '\')">查看</span>';
        if(whetherJxry(currentUserRoles)){
            s += '<span  title="修改" onclick="openApeEditWindow(\'update\',\'' + id + '\')">编辑</span>';

            s += '<span  title="删除" onclick="removeApe(' + JSON.stringify(record).replace(/"/g, '&quot;') + ')">删除</span>';
        }else {
...
<redxun:gridScript gridId="apeListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>