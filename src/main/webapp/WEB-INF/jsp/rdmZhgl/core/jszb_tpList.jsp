...
<div class="mini-toolbar" >
    <div class="searchBox">
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul >
                <input id="gslclb" name="gslclb" value="特批流程" class="mini-hidden"/>
                <li style="margin-right: 15px">
                    <span class="text" style="width:auto">特批申请部门: </span>
            ...
            <div id="moreBox">
                <ul>
                    <li style="margin-right: 15px"><span class="text" style="width:auto">拟采用采购方式: </span>
                        <input id="cgfs" name="cgfs" class="mini-combobox" style="width:120px;"
                               textField="value" valueField="key" emptyText="请选择..." onvaluechanged="searchFrm"
                               required="false" allowInput="false" showNullItem="true" nullItemText="请选择..."
...
<div class="mini-fit" style="height: 100%;">
    <div id="jszbListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false" onlyCheckSelection="true"
        ...
        <div property="columns">
            ...
            <div field="zbbmName"  width="70" headerAlign="center" align="center" allowSort="false">特批申请部门</div>
            <div field="jbrName"  width="60" headerAlign="center" align="center" allowSort="false">经办人</div>
            <div field="zbName" align="center" width="80" headerAlign="center" allowSort="false">项目名称</div>
            <div field="zbjg" width="80"  allowSort="true" headerAlign="center" align="center" >项目预算</div>
            <div field="yjFinishTime" width="60"  allowSort="true" headerAlign="center" align="center" >预计完成时间</div>
            <div field="cgfs" width="80"  allowSort="true" headerAlign="center" align="center" >拟采用采购方式</div>
