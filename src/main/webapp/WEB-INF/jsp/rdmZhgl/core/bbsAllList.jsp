...
<div class="mini-toolbar">
    <div class="searchBox">
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                <li style="margin-right: 15px"><span class="text" style="width:auto">标题: </span>
                    <input name="title" class="mini-textbox rxc" allowInput="true" style="width:100%;"/>
                </li>
                <li style="margin-right: 15px"><span class="text" style="width:auto">主题: </span>
                    <input name="direction" class="mini-textbox rxc" allowInput="true" style="width:100%;"/>
                </li>
                <li style="margin-right: 15px"><span class="text" style="width:auto">板块: </span>
                    <input name="plateName" class="mini-textbox rxc" allowInput="true" style="width:100%;"/>
                </li>
                <li style="margin-right: 15px"><span class="text" style="width:auto">发帖人: </span>
                    <input name="publisher" class="mini-textbox rxc" allowInput="true" style="width:100%;"/>
                </li>
                <li style="margin-right: 15px"><span class="text" style="width:auto">是否关帖: </span>
                    <input id="closed" name="closed" class="mini-combobox rxc" plugins="mini-combobox"
                           style="width:100px;height:34px" label="是否关帖："
                ...
                <li style="margin-right: 15px"><span class="text" style="width:auto">帖子分类: </span>
                    <input id="bbsType" name="bbsType" class="mini-combobox rxc" plugins="mini-combobox"
                           style="width:100%;height:34px"  label="帖子分类：" onvaluechanged="searchFrm"
                ...
                <li style="margin-right: 15px"><span class="text" style="width:auto">是否采纳: </span>
                    <input id="isAdopt" name="isAdopt" class="mini-combobox rxc" plugins="mini-combobox"
                           style="width:100px;height:34px" label="是否采纳："
                           length="50" onvaluechanged="searchFrm()"
                           only_read="false" required="false" allowinput="false" mwidth="100"
                           wunit="%" mheight="34" hunit="px" shownullitem="true" multiSelect="false"
                           textField="text" valueField="key_" emptyText="请选择..."
                ...
                <br>
                <li style="margin-right: 15px"><span class="text" style="width:auto">满意度: </span>
                    <input id="satisfaction" name="satisfaction" class="mini-combobox rxc" plugins="mini-combobox"
                           style="width:100px;height:34px" label="满意度："
                           length="50" onvaluechanged="searchFrm()"
                           only_read="false" required="false" allowinput="false" mwidth="100"
                           wunit="%" mheight="34" hunit="px" shownullitem="true" multiSelect="false"
                           textField="text" valueField="key_" emptyText="请选择..."
                ...
                <li style="margin-right: 15px">
                    <span class="text" style="width:auto">发帖时间 从 </span>:<input name="startTime" allowinput="false"
                                                                                class="mini-datepicker"
                                                                                format="yyyy-MM-dd"
                                                                                style="width:120px"/>
                </li>
                <li style="margin-right: 15px">
                    <span class="text-to" style="width:auto">至: </span><input name="endTime" allowinput="false"
                                                                              class="mini-datepicker"
                                                                              format="yyyy-MM-dd"
                                                                              style="width:120px"/>
                </li>
...
<div class="mini-fit" style="height:  100%;">
    <div id="listGrid" class="mini-datagrid" allowResize="true" style="height:  100%;" sortField="CREATE_TIME_"
         sortOrder="desc"
         url="${ctxPath}/rdmZhgl/core/bbs/bbsList.do" idField="id" showPager="true"
