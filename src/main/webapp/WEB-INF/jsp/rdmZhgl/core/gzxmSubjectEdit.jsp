...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/gzxmSubjectEdit.js?version=${static_res_version}"
            ...
            <table cellspacing="1" cellpadding="0" class="table-detail column-four grey">
                ...
                <tr>
                    <td align="center" style="white-space: nowrap;">
                        课题名称<span style="color: #ff0000">*</span>：
                    </td>
                    <td align="center" colspan="3" rowspan="1">
                        <input name="subjectName" required class="mini-textbox rxc" style="width:100%;height:34px">
                    </td>
                </tr>
                <tr>
                    <td align="center" style="white-space: nowrap;">
                        课题编号<span style="color: #ff0000">*</span>：
                    </td>
                    <td align="center" colspan="1" rowspan="1">
                        <input name="subjectIndex" required  class="mini-spinner"  allowLimitValue="false"  decimalPlaces="0"  minValue="0"  style="width:100%;height:34px">
                    </td>
                    <td align="center" style="white-space: nowrap;">
                        所属项目<span style="color: #ff0000">*</span>：
                    </td>
                    <td align="center" colspan="3" rowspan="1">
                        <input id="projectCombo" name="projectId" class="mini-combobox rxc" plugins="mini-combobox"
                               ...
                               textField="projectName" valueField="id" emptyText="请选择..."
                               url="${ctxPath}/rdmZhgl/core/gzxm/project/gzxmList.do"
                               nullitemtext="请选择..." emptytext="请选择..."/>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="white-space: nowrap;">
                        课题负责人<span style="color: #ff0000">*</span>：
                    </td>
                    <td align="center" colspan="1" rowspan="1">
                ...
                <tr>
                    ...
                    <td align="center" colspan="3" rowspan="1">
                        <input id="processDetail" name="processDetail" class="mini-textarea rxc" style="width:100%;height:50px">
                    </td>
                </tr>
                </tbody>
            </table>
