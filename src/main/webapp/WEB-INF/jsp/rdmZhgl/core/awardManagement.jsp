...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/awardManagement.js?version=${static_res_version}"
            ...
            <ul>
                ...
                <li style="margin-left: 10px">
                    ...
                    <a id="addId" class="mini-button" style="margin-right: 5px" plain="true"
                       onclick="openAmgEditWindow('add','')">新增</a>
                    <a id="deletedId" class="mini-button btn-red" style="margin-right: 5px" plain="true"
                       onclick="removeAmg()">删除</a>
                    <a id="importMaterialName" class="mini-button" style="margin-right: 5px" plain="true"
                       onclick="importAmgMaterialName()">批量导入</a>
                    <a class="mini-button" style="margin-right: 5px" plain="true" onclick="exportAmg()">导出</a>
                </li>
            </ul>
...
<div class="mini-fit" style="height: 100%;">
    ...
    <div id="amgListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         onlyCheckSelection="true"
         url="${ctxPath}/zhgl/core/awardManagement/getAmgList.do" idField="id"
        ...
        <div property="columns">
            ...
            <div name="projectName" field="projectName" width="80" headerAlign="center" align="center" allowSort="true">
                项目名称
            </div>
...
<!--导出Excel相关HTML-->
<form id="excelForm" action="${ctxPath}/zhgl/core/awardManagement/exportAmgList.do" method="post"
      target="excelIFrame">
    <input type="hidden" name="filter" id="filter"/>
</form>
<iframe id="excelIFrame" name="excelIFrame" style="display: none;"></iframe>

<div id="importWindow" title="管理奖导入窗口" class="mini-window" style="width:750px;height:280px;"
     showModal="true" showFooter="false" allowResize="true">
    <p style="display: inline-block;color: red;font-size:15px;vertical-align: middle">
    </p>
    <div style="display: inline-block;float: right;">
        <a id="importBtn" class="mini-button" onclick="importAmgMaterial()">导入</a>
        ...
        <form id="formImport" method="post">
            <table class="table-detail" cellspacing="1" cellpadding="0">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <a href="#" style="color:blue;text-decoration:underline;" onclick="downAmgImportTemplate()">管理奖导入模板.xls</a>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var amgListGrid = mini.get("amgListGrid");
    ...
    function onActionRenderer(e) {
        ...
        var id = record.id;
        var s = '';
        s += '<span  title="查看" onclick="openAmgEditWindow(\'detail\',\'' + id + '\')">查看</span>';
        if(whetherJxry(currentUserRoles)){
            s += '<span  title="修改" onclick="openAmgEditWindow(\'update\',\'' + id + '\')">编辑</span>';

            s += '<span  title="删除" onclick="removeAmg(' + JSON.stringify(record).replace(/"/g, '&quot;') + ')">删除</span>';
        }else {
    ...
    function onActionRendererCpa(e) {
        ...
        if(record.fileName){
            //预览按钮添加
            cellHtml = returnAmgPreviewSpan(record.fileName, record.fileId,  record.id, coverContent);
            //增加下载按钮 某些节点/用户提供下载功能 （未做）

            cellHtml += '&nbsp;&nbsp;&nbsp;<span title="下载" style="color:#409EFF;cursor: pointer;" ' +
                'onclick="downLoadAmgFile(\'' + record.fileName + '\',\'' + record.fileId + '\',\'' + record.id + '\')">下载</span>';
        }else {
...
<redxun:gridScript gridId="amgListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>