...
<html>
<head>
    <title>国重项目审批列表</title>
    <%@include file="/commons/list.jsp" %>
    <script src="${ctxPath}/scripts/rdmZhgl/gzxmProjectApplyList.js?version=${static_res_version}"
...
<div class="mini-fit" style="height: 100%;">
    <div id="applyListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/rdmZhgl/core/gzxm/projectApply/queryList.do"
        ...
        <div property="columns">
            ...
            <div field="userName" sortField="userName" width="40" headerAlign="center" align="center" allowSort="true">申请人</div>
            <div field="reason" width="100" headerAlign="center" align="center" allowSort="false">备注</div>
            <div field="instStatus" width="70" headerAlign="center" align="center" renderer="onStatusRenderer" allowSort="false">申请流程状态</div>
            ...
            <div field="applyTime" sortField="applyTime" dateFormat="yyyy-MM-dd HH:mm:ss" align="center" width="100" headerAlign="center" allowSort="true">申请时间</div>
