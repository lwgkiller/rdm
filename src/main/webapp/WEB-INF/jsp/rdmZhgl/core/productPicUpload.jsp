...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/productPicUpload.js?version=${static_res_version}" type="text/javascript"></script>
...
<div id="fileUploadDiv" class="mini-panel" style="width: 100%; height: 100%" showfooter="false" bodystyle="padding:0" borderStyle="border:0"
    ...
    <div id="multiuploadGrid" class="mini-datagrid"  allowSortColumn="false" multiSelect="false" idField="id"
        ...
        <div property="columns">
            ...
            <div field="picType"  width="90"  renderer="onPicType" headerAlign="center">照片类型<span style="color: #ff0000">*</span>
                <input property="editor" class="mini-combobox" textField="text" valueField="key_"
                       ...
                       url="${ctxPath}/sys/core/commonInfo/getDicItem.do?dicType=XPSZ-ZPFX"/>
            </div>
