...
<html>
<head>
    <title>研发降本-试制通知单</title>
    <%@include file="/commons/edit.jsp" %>
    <link href="${ctxPath}/styles/list.css?static_res_version=${static_res_version}" rel="stylesheet" type="text/css"/>
    <script src="${ctxPath}/scripts/rdmZhgl/yfjbProductionNoticeEdit.js?version=${static_res_version}" type="text/javascript"></script>
</head>
<body>
        ...
        <form id="infoForm" method="post">
            ...
            <table cellspacing="1" cellpadding="0" class="table-detail column-four grey">
                ...
                <tr>
                    ...
                    <td align="center" colspan="1" rowspan="1">
                        <input name="productionNo"  class="mini-textbox rxc" style="width:100%;height:34px">
                    </td>
                    <td align="center" style="white-space: nowrap;">
                        试制通知单下发时间<span style="color: #ff0000">*</span>：
                    </td>
                    <td align="center" colspan="1" rowspan="1">
