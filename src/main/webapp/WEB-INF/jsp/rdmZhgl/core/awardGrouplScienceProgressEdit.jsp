...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/awardGrouplScienceProgress.js?version=${static_res_version}"
            ...
            <ul>
                ...
                <li style="margin-left: 10px">
                    ...
                    <a id="addId" class="mini-button" style="margin-right: 5px" plain="true"
                       onclick="openAgspEditWindow('add','')">新增</a>
                    <a id="deletedId" class="mini-button btn-red" style="margin-right: 5px" plain="true"
                       onclick="removeAgspe()">删除</a>
                    <a id="importMaterialName" class="mini-button" style="margin-right: 5px" plain="true"
                       onclick="importAgspeMaterialName()">批量导入</a>
                    <a class="mini-button" style="margin-right: 5px" plain="true" onclick="exportAgspe()">导出</a>
                </li>
            </ul>
...
<div class="mini-fit" style="height: 100%;">
    ...
    <div id="agspeListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         onlyCheckSelection="true"
         url="${ctxPath}/zhgl/core/awardGrouplScienceProgress/getCpaList.do" idField="id"
        ...
        <div property="columns">
            ...
            <div name="certificateNumber" field="certificateNumber" width="80" headerAlign="center" align="center" allowSort="true">证书编号</div>
            <div name="validity" field="validity" width="80" headerAlign="center" align="center" allowSort="true">有效期</div>
            <div name="expiryTime" field="expiryTime" width="80" headerAlign="center" align="center" allowSort="true">失效时间</div>
            <div name="predictRecheckTime" field="predictRecheckTime" width="80" headerAlign="center" align="center" allowSort="true">预计复审时间</div>
            <div name="nextReviewState" field="nextReviewState" width="80" headerAlign="center" align="center" allowSort="true"  renderer="nextReviewStateRenderer">下次评审状态</div>
...
<!--导出Excel相关HTML-->
<form id="excelForm" action="${ctxPath}/zhgl/core/awardGrouplScienceProgress/exportAgspeList.do" method="post"
      target="excelIFrame">
    <input type="hidden" name="filter" id="filter"/>
</form>
<iframe id="excelIFrame" name="excelIFrame" style="display: none;"></iframe>

<div id="importWindow" title="高品奖导入窗口" class="mini-window" style="width:750px;height:280px;"
     showModal="true" showFooter="false" allowResize="true">
    <p style="display: inline-block;color: red;font-size:15px;vertical-align: middle">
    </p>
    <div style="display: inline-block;float: right;">
        <a id="importBtn" class="mini-button" onclick="importAgspeMaterial()">导入</a>
        ...
        <form id="formImport" method="post">
            <table class="table-detail" cellspacing="1" cellpadding="0">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <a href="#" style="color:blue;text-decoration:underline;" onclick="downAgspeImportTemplate()">高品奖导入模板.xls</a>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var agspeListGrid = mini.get("agspeListGrid");
    ...
    function onActionRenderer(e) {
        ...
        var id = record.id;
        var s = '';
        s += '<span  title="查看" onclick="openAgspEditWindow(\'detail\',\'' + id + '\')">查看</span>';
        if(whetherJxry(currentUserRoles)){
            s += '<span  title="修改" onclick="openAgspEditWindow(\'update\',\'' + id + '\')">编辑</span>';

            s += '<span  title="删除" onclick="removeAgspe(' + JSON.stringify(record).replace(/"/g, '&quot;') + ')">删除</span>';
        }else {
    ...
    function onActionRendererCpa(e) {
        ...
        if(record.fileName){
            //预览按钮添加
            cellHtml = returnAgpPreviewSpan(record.fileName, record.fileId,  record.id, coverContent);
            //增加下载按钮 某些节点/用户提供下载功能 （未做）

            cellHtml += '&nbsp;&nbsp;&nbsp;<span title="下载" style="color:#409EFF;cursor: pointer;" ' +
                'onclick="downLoadAgpFile(\'' + record.fileName + '\',\'' + record.fileId + '\',\'' + record.id + '\')">下载</span>';
        }else {
    ...
    function nextReviewStateRenderer(e) {
        var record = e.record;
        var nextReviewState = record.nextReviewState;

        var arr = [

            {'key': '1', 'value': '有效'}, {'key': '0', 'value': '无效'}
        ];

        return $.formatItemValue(arr, nextReviewState);
    }
</script>
<redxun:gridScript gridId="agspeListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>