...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/yfjbEditApplyList.js?version=${static_res_version}"
        ...
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                ...
                <li style="margin-left: 10px">
                    ...
                    <div style="display: inline-block" class="separator"></div>
                    <a id="exportButton" class="mini-button" style="margin-left: 5px" plain="true" onclick="exportExcel()">按条件导出</a>
                </li>
            </ul>
            <div id="moreBox">
                <ul>
...
<div class="mini-fit" style="height: 100%;">
    <div id="applyListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/rdmZhgl/core/yfjb/editApply/queryList.do"
...
<form id="excelForm" action="${ctxPath}/rdmZhgl/core/yfjb/editApply/exportBaseInfoExcel.do"
