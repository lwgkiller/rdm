...
<head>
	...
	<script src="${ctxPath}/scripts/rdmZhgl/cpaManagement.js?version=${static_res_version}"
...
<div id="detailToolBar" class="topToolBar">
	<div>
		<a id="saveStandard" class="mini-button" onclick="saveCpa('${awardId}')">保存修改</a>
	...
	<div class="form-container" style="margin: 0 auto">
		<form id="formStandard" method="post">
			...
			<table class="table-detail" cellspacing="1" cellpadding="0">
				...
				<tr>
					<td style="width: 14%">表彰单位：<span style="color: #ff0000">*</span></td>
					<td colspan="3">
