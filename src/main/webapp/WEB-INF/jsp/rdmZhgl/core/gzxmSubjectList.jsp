...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/gzxmSubjectList.js?version=${static_res_version}" type="text/javascript"></script>
</head>
<body>
<div class="mini-toolbar">
    <div class="searchBox">
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                <li style="margin-right: 15px"><span class="text" style="width:auto">所属项目: </span>
                    <input  name="projectName" class="mini-textbox rxc"   allowInput="true" style="width:100%;"/>
                </li>
                <li style="margin-right: 15px"><span class="text" style="width:auto">课题名称: </span>
                    <input  name="subjectName" class="mini-textbox rxc"   allowInput="true" style="width:100%;"/>
                </li>
        ...
        <ul class="toolBtnBox">
            ...
            <a id="exportButton" class="mini-button" style="margin-left: 5px" plain="true" onclick="exportSubjectTask()">导出</a>
        </ul>
    </div>
</div>
<div class="mini-fit" style="height:  100%;">
    <div id="dataListGrid" class="mini-datagrid"  allowResize="true" style="height:  100%;" sortField="UPDATE_TIME_" sortOrder="desc"
         url="${ctxPath}/rdmZhgl/core/gzxm/subject/list.do" idField="id" showPager="true" allowCellWrap="true"
        ...
        <div property="columns">
            ...
            <div field="projectName" name="projectName" width="200px" headerAlign="center" align="center" allowSort="false" renderer="onProjectName">所属项目</div>
            <div field="subjectName" name="subjectName" width="200px" headerAlign="center" align="center" allowSort="false" renderer="onSubjectName">课题名称</div>
            <div field="subjectIndex" name="subjectIndex" width="100px" headerAlign="center" align="center" allowSort="false">课题序号</div>
            ...
            <div field="startDate" name="startDate" width="150px" headerAlign="center" align="center" allowSort="false" dateFormat="yyyy-MM-dd">开始日期</div>
            <div field="endDate" name="endDate" width="150px" headerAlign="center" align="center" allowSort="false" dateFormat="yyyy-MM-dd">结束日期</div>
            <div field="currentStage" name="currentStage" width="150px" headerAlign="center" align="center" allowSort="false" renderer="onFinishProcess">进度状态</div>
        ...
        <form id="formImport" method="post">
            <table class="table-detail" cellspacing="1" cellpadding="0">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <a href="#" style="color:blue;text-decoration:underline;" onclick="downImportTemplate()">国重项目课题任务导入模板.xlsx</a>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    dataListGrid.on("load", function () {
        dataListGrid.mergeColumns(["projectName"]);
    });
    if(!gzxmAdmin){
    ...
    function onTaskRenderer(e) {
        ...
        s += '<span  title="总览" onclick="overSee(\'' + id + '\')">总览</span>';
        return s;
    }
