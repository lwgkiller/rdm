...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/zgzlFileUpload.js?version=${static_res_version}" type="text/javascript"></script>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var url=jsUseCtxPath+"/zhgl/core/zlgl/getFileList.do?standardId="+standardId + "&fjlx=" + fjlx;
        ...
        function uploadCompleteFile() {
            mini.open({
                title: "文件上传",
                url: jsUseCtxPath + "/zhgl/core/zlgl/openUploadWindow.do",
                width: 650,
                height: 350,
                showModal:false,
                allowResize: true,
