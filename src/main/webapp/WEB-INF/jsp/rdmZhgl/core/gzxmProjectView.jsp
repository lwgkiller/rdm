...
<div class="mini-fit" style="margin-top: 10px">
    <div id="itemGrid" class="mini-datagrid" style=" height: 100%;" allowResize="true"
         url="${ctxPath}/rdmZhgl/core/gzxm/project/items.do"
...
<script type="text/javascript">
    ...
    function showFilePage(taskId,editable) {
        mini.open({
            title: "文件列表",
            url: jsUseCtxPath + "/rdmZhgl/core/gzxm/project/fileWindow.do?taskId=" + taskId + "&fileType=1&editable=false&gzxmAdmin=false"+"&isReporter=false",
            width: 1000,
            height: 500,
            showModal: false,
            allowResize: true,
