...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/yfjbChangeNoticeList.js?version=${static_res_version}" type="text/javascript"></script>
</head>
<body>
<div class="mini-toolbar">
    <div class="searchBox">
        ...
        <!--导出Excel相关HTML-->
        <form id="excelForm" action="${ctxPath}/rdmZhgl/core/yfjb/changeNotice/exportExcel.do"method="post" target="excelIFrame">
...
<div class="mini-fit" style="height:  100%;">
    <div id="listGrid" class="mini-datagrid"  allowResize="true" style="height:  100%;" sortField="UPDATE_TIME_" sortOrder="desc"
         url="${ctxPath}/rdmZhgl/core/yfjb/changeNotice/list.do" idField="id" showPager="true" allowCellWrap="true"
         multiSelect="true" showColumnsMenu="false" sizeList="[10,20,50,100,200]"  allowAlternating="true" ondrawcell="onDrawCell"
        ...
        <div property="columns">
            ...
            <div field="assessment"  width="250px" headerAlign="center" align="center" allowSort="false">主要差异性、试制要求、竞品使用情况</div>
            ...
            <div field="noticeNo"  width="150px" headerAlign="center" align="center" allowSort="false">切换通知号</div>
            <div field="noticeDate"  width="150px" headerAlign="center" align="center" allowSort="false">切换通知单下发时间</div>
            <div field="storageAndCar"  width="250px" headerAlign="center" align="center" allowSort="false">通知单中库存及切换车号</div>
...
<script type="text/javascript">
    ...
    function onDrawCell(e) {
        ...
        if (field == 'noticeDate') {
            ...
            var jhxfqh_date = record.jhxfqh_date;
            if(noticeDate&&jhxfqh_date){
