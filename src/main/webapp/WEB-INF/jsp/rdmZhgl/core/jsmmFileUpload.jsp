...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/jsmmFileUpload.js?version=${static_res_version}" type="text/javascript"></script>
        ...
        <div property="columns">
            ...
            <div field="typeId" width="100" displayField="typeName" headerAlign="center">交付物类型
                <input id="typeSelect" property="editor" class="mini-combobox" style="width:90%;"
                       textField="typeName" valueField="typeId" emptyText="请选择..."
