...
<head>
    ...
    <script src="${ctxPath}/scripts/rdmZhgl/xpszFinishList.js?version=${static_res_version}"
...
<div class="mini-fit" style="height: 100%;">
    <div id="applyListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/rdmZhgl/core/xpszFinish/queryList.do"
        ...
        <div property="columns">
            ...
            <div field="itemName" width="100" headerAlign="center" align="center" allowSort="false">完成项</div>
