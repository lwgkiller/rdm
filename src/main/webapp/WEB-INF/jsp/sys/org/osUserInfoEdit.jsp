...
<rx:toolbar toolbarId="toolbar1" pkId="${osUser.userId}" hideRecordNav="true">
  <div class="self-toolbar">
	...
	<%--<div id="div_toolbar1" class="topToolBar" >
		<div>
			<a class="mini-button"  plain="true" onclick="testSave">保存</a>
		</div>
	</div>--%>
		<div class="mini-fit">
			...
			<input type="hidden" name="crsf_token" class="mini-hidden"  value="${sessionScope.crsf_token}"/>
						...
						<div class="form-outer" style="padding: 6px;">
							...
							<table class="table-detail column_2" cellspacing="1" cellpadding="0">
								...
								<tr>
									<td width="120">姓　　名 <span class="star" style="color: red">*</span></td>
									<td><input name="fullname" value="${osUser.fullname}" readOnly  style="width:98%" class="mini-textbox" vtype="maxLength:64" emptyText="请输入姓名" /></td>
									<td width="120">账　　号 <span class="star" style="color: red">*</span></td>
								...
								<tr>
									<td >
										主  部  门<span class="star" style="color: red">*</span>
									</td>
									<td>
										  <input id="mainDepId" name="mainDepId" style="width:98%" class="mini-dep mini-buttonedit icon-dep-button"
												 value="${mainDepId}" text="${mainDepName}" readOnly  allowInput="false" onbuttonclick="selectMainDep"/>
									</td>
									<td>邮　　件</td>
									<td><input name="email" value="${osUser.email}" class="mini-textbox" onvalidation="onEmailValidation" vtype="maxLength:100" style="width:98%"/></td>
								</tr>
								<tr>
									<td>身份证号</td>
									<td><input name="certNo" value="${osUser.certNo}" class="mini-textbox" vtype="maxLength:20" style="width:98%"/></td>
									<td>联系电话</td>
									<td><input name="mobile" value="${osUser.mobile}" class="mini-textbox" vtype="maxLength:20" style="width:98%"/></td>
								</tr>
								<tr>
									<td>Windchill PDM关联账号</td>
									<td><input id="pdmUserNo" value="${osUser.pdmUserNo}" name="pdmUserNo" class="mini-textbox" style="width: 98%;" /></td>
                                    <td>
                                        QMS系统账号
                                    </td>
                                    <td>
                                        <input id="qmsUserNo" value="${osUser.qmsUserNo}" name="qmsUserNo" class="mini-textbox" style="width: 98%;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>所属室主任</td>
									<td>
										<input id="szrUserId" value="${osUser.szrUserId}" text="${osUser.szrUserName}" name="szrUserId" textname="szrUserName" class="mini-user rxc"
											   plugins="mini-user" style="width:98%;height:34px;" allowinput="false" label="室主任" length="50"
								...
								<tr>
									...
									<td colspan="3" style="padding:6px;">
										<input id="canGroupIds" name="canGroupIds" allowInput="false" readOnly class="mini-textboxlist" style="width: 98%;" value="${canGroupIds}" text="${canGroupNames}" />
									</td>
								</tr>
								<tr>
									<td>状　　态<span class="star" style="color: red">*</span>
									</td>
									<td>
										<div id="status" name="status" class="mini-radiobuttonlist" value="${osUser.status}" required="true" repeatDirection="vertical" required="true" emptyText="请输入状态" repeatLayout="table" data="[{id:'IN_JOB',text:'在职'},{id:'OUT_JOB',text:'离职'}]" textField="text" valueField="id" required="true" vtype="maxLength:40"></div>
									</td>
									<td>性　　别</td>
									<td>
								...
								<tr>
									<td>入职时间</td>
									<td><input name="entryTime" value="${osUser.entryTime}" class="mini-datepicker" vtype="maxLength:19" style="width:98%"/></td>

									<td>离职时间</td>
									<td><input name="quitTime" value="${osUser.quitTime}" class="mini-datepicker" vtype="maxLength:19" style="width:98%"/></td>
								</tr>
								<tr>
									<td>地　　址</td>
									<td colspan="3"><input name="address" class="mini-textbox" vtype="maxLength:255" style="width: 98%" value="${osUser.address}" /></td>
								</tr>

								<tr>
									<td>紧急联系人</td>
									<td><input name="urgent" value="${osUser.urgent}" class="mini-textbox" vtype="maxLength:64" style="width:98%"/></td>

									<td>紧急联系人手机</td>
									<td><input name="urgentMobile" value="${osUser.urgentMobile}" class="mini-textbox" vtype="maxLength:20" style="width:98%"/></td>
								</tr>
								<tr>
									<td>QQ 号</td>
									<td><input name="qq" value="${osUser.qq}" class="mini-textbox" vtype="maxLength:20" style="width:98%"/></td>
									<td>生　　日</td>
									<td><input name="birthday" value="${osUser.birthday}" class="mini-datepicker" vtype="maxLength:19" style="width:98%"/></td>
								</tr>
								<tr>
									<td>从属部门</td>
									<td colspan="3"><input id="canDepIds" name="canDepIds" readOnly allowInput="false" class="mini-textboxlist" style="width:98%" value="${canDepIds}" text="${canDepNames}" /></td>
								</tr>
								<tr>
									<td>照　　片</td>
									<td style="height:100px;"><input id="photo" name="photo" value="${osUser.photo}" class="mini-hidden" /> <img <%--src="${ctxPath}/sys/core/file/imageView.do?thumb=true&fileId=${osUser.photo}"--%> class="upload-file" /></td>
								</tr>
							</table>
						</div>
	...
	<script type="text/javascript">
		...
		$(function(){
            ...
            mini.get("canGroupIds").setEnabled(false);
