			...
			<div class="mini-tabs" activeIndex="0"  style="width:100%;min-height:100%;">
				<div  title="用户基本信息">
					<table class="table-detail column-four table-align" cellspacing="1" cellpadding="0">
						...
						<tr>
							<td width="120px">
									姓　　名 <span class="star" style="color: red">*</span>
							</td>
							<td><input name="fullname" value="${osUser.fullname}" class="mini-textbox" vtype="maxLength:64" style="width: 98%" required="true" emptyText="请输入姓名" />
							...
							<td width="120px">帐 号 <span class="star" style="color: red">*</span> </td>
							<td>
								<input name="userNo"
									   value="${osUser.userNo}" class="mini-textbox" vtype="maxLength:64" emptyText="请输入账号" required="true" style="width: 50%"/>
						...
						<c:if test="${empty osUser.userId}">
								<tr>
									<td>
										<span class="starBox">
											密　　码<span class="star" style="color: red">*</span>
										</span>
									</td>
									<td><input class="mini-password" name="pwd" id="pwd" required="true"  style="width: 98%"/></td>
									<td>
										<span class="starBox">
											确认密码<span class="star" style="color: red">*</span>
										</span>
									</td>
									<td >
										<input
						...
						<tr>
							...
							<td>
								<span class="starBox">
									邮　　件 <span class="star" style="color: red">*</span>
								</span>
							</td>
							<td><input name="email" value="${osUser.email}" class="mini-textbox" required="true" vtype="maxLength:100" style="width: 98%"/></td>
						</tr>
						<tr>
							<td>联系电话 </td>
						...
						<tr>
							...
							<td>
								<input id="pdmUserNo" value="${osUser.pdmUserNo}" name="pdmUserNo" class="mini-textbox" style="width: 98%;" />
							</td>
                            <td>
                                QMS系统账号
                            </td>
						...
						<tr>
							<td>
								状　 　态<span class="star" style="color: red">*</span>
							</td>
							<td>
