		...
		<div id="menuForm">
					<table class="table-detail column-two table-align" style="width:100%; " >
						...
						<tr>
							<td>访问方式</td>
							<td>
								<div class="mini-radiobuttonlist"  required="true" repeatItems="2" repeatLayout="table" repeatDirection="vertical" name="showType" value="URL" data="[{id:'URL',text:'URL访问'},{id:'POP_WIN',text:'弹窗'},{id:'NEW_WIN',text:'新窗口'},{id:'FUNS',text:'功能面板集'},{id:'FUN',text:'功能面板'}]"></div>
							</td>
						</tr>
						<tr>
							<td>菜单类型</td>
