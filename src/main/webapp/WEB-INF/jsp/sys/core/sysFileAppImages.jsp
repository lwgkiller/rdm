...
<div class="mini-fit">
	<div  class="form-container">
		<div style="border-bottom: 1px solid #ddd;padding-bottom:10px; "><span>按文件名搜索：</span><input class="mini-textbox" id="fileName" emptyText="请输入文件名" onenter="onSearch" value="${param['fileName']}">&nbsp<a class="mini-button" onclick="onSearch">搜索</a></div>
