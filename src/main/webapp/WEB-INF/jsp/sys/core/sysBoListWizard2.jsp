					...
					>
						<div class="mini-toolbar" >
									...
									<ul>
										...
										<li>
											...
											<input
													...
													style="width:50px"
											>
											<span style="font-size: 14px">&nbsp;列</span>
										</li>
									</ul>
								</form>
							</div>
							<ul  class="toolBtnBox">
								...
								<li>
									<a class="mini-button"   onclick="addRow('headerGrid')">新增行</a>
								</li>
								<li>
									<a class="mini-button btn-red" plain="true" onclick="removeRow('headerGrid')">删除行</a>
								</li>
								<li>
								...
								<li>
									<a class="mini-button"  plain="true" onclick="expand();">展开</a>
								</li>
								<li>
									<a class="mini-button" plain="true" onclick="collapse();">收起</a>
								</li>
						...
						<div class="mini-fit">
							...
							>
								<div property="columns" class="border-right">
									...
									<div field="mobileShowMode" width="80" headerAlign="center">手机端主副显示
										<input
												property="editor"
												class="mini-combobox"
												showNullItem="true"
