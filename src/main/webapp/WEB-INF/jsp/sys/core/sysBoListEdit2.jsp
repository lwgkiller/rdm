...
<div class="mini-fit">
	<div class="mini-tabs" style="width:100%;height:100%" onactivechanged="activechangedTab">
		<div title="列头配置" >
			...
			<div class="mini-fit">
				...
				<div id="searchGrid" class="mini-datagrid" allowResize="true" showPager="false" oncellbeginedit="OnSearchCellBeginEdit"
					...
					<div property="columns">
						<div type="indexcolumn" width="20">序号</div>
						<div field="type" displayField="typeName" width="100" >参数类型
							<input property="editor" class="mini-combobox"
						...
						<div field="fieldName" displayField="fieldText"  width="100">搜索字段
						...
						<div field="fieldLabel" width="100" >标签
							<input property="editor" class="mini-textbox" style="width:100%;" />
						</div>
						<div field="autoFilter" displayField="autoFilterName" width="100" >自动过滤
							<input property="editor" class="mini-combobox"
								   textField="name" valueField="id"
								   style="width:100%;" data="[{id:'YES',name:'是'},{id:'NO',name:'否'}]" />
						</div>
						<div field="fieldOp" displayField="fieldOpLabel" required="true"   width="100">比较符
						</div>
						<div field="fc" displayField="fcName"   width="100">输入控件
							<input property="editor" class="mini-combobox"
			...
			<div title="数据权限">
				<div class="mini-toolbar">
					<ul class="toolBtnBox">
						...
						<li><a class="mini-button"   plain="true" onclick="addDataUserGrantRow">新增用户权限</a></li>
						<li><a class="mini-button"   plain="true" onclick="addDataGroupGrantRow">新增组权限</a></li>
						<li><a class="mini-button"   plain="true" onclick="addDataInstGrantRow">新增机构权限</a></li>
						<!--
						<li><a class="mini-button"   plain="true" onclick="addDataBpmAttendGrantRow">新增流程参与人权限</a></li>
						-->
						<li><span class="separator"></span></li>
						<li><a class="mini-button"   plain="true" onclick="addDataCreateUserGrantRow">新增创建人权限</a></li>
						<li><a class="mini-button"   plain="true" onclick="addDataCreateGroupGrantRow">新增创建部门权限</a></li>
						<li><a class="mini-button"   plain="true" onclick="addDataCreateInstGrantRow">新增创建机构权限</a></li>
						</li><span class="separator"></span></li>
				...
				<div class="mini-fit">
					<div id="dataGrantGrid" class="mini-datagrid" style="width:100%;height:100%"
						...
						<div property="columns">
							...
							<div type="checkcolumn" width="20"></div>
							<div name="typeName" field="typeName" width="100">权限类型</div>
							...
							<div name="scope" field="scope" displayField="scope_name" width="200" >作用域
...
<textarea readonly="readonly" style="width:100%;height:52%;border:none;padding: 0;">
...
// 			   	         {id:'upload-panel',text:'附件',tag:'input'},
    ...
    function addDataUserGrantRow(){
        var g=mini.get('dataGrantGrid');
        g.addRow({type:'user',typeName:'按用户过滤'});
    }

    function addDataCreateUserGrantRow(){
        var g=mini.get('dataGrantGrid');
        g.addRow({type:'user',typeName:'按用户过滤',field:'CREATE_BY_',field_name:'创建人ID'});
    }

    function addDataGroupGrantRow(){
        var g=mini.get('dataGrantGrid');
        g.addRow({type:'group',typeName:'按用户组过滤'});
    }

    function addDataCreateGroupGrantRow(){
        var g=mini.get('dataGrantGrid');
        g.addRow({type:'group',typeName:'按用户过滤',field:'GROUP_ID_',field_name:'部门ID'});
    }

    function addDataInstGrantRow(){
        var g=mini.get('dataGrantGrid');
        g.addRow({type:'inst',typeName:'按机构过滤'});
    }

    function addDataCreateInstGrantRow(){
        var g=mini.get('dataGrantGrid');
        g.addRow({type:'inst',typeName:'按机构过滤',field:'TENANT_ID_',field_name:'机构ID'});
    }
	...
	var bodyScriptEditor;
	
	function activechangedTab(e){
		if(e.index==4){
			if(bodyScriptEditor)return;
			bodyScriptEditor = CodeMirror.fromTextArea(document.getElementById("bodyScript"), {
					mode: "selfHtml",
					lineNumbers: false,
					lineWrapping: true
				});
	...
	function onSaveConfigJson(){
		...
		var bodyScriptText=$("#bodyScript").text();
		if(bodyScriptEditor){
			bodyScriptText=bodyScriptEditor.getValue();
		}
		if(!idField){
			alert('请选择主键字段！');
			return;
	...
	function rowControlConfig(){
		...
		_OpenWindow({
			...
			onload:function(){
				...
				if(!controlConf) controlConf={};
				controlConf.field=row.field;
				controlConf.maxlen=row.width;
