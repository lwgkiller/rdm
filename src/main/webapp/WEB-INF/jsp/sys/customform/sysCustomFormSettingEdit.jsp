...
<div class="mini-fit">
<form id="form1" method="post" action="/sys/customform/sysCustomFormSetting/save.do" style="padding:0;margin:0;height: 100%;">
						...
						<tr>
							...
							<td colspan="3" style="padding:0 !important;">
								...
								<div id="paramGrid" class="mini-datagrid" style="width: 100%;"
									...
									<div property="columns">
										<div type="indexcolumn" width="40">序号</div>
										<div field="name" displayfield="comment" width="120" >
											字段
										...
										<div field="valueDef" width="180" >值</div>
									</div>
								</div>
							</td>
						</tr>
