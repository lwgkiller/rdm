...
<script type="text/javascript">
	...
	function setFormData(data){
        var editForm=new mini.Form('#form-panel');
...
<body>
	<c:choose>
		<c:when test="${formExist!='true' }">
			<div style="padding:8px;text-align: center;"><h2><span style="color: red">表单(${formAlias})不存在！</span></h2></div>
		</c:when>
		<c:otherwise>
