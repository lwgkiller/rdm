	...
	<div class="mini-toolbar">
		<div class="searchBox">
			<form id="searchForm">
				<ul>
					<li class="liAuto">
						<span class="text">权限转移人：</span>
						<input id="userIdEditA"
							   name="Q_AUTHOR_PERSON__S_LK"
							   value="${osUser.userId }" text="${osUser.fullname }" required="true"
							   class="mini-buttonedit" emptyText="请输入..."  allowInput="false" onbuttonclick="onSelectUser('userIdEditA')"/>
					</li>
					<li class="liAuto">
						<span class="text">目标转移人：</span>
						<input id="userIdEditB"
							   name="Q_TARGET_PERSON__S_LK"
							   value="" text="" required="true"
							   class="mini-buttonedit" emptyText="请输入..."
							   allowInput="false" onbuttonclick="onSelectUser('userIdEditB')"/>
					</li>
				</ul>
			</form>
		</div>
