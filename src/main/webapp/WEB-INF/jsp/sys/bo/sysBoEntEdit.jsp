		...
		<div class="form-toolBox">
			...
			<table  cellspacing="0" cellpadding="0" style="width:100%" class="table-detail" >
				<tr>
					...
					<td style="width: 520px"  id="tdFromDb" style="display:none;">
						<input id="genMode" name="genMode" class="mini-hidden" value="create"/>
						<span class="inBox">
							主键：<input id="pkField" name="pkField" class="mini-combobox"  textField="comment" valueField="name"  showNullItem="true" allowInput="true" style="width: 120px"/>
						</span>
						<span class="inBox">
							外键：<input id="fkField" name="fkField" class="mini-combobox"  textField="comment" valueField="name" showNullItem="true" allowInput="true" style="width: 120px"/>
						</span>
						<span class="inBox">
							父ID：<input id="parentField" name="parentField" class="mini-combobox"  textField="comment" valueField="name" showNullItem="true" allowInput="true" style="width: 120px"/>
						</span>
		...
		<div class="mini-fit">
			<div id="layout1" class="mini-layout" width="100%" height="100%">
			    <div title="业务属性" region="east" width="400" showCloseButton="false" showSplitIcon="false" showSplit="false">
			        ...
			        <table id="attrForm" class="table-detail column-two table-align" cellspacing="1" cellpadding="0">
