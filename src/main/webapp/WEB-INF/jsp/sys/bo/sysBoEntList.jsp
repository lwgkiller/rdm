				...
				<form id="searchForm" class="search-form" >						
					...
					<div id="moreBox">
						<ul>
							...
							<li><span class="text" title="是否生成物理表">是否生成物理表：</span>
								<input
										class="mini-combobox"
		...
		<div class="mini-fit" style="height: 100%;">
			<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
				...
				<div property="columns">
					...
					<div name="action" cellCls="actionIcons" width="200" renderer="onActionRenderer" cellStyle="padding:0;">操作</div>
					<div field="comment"  sortField="COMMENT_"  width="180" headerAlign="" >注释</div>
					<div field="name"  sortField="NAME_"  width="160" headerAlign="" >名称</div>
					<div field="genMode" renderer="onGenModeRenderer"  width="120" headerAlign="" >创建方式</div>
					<div field="tableName"  sortField="TABLE_NAME_"  width="110" headerAlign="" >表名</div>
					<div field="dsName"  sortField="DS_NAME_"  width="140" headerAlign="" >数据源名称</div>
