...
<script type="text/javascript">
    ...
    var url = jsUseCtxPath + "/common/core/file/files.do";
    ...
    function queryFiles() {
        fileGrid.setUrl(url + "?mainId=" + mainId + "&tableName=" + tableName);
        fileGrid.load();
    }
    ...
    function fileInfoRenderer(e) {
        var record = e.record;
        var s = '';
        s += returnPreviewSpan(record.fileName, record.id, record.mainId, coverContent, "commonFileUrl");
    ...
    function downFile(record) {
        ...
        fileUrl.attr("value", "commonFileUrl");
        $("body").append(form);
