...
<div class="mini-fit" style="height: 100%;">
    <div id="businessListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         ...
         url="${ctxPath}/newproductAssembly/core/kanban/annualPlanDepListQuery.do" oncellvalidation="onCellValidation">
        <div property="columns">
            ...
            <div field="productDepId" displayField="productDep" width="120" headerAlign="center" align="center">产品部门
                <input property="editor" class="mini-dep rxc" plugins="mini-dep" style="width:90%;height:34px;"
...
<script type="text/javascript">
    ...
    function removeBusiness(record) {
        ...
        mini.confirm("确定删除选中记录？", "提示", function (action) {
            if (action != 'ok') {
                ...
                if (rowIds.length > 0) {
                    _SubmitJson({
                        url: jsUseCtxPath + "/newproductAssembly/core/kanban/deleteAnnualPlanDep.do",
                        method: 'POST',
    ...
    function saveBusiness() {
        ...
        $.ajax({
            url: jsUseCtxPath + "/newproductAssembly/core/kanban/saveAnnualPlanDep.do",
            type: 'POST',
    ...
    function onCellValidation(e) {
        ...
        if (e.field == 'productDepId' && (!e.value || e.value == '')) {
            e.isValid = false;
            e.errorText = '不能为空！';
        }
