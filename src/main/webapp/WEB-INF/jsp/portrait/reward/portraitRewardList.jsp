...
<head>
    ...
    <script src="${ctxPath}/scripts/portrait/reward/portraitRewardList.js?version=${static_res_version}" type="text/javascript"></script>
</head>
<body>
...
<div class="mini-fit" style="height: 100%;">
    <div id="rewardListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/portrait/reward/rewardList.do" idField="id" sortField="UPDATE_TIME_" sortOrder="desc"
        ...
        <div property="columns">
            ...
            <div field="rewardName" width="200" headerAlign="center" align="left" allowSort="true">奖项名称</div>
            <div field="deptName" width="60" headerAlign="center" align="center" allowSort="true">所属部门</div>
            <div field="userName" width="40" headerAlign="center" align="center" allowSort="true">姓名</div>
            <div field="rewardLevel" width="80" headerAlign="center" align="center" allowSort="true" renderer="onWSwitchLevel">奖项级别</div>
            <div field="rewardRank" width="40" headerAlign="center" align="center" allowSort="true" renderer="onWSwitchRank">排名</div>
            <div field="rewardYear" width="40" headerAlign="center" align="center" allowSort="true" >获奖年度</div>
            <div field="score" width="40" headerAlign="center" align="center" allowSort="false">得分</div>
            <div field="CREATE_TIME_" width="80" headerAlign="center" align="center" allowSort="false">同步日期</div>
        </div>
    </div>
</div>
<div id="importWindow" title="荣誉奖项导入窗口" class="mini-window" style="width:750px;height:280px;"
...
<%--        注意：公司领导不计入排名，无需将领导加入作者中排名！--%>
    ...
    <div style="display: inline-block;float: right;">
        <a id="importBtn" class="mini-button" onclick="importReward()">导入</a>
        ...
        <form id="formImport" method="post">
            <table class="table-detail" cellspacing="1" cellpadding="0">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <a href="#" style="color:blue;text-decoration:underline;" onclick="downImportTemplate()">荣誉奖项导入模板.xls</a>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var levelList = getDics("rewardLevel");
    var rankList = getDics("awardRank");
    var yearList = getDics("year");
    ...
    function onWSwitchLevel(e) {
        ...
        for(var i=0;i<levelList.length;i++){
            if(levelList[i].key_==rewardLevel){
    ...
    function onWSwitchYear(e) {
        var record = e.record;
        var rewardYear = record.rewardYear;
        var yearText = '';
        for(var i=0;i<yearList.length;i++){
            if(yearList[i].key_==rewardYear){
                yearText = yearList[i].text;
                break
            }
        }
        return yearText;
...
<redxun:gridScript gridId="rewardListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>
