...
<div class="mini-fit" style="height: 100%;">
    <div id="listGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/portrait/secret/listData.do" idField="id" sortOrder="desc" sortField="publishYear"
        ...
        <div property="columns">
            ...
            <div field="jsmmNumber" width="150" headerAlign="center" align="center" >秘密编号</div>
            <div field="jsmmName" width="200" headerAlign="center" align="left" >秘密名称</div>
    ...
    function asyncData() {
        mini.confirm("确定同步数据？", "提示", function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/portrait/secret/asyncSecret.do",
                    method: 'POST',
