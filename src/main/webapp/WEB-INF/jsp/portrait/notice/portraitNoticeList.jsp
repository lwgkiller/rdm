...
<head>
    ...
    <script src="${ctxPath}/scripts/portrait/notice/portraitNoticeList.js?version=${static_res_version}" type="text/javascript"></script>
</head>
<body>
...
<div class="mini-fit" style="height: 100%;">
    <div id="noticeListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false" sortField="UPDATE_TIME_" sortOrder="desc"
         url="${ctxPath}/portrait/notice/noticeList.do" idField="id"
        ...
        <div property="columns">
            ...
            <div field="noticeType" width="120" headerAlign="center" align="center" allowSort="true" renderer="onWSwitchType">通报类型</div>
...
<div id="importWindow" title="通报导入窗口" class="mini-window" style="width:750px;height:280px;"
    ...
    <div style="display: inline-block;float: right;">
        <a id="importBtn" class="mini-button" onclick="importNotice()">导入</a>
        ...
        <form id="formImport" method="post">
            <table class="table-detail" cellspacing="1" cellpadding="0">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <a href="#" style="color:blue;text-decoration:underline;" onclick="downImportTemplate()">通报导入模板.xls</a>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var noticeListGrid = mini.get("noticeListGrid");
    var typeList = getDics("noticeType");
...
<redxun:gridScript gridId="noticeListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>
