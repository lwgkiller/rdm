...
<div class="mini-fit" style="height: 100%;">
    <div id="listGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/portrait/analysisImprove/listData.do" idField="id" sortOrder="desc" sortField="applyYear"
        ...
        <div property="columns">
            ...
            <div field="userName" width="60" headerAlign="center" align="center" allowSort="true">姓名</div>
    ...
    function asyncData() {
        mini.confirm("确定同步数据？", "提示", function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/portrait/analysisImprove/asyncAnalysisImprove.do",
                    method: 'POST',
