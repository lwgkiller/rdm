...
<head>
    ...
    <script src="${ctxPath}/scripts/portrait/manage/portraitManageList.js?version=${static_res_version}" type="text/javascript"></script>
</head>
<body>
<div class="mini-toolbar">
    <div class="searchBox">
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                <li style="margin-right: 15px"><span class="text" style="width:auto">内参名称: </span><input class="mini-textbox" style="width: 150px" name="manageName"/></li>
                <li style="margin-right: 15px"><span class="text" style="width:auto">内参描述: </span><input class="mini-textbox" style="width: 150px" name="remark"/></li>
...
<div class="mini-fit" style="height: 100%;">
    <div id="listGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/portrait/manage/dataList.do" idField="id" sortField="UPDATE_TIME_" sortOrder="desc"
        ...
        <div property="columns">
            ...
            <div field="" renderer="onFileRenderer" width="100px" headerAlign="center" align="center" allowSort="true">内参附件</div>
            <div field="manageName" width="80" headerAlign="center" align="center" allowSort="true">内参名称</div>
            <div field="remark" width="200" headerAlign="center" align="left" allowSort="true">内参描述</div>
