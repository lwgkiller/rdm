...
<div class="mini-fit" style="height: 100%;">
    <div id="listGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/portrait/technology/listData.do" idField="id" sortOrder="desc" sortField="applyYear"
        ...
        <div property="columns">
            ...
            <div field="jsNum" width="150" headerAlign="center" align="center" >技术编号</div>
            <div field="jsName" width="200" headerAlign="center" align="left" >技术名称</div>
            <div field="score" width="40" headerAlign="center" align="center" allowSort="true">得分</div>
            <div field="applyYear" width="60" headerAlign="center" align="center" allowSort="true">发表年份</div>
    ...
    function asyncData() {
        mini.confirm("确定同步数据？", "提示", function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/portrait/technology/asyncTechnology.do",
                    method: 'POST',
