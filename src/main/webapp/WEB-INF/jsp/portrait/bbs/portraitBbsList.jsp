...
<div class="mini-fit" style="height: 100%;">
    <div id="listGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/portrait/bbs/listData.do" idField="id" sortOrder="desc" sortField="publishYear"
        ...
        <div property="columns">
            ...
            <div field="direction" width="150" headerAlign="center" align="center" >主题</div>
            <div field="title" width="200" headerAlign="center" align="left" >标题</div>
            <div field="score" width="40" headerAlign="center" align="center" allowSort="true">得分</div>
            <div field="publishYear" width="60" headerAlign="center" align="center" allowSort="true">发表年份</div>
    ...
    function asyncData() {
        mini.confirm("确定同步数据？", "提示", function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/portrait/bbs/asyncBbs.do",
                    method: 'POST',
