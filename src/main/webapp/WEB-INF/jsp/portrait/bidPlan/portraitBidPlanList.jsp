...
<head>
    ...
    <script src="${ctxPath}/scripts/portrait/bidPlan/portraitBidPlanList.js?version=${static_res_version}" type="text/javascript"></script>
</head>
<body>
...
<div class="mini-fit" style="height: 100%;">
    <div id="bidPlanListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/portrait/bidPlan/bidPlanList.do" idField="id" sortField="UPDATE_TIME_" sortOrder="desc"
        ...
        <div property="columns">
            ...
            <div field="projectName" width="120" headerAlign="center" align="center" allowSort="true">项目名称</div>
            <div field="projectType" width="80" headerAlign="center" align="center" allowSort="true" renderer="onWSwitchType">项目类别</div>
            <div field="projectRole" width="80" headerAlign="center" align="center" allowSort="true" renderer="onWSwitchRole">角色</div>
...
<div id="importWindow" title="招标规划导入窗口" class="mini-window" style="width:750px;height:280px;"
     showModal="true" showFooter="false" allowResize="true">
    <p style="display: inline-block;color: red;font-size:15px;vertical-align: middle">
    </p>
    <div style="display: inline-block;float: right;">
        <a id="importBtn" class="mini-button" onclick="importBidPlan()">导入</a>
        ...
        <form id="formImport" method="post">
            <table class="table-detail" cellspacing="1" cellpadding="0">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <a href="#" style="color:blue;text-decoration:underline;" onclick="downImportTemplate()">招标规划导入模板.xls</a>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var roleList = getDics("bidPlanRole");
    var typeList = getDics("bidPlanType");
    ...
    function onWSwitchRole(e) {
        var record = e.record;
        var projectRole = record.projectRole;
        var roleText = '';
        for(var i=0;i<roleList.length;i++){
            if(roleList[i].key_==projectRole){
                roleText = roleList[i].text;
                break
            }
        }
        return roleText;
    ...
    function onWSwitchType(e) {
        ...
        for(var i=0;i<typeList.length;i++){
            if(typeList[i].key_==projectType){
...
<redxun:gridScript gridId="bidPlanListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>
