...
<head>
    ...
    <script src="${ctxPath}/scripts/portrait/culture/portraitCultureList.js?version=${static_res_version}" type="text/javascript"></script>
</head>
<body>
...
<div class="mini-fit" style="height: 100%;">
    <div id="cultureListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/portrait/culture/cultureList.do" idField="id"
        ...
        <div property="columns">
            ...
            <div field="userName" width="80" headerAlign="center" align="center" allowSort="true">导师姓名</div>
            <div field="studentName" width="80" headerAlign="center" align="center" allowSort="true" >徒弟姓名</div>
            <div field="conformDate" width="80" headerAlign="center" align="center" allowSort="true" >确定日期</div>
...
<redxun:gridScript gridId="cultureListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>
