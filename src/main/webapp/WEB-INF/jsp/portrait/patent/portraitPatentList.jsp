...
<div class="mini-fit" style="height: 100%;">
    <div id="listGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/portrait/patent/listData.do" idField="id" sortOrder="desc" sortField="interpretationYear"
        ...
        <div property="columns">
            ...
            <div field="patentPublicationNo" width="100" headerAlign="center" align="center" >专利公开（公告）号</div>
            <div field="patentName" width="250" headerAlign="center" align="left" >专利名称</div>
            <div field="score" width="40" headerAlign="center" align="center" allowSort="true">得分</div>
            <div field="interpretationYear" width="60" headerAlign="center" align="center" allowSort="true">签订年份</div>
    ...
    function asyncData() {
        mini.confirm("确定同步数据？", "提示", function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/portrait/patent/asyncPatent.do",
                    method: 'POST',
