...
<head>
    ...
    <script src="${ctxPath}/scripts/portrait/teamWork/portraitTeamWorkList.js?version=${static_res_version}" type="text/javascript"></script>
</head>
<body>
...
<div class="mini-fit" style="height: 100%;">
    <div id="teamWorkListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/portrait/teamwork/teamWorkList.do" idField="id" sortField="UPDATE_TIME_" sortOrder="desc"
        ...
        <div property="columns">
            ...
            <div field="needDeptName" width="120" headerAlign="center" align="center" allowSort="true">需求部门</div>
            <div field="description" width="80" headerAlign="center" align="center" allowSort="true" >协同事项</div>
            <div field="remark" width="80" headerAlign="center" align="center" allowSort="true" >完成情况</div>
...
<div id="importWindow" title="技术协同导入窗口" class="mini-window" style="width:750px;height:280px;"
    ...
    <div style="display: inline-block;float: right;">
        <a id="importBtn" class="mini-button" onclick="importTeamWork()">导入</a>
        ...
        <form id="formImport" method="post">
            <table class="table-detail" cellspacing="1" cellpadding="0">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <a href="#" style="color:blue;text-decoration:underline;" onclick="downImportTemplate()">技术协同导入模板.xls</a>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var teamWorkListGrid = mini.get("teamWorkListGrid");
...
<redxun:gridScript gridId="teamWorkListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>
