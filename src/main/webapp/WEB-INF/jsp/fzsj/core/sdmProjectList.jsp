...
<div class="mini-fit" style="height: 100%;">
    <div id="listGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/fzsj/core/sdm/sdmProjectList.do" idField="id" sortField="score" sortOrder="desc"
        ...
        <div property="columns">
            ...
            <div field="fzNumber" width="120" headerAlign="center" align="center" allowSort="true">仿真编号</div>
            <div field="questName" width="120" headerAlign="center" align="center" allowSort="true">任务名称</div>
            <div field="projectName" width="150" headerAlign="center" align="center" allowSort="true">产品名称</div>
            <div field="CREATE_TIME_" width="80" headerAlign="center" align="center" allowSort="false">推送日期</div>
        </div>
    </div>
</div>
<script type="text/javascript">
    ...
    function onActionRenderer(e) {
        ...
        var s = '';
        if(resultCode!=200){
            s = '<span  title="查看" onclick="viewForm(\'' + id + '\',\'view\')">重新推送</span>';
        }
        return s;
    }
</script>
