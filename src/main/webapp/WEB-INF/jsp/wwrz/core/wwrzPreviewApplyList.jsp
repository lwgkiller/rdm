...
<head>
    ...
    <script src="${ctxPath}/scripts/wwrz/wwrzPreviewApplyList.js?version=${static_res_version}"
...
<div class="mini-fit" style="height: 100%;">
    <div id="applyListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/wwrz/core/previewApply/queryList.do"
         idField="applyId"
        ...
        <div property="columns">
            ...
            <div field="applyReason" width="70" headerAlign="center" align="center" allowSort="false">申请原因</div>
