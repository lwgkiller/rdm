...
<div class="mini-panel" id="fileUploadDiv" style="width: 100%; height: 100%" showfooter="true" bodystyle="padding:0" borderStyle="border:0"
    ...
    <div id="multiuploadGrid" class="mini-datagrid" allowSortColumn="false" multiSelect="false" idField="id"
        ...
        <div property="columns">
            ...
            <div field="fileName" width="110" headerAlign="center">附件名称
                <input property="editor" class="mini-textbox" readonly/>
            </div>
            <div field="reportType" displayField="reportType"  headerAlign="center" align="center" width="80">文件类型
            ...
            <div field="reportName" displayField="reportName"  headerAlign="center" align="center" width="120">文件名称
                <input property="editor" class="mini-combobox" textField="text" valueField="key_"
                       emptyText="请选择..." required
                       showNullItem="false" nullItemText="请选择..."
                       url="${ctxPath}/sys/core/commonInfo/getDicItem.do?dicType=WWRZ-WJMC"/>
            </div>
            <div field="reportCode" width="110" headerAlign="center" align="center">编号
                <input property="editor" class="mini-textbox" />
            </div>
            <div field="reportDate" width="110" headerAlign="center" align="center"  dateFormat="yyyy-MM-dd">日期
                <input property="editor"  class="mini-datepicker" allowInput="false"  style="width:100%;"/>
            </div>
            <div field="reportValidity" width="80" headerAlign="center" align="center"  dateFormat="yyyy-MM-dd">有效期
                <input property="editor"  class="mini-datepicker"  allowInput="false" style="width:100%;"/>
            </div>
            <div field="fileDesc" width="90" headerAlign="center">文件描述
                <textarea property="editor" id="fileDesc" name="fileDesc" class="mini-textarea rxc" plugins="mini-textarea"
                          ...
                          label="文件描述" datatype="varchar" length="500" vtype="length:500" minlen="0" allowinput="true"
                          emptytext="请输入文件描述..." mwidth="80" wunit="%" hunit="px"></textarea>
            </div>
...
<script type="text/javascript">
    ...
    function initUpload(){
        $('#fileUploadDiv').Huploadify({
            formData:{detailId:detailId,fileType:fileType},
            sendFileAttr:["fileName","fileSize","fileDesc","reportType","reportName","reportCode","reportDate","reportValidity"],
            uploadFileList:grid,
            url:jsUseCtxPath+'/wwrz/core/file/fileUpload.do',
            ...
            addFileToGrid: function (files) {
                for(var i=0;i<files.length;i++) {
                    var file=files[i];
                    var row = {id:file.id,fileName:file.name,status:file.status,fileSize:bytesToSize(file.size),complete:0,fileType:fileType};
