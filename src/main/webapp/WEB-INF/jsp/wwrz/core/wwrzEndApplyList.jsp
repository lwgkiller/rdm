...
<head>
    ...
    <script src="${ctxPath}/scripts/wwrz/wwrzEndApplyList.js?version=${static_res_version}"
...
<div class="mini-fit" style="height: 100%;">
    <div id="applyListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/wwrz/core/end/queryList.do"
         idField="applyId"
        ...
        <div property="columns">
            ...
            <div field="projectStatus" width="70" headerAlign="center" align="center" allowSort="false">项目状态</div>
            <div field="money" width="70" headerAlign="center" align="center" allowSort="false">预计费用</div>
            <div field="remark" width="70" headerAlign="center" align="center" allowSort="false">废止原因</div>
            ...
            <div field="reason" width="60" headerAlign="center" align="center" allowSort="false">备注</div>
