...
<head>
    ...
    <script src="${ctxPath}/scripts/wwrz/wwrzPlanApplyList.js?version=${static_res_version}"
    ...
    <div class="searchBox">
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                ...
                <li style="margin-right: 15px">
                    <span class="text" style="width:auto">表单名称: </span>
...
<div class="mini-fit" style="height: 100%;">
    <div id="applyListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/wwrz/core/plan/queryList.do"
         idField="applyId"
        ...
        <div property="columns">
            ...
            <div field="applyName" width="120" headerAlign="center" align="left" allowSort="false">表单名称</div>
