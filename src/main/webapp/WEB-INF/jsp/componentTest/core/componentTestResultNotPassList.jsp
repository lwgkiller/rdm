        ...
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                ...
                <li style="margin-left: 10px">
                    <f:a alias="componentTestNotPassList-searchFrm" onclick="searchFrm()" showNoRight="false" style="margin-right: 5px">查询</f:a>
                    <a class="mini-button btn-red" style="margin-right: 5px" plain="true" onclick="clearForm()">清空查询</a>
                    <f:a alias="componentTestNotPassList-exportItem" onclick="exportItem()" showNoRight="false" style="margin-right: 5px">导出</f:a>
                </li>
            </ul>
        </form>
...
<div class="mini-fit" style="height: 100%;">
    <div id="businessListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         ...
         url="${ctxPath}/componentTest/core/result/dataNotPassListQuery.do">
        <div property="columns">
            ...
            <div field="nonconformingDescription" width="130" headerAlign="center" align="center" allowSort="true" renderer="render">不合格项说明</div>
        </div>
    </div>
</div>
<!--导出Excel相关HTML-->
<form id="excelForm" action="${ctxPath}/componentTest/core/result/exportNotPass.do" method="post" target="excelIFrame">
