...
<head>
    ...
    <script src="${ctxPath}/scripts/multiFileUpload/multiProductUpload.js" type="text/javascript"></script>
...
<div class="mini-panel" id="fileUploadDiv" style="width: 100%; height: 100%" showfooter="true" bodystyle="padding:0" borderStyle="border:0"
    ...
    <div id="multiupload1" class="mini-datagrid"  allowSortColumn="false" multiSelect="false" idField="id"
        ...
        <div property="columns">
            ...
            <div field="productIds" displayField="productNames" headerAlign="center" align="center" width="120">适用产品<span style="color: #ff0000">*</span>
...
<script type="text/javascript">
    ...
    var includeProductIds = "${includeProductIds}";
