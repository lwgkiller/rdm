...
<div class="mini-fit" style="height: 100%;">
    <div id="listGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/info/core/enterprise/gn/list.do" idField="id"
...
<script type="text/javascript">
    ...
    var url = "${ctxPath}/info/core/enterprise/gn/list.do";
    ...
    function saveAchievementType() {
        ...
        if (data.length > 0) {
            ...
            $.ajax({
                url: jsUseCtxPath + "/info/core/enterprise/gn/batchOptions.do",
                data: json,
                type: "post",
