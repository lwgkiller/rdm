...
<div class="mini-fit" style="height: 100%;">
    <div id="typeConfigGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/info/busTypeConfig/busInfoTypeList.do"
        ...
        <div property="columns">
            ...
            <div field="busTypeName" name="busTypeName" width="100" headerAlign="center" align="center">业务方向<span
...
<script type="text/javascript">
    ...
    function addRow() {
        ...
        typeConfigGrid.beginEditCell(newRow, "busTypeName");
    }
    ...
    function saveRow() {
        ...
        if (data.length > 0) {
            ...
            if (needReload) {
                ...
                $.ajax({
                    url: jsUseCtxPath + "/info/busTypeConfig/dealData.do",
                    data: json,
                    type: "post",
