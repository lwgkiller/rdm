...
<body>
<div id="jptzFileUpload" class="mini-panel" style="width: 100%; height: 100%" showfooter="false" bodystyle="padding:0" borderStyle="border:0"
     showheader="false">
    ...
    <div id="jptzFileUploadGrid" class="mini-datagrid"  allowResize="false" idField="id"
...
<script type="text/javascript">
    ...
    var jptzFileUploadGrid = mini.get("#jptzFileUploadGrid");
    var belongId = "";
    ...
    jQuery('#jptzFileUpload').Huploadify({
        sendFileAttr:["belongId","fileName","fileSize"],
        uploadFileList:jptzFileUploadGrid,
        url:jsUseCtxPath+'/info/core/jptz/file/upload.do',
