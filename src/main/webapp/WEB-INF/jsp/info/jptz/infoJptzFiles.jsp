...
<div class="mini-fit" style="height: 100%;">
    <div id="listGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         url="${ctxPath}/info/core/jptz/jptzFile/list.do" idField="id"
...
<script type="text/javascript">
    ...
    var url = "${ctxPath}/info/core/jptz/jptzFile/list.do";
    ...
    function addAchievementType() {
        mini.open({
            title: "文件上传",
            url: jsUseCtxPath + "/info/core/jptz/filesUpload/page.do",
            width: 750,
            height: 450,
            showModal:false,
            allowResize: true,
    ...
    function previewPdf(field, fileName, belongId, coverConent) {
        ...
        var previewUrl = jsUseCtxPath + "/info/core/jptz/downOrPdfPreview.do?action=preview&fileName=" + encodeURIComponent(fileName) + "&belongId=" + belongId + "&fileId=" + field;
    ...
    function previewPic(field, fileName, belongId) {
        ...
        var previewUrl = jsUseCtxPath + "/info/core/jptz/imagePreview.do?fileName=" + encodeURIComponent(fileName) + "&belongId=" + belongId + "&fileId=" + field;
        let open = window.open('_blank');
    ...
    function previewDoc(field, fileName, belongId, coverContent) {
        ...
        var previewUrl = jsUseCtxPath + "/info/core/jptz/officePreview.do?fileName=" + encodeURIComponent(fileName) + "&belongId=" + belongId + "&fileId=" + field;
        let open = window.open('_blank');
    ...
    function downLoadFile (uid) {
        ...
        form.attr("action", jsUseCtxPath + "/info/core/jptz/file/download.do");
    ...
    function removeFile (uid) {
        ...
        mini.confirm("确定删除？", "确定？",
            function (action) {
                if (action == "ok") {
                    $.ajax({
                        url:jsUseCtxPath + "/info/core/jptz/file/delete.do?id="+rowData.id+"&belongId="+belongId+"&fileName="+rowData.fileName,
    ...
    function saveAchievementType() {
        ...
        if (data.length > 0) {
            ...
            $.ajax({
                url: jsUseCtxPath + "/info/core/jptz/jptzFile/batchOptions.do",
                data: json,
                type: "post",
