			...
			<table cellspacing="1" cellpadding="0" class="table-detail column-four grey">
				...
				<tr>
					...
					<td align="left" colspan="3">
						<input name="patentName" class="mini-textbox rxc" plugins="mini-textbox" vtype="length:50"  onvalidation=""
				...
				<tr>
					...
					<td align="left">
						<input name="patentType" class="mini-textbox rxc" plugins="mini-textbox" vtype="length:50"  onvalidation=""
					...
					<td align="left">
						<input name="publishCode" class="mini-textbox rxc" plugins="mini-textbox" vtype="length:50"  onvalidation=""
							   datatype="varchar" length="50" decimal="0" minnum="" maxnum="" validrule="" from="forminput" required="true" only_read="false" allowinput="true" value="" format="" emptytext="" sequence="" scripts="" mwidth="100" wunit="%" mheight="34" hunit="px" style="width:100%;height:34px"/>
					</td>
				</tr>
				<tr>
					...
					<td align="left" >
						<input name="applyPerson" class="mini-textbox rxc" plugins="mini-textbox" vtype="length:50"  onvalidation=""
							   datatype="varchar" length="50" decimal="0" minnum="" maxnum="" validrule="" from="forminput" required="true" only_read="false" allowinput="true" value="" format="" emptytext="" sequence="" scripts="" mwidth="100" wunit="%" mheight="34" hunit="px" style="width:100%;height:34px"/>
					</td>
					<td align="center" style="white-space: nowrap;">
						申请日期：
				...
				<tr>
					...
					<td align="left" >
						<input name="typeCode" class="mini-textbox rxc" plugins="mini-textbox" vtype="length:50"  onvalidation=""
							   datatype="varchar" length="50" decimal="0" minnum="" maxnum="" validrule="" from="forminput" required="true" only_read="false" allowinput="true" value="" format="" emptytext="" sequence="" scripts="" mwidth="100" wunit="%" mheight="34" hunit="px" style="width:100%;height:34px"/>
					</td>
					<td align="center" style="white-space: nowrap;">
						公开日：
...
<script type="text/javascript">
	...
	var action = '${action}';
	var patentForm = new mini.Form("#patentForm");
	...
	$(function () {
		if(action!='add'){
			patentForm.setData(applyObj);
			setContent(applyObj.content);
		}
		if (action == 'view') {
			patentForm.setEnabled(false);
			$('#save').hide();
		}
	})
	function saveData() {
		patentForm.validate();
		if (!patentForm.isValid()) {
			return;
		}
		var formData = patentForm.getData();
		formData.content=getContent();
		var config = {
			url: jsUseCtxPath+"/info/patent/save.do",
			method: 'POST',
			data: formData,
