...
<div class="mini-fit" style="height: 100%;">
    <div id="fileListGrid" class="mini-datagrid" style="width: 100%; height: 100%"
         ...
         url="${ctxPath}/Info/Qbgz/getQbgzFileList.do?qbgzId=1"
...
<script type="text/javascript">
    ...
    function operationRenderer(e) {
        var record = e.record;
        var cellHtml = '';
        cellHtml=returnJstbPreviewSpan(record.fileName,record.fileId,record.belongId,coverContent);
        cellHtml+='&nbsp;&nbsp;&nbsp;<span title="下载" style="color:#409EFF;cursor: pointer;" ' +
            'onclick="downLoadJstbFile(\''+record.fileName+'\',\''+record.fileId+'\',\''+record.belongId+'\')">下载</span>';
    ...
    function fileupload() {
        mini.open({
            title: "添加附件",
            url: jsUseCtxPath + "/Info/Qbgz/openUploadWindow.do?qbgzId=1",
            width: 850,
            height: 550,
            showModal:true,
            allowResize: true,
