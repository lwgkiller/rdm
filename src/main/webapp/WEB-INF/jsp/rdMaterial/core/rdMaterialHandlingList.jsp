        ...
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                <li style="margin-right:15px">
                    <span class="text" style="width:auto">处理单据号：</span>
                    <input class="mini-textbox" id="businessNo" name="businessNo" style="width:100%;"/>
                </li>
                <li style="margin-right:15px">
                    <span class="text" style="width:auto">处置部门：</span>
                    <input class="mini-textbox" id="responsibleDep" name="responsibleDep" style="width:100%;"/>
                </li>
                <li style="margin-right:15px">
                    <span class="text" style="width:auto">处置人员：</span>
                    <input class="mini-textbox" id="responsibleUser" name="responsibleUser" style="width:100%;"/>
                </li>
                <li style="margin-right: 15px">
                    <span class="text" style="width:auto">处置日期：</span>
                    <input id="handlingDateBegin" name="handlingDateBegin" class="mini-datepicker" format="yyyy-MM-dd"
                           showTime="false" showOkButton="false" showClearButton="true" style="width:98%;"/>
                </li>
                <li style="margin-right: 15px">
                    <span class="text-to" style="width:auto">至：</span>
                    <input id="handlingDateEnd" name="handlingDateEnd" class="mini-datepicker" format="yyyy-MM-dd"
                           showTime="false" showOkButton="false" showClearButton="true" style="width:98%;"/>
                </li>
...
<div class="mini-fit" style="height: 100%;">
    <div id="businessListGrid" idField="id" class="mini-datagrid" style="width: 100%; height: 100%;"
         ...
         url="${ctxPath}/rdMaterial/core/handling/dataListQuery.do">
        <div property="columns">
            ...
            <div field="businessNo" width="130" headerAlign="center" align="center" allowSort="true">处理单据号</div>
            <div field="responsibleDep" width="130" headerAlign="center" align="center" allowSort="true">处置部门</div>
            <div field="responsibleUser" width="130" headerAlign="center" align="center" allowSort="true">处置人员</div>
            <div field="handlingDate" width="100" headerAlign="center" align="center" allowSort="true" dateFormat="yyyy-MM-dd">处置日期</div>
...
<script type="text/javascript">
    ...
    function addBusiness() {
        var url = jsUseCtxPath + "/rdMaterial/core/handling/editPage.do?businessId=&action=add";
    ...
    function editBusiness(businessId) {
        var url = jsUseCtxPath + "/rdMaterial/core/handling/editPage.do?businessId=" + businessId + "&action=edit";
        var winObj = window.open(url, '');
        var loop = setInterval(function () {
            if (winObj.closed) {
                clearInterval(loop);
    ...
    function detailBusiness(businessId) {
        var url = jsUseCtxPath + "/rdMaterial/core/handling/editPage.do?businessId=" + businessId + "&action=detail";
        var winObj = window.open(url, '');
        var loop = setInterval(function () {
            if (winObj.closed) {
                clearInterval(loop);
    ...
    function deleteBusiness(record) {
        ...
        mini.confirm("确定删除选中记录？", "提示", function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/rdMaterial/core/handling/deleteBusiness.do",
                    method: 'POST',
    ...
    function onActionRenderer(e) {
        ...
        if (currentUserNo == 'admin' || (isYanFaWuLiaoGuanLiYuan == "true" && '编辑中' == record.businessStatus)) {
