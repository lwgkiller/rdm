...
<div class="mini-fit" style="width: 100%; height: 100%;background: #fff">
    ...
    <div id="requestToolBar" class="topToolBar">
        <div style="position: relative!important;">
            ...
            <a class="mini-button" style="float: left" plain="true" id="exDemand"
    ...
    <div id="requestListGrid" class="mini-datagrid" allowResize="false" style="height: 46%"
        ...
        <div property="columns">
            ...
            <div field="requestDesc" headerAlign="center" width="750px" align="left"
                 >要求描述<span style="color:red">*</span>
            </div>
...
<div id="selectDemandWindow" title="选择部门需求" class="mini-window" style="width:750px;height:450px;"
    ...
    <div class="mini-fit">
        <div id="selectDemandListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
             idField="id" showColumnsMenu="false" autoload="false"
...
<div id="requestWindow" title="要求编辑" class="mini-window" style="width:950px;height:700px;"
     showModal="true" showFooter="true" allowResize="true" showCloseButton="false">
    <div class="mini-fit">
        <div class="topToolBar" style="float: right;">
            <div style="position: relative!important;">
        ...
        <table class="table-detail"  cellspacing="1" cellpadding="0" style="width: 99%">
            ...
            <tr>
                <td style="width: 8%;">变化点带来的与该要求相关<br>的客观影响(500字以内)：<span style="color:red">*</span></td>
                <td style="width: 92%;" colspan="3">
            ...
            <tr>
                ...
                <td style="width: 92%;">
                    <input id="riskLevel" name="riskLevel" class="mini-combobox" style="width:98%;"
                           textField="text" valueField="key_" emptyText="请选择..."
                           required="false" allowInput="false" showNullItem="false"
                           url="${ctxPath}/sys/core/commonInfo/getDicItem.do?dicType=FXPJ"/>
                </td>
            </tr>
            <tr>
                <td style="width: 15%">接口名称：</td>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        if (collectType=='collectType'){
            $("#exDemand").attr("style","display:none;");
            $("#exFunction").attr("style","display:none;");
            querySingleIdInterface(belongCollectFlowId);
            var urlFunction = "${ctxPath}/drbfm/single/getFunctionInterfaceList.do?belongCollectFlowId=${belongCollectFlowId}";
            functionListGrid.setUrl(urlFunction);
            functionListGrid.reload();
            var urlRequest = "${ctxPath}/drbfm/single/getRequestInterfaceList.do?belongCollectFlowId=${belongCollectFlowId}";
            requestListGrid.setUrl(urlRequest);
    ...
    function saveFunction() {
        ...
        var data = {id:id,functionDesc:functionDesc,relDimensionKeys:relDimensionKeys,
            ...
            interfaceRequestStructId:interfaceRequestStructId,belongCollectFlowId:belongCollectFlowId};
    ...
    function selectDemandClick() {
        ...
        if (collectType=='collectType' && belongCollectFlowId){
            var url="${ctxPath}/drbfm/single/getSingleDeptDemandList.do?belongSingleId=" + singleId;
            selectDemandListGrid.setUrl(url);
            selectDemandListGrid.reload();
        }
    ...
    function saveRequest() {
        ...
        var data = {id:id,requestDesc:requestDesc,relDimensionKeys:relDimensionKeys,
            relDimensionNames:relDimensionNames,belongSingleId:singleId,requestChanges:requestChanges,
    ...
    function selectFunctionClick() {
        ...
        if (collectType=='collectType' && belongCollectFlowId){
            var url="${ctxPath}/drbfm/single/getFunctionListByCollectId.do?belongCollectFlowId=" + belongCollectFlowId;
            selectFunctionListGrid.setUrl(url);
            selectFunctionListGrid.reload();
        }
