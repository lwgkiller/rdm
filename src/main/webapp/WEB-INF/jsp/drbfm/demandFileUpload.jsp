...
<script type="text/javascript">
    ...
    function initUpload() {
        $('#fileUploadDiv').Huploadify({
            formData: {relDemandId:relDemandId},
            sendFileAttr: ["fileName", "fileSize"],
            uploadFileList: multiuploadGrid,
            url: jsUseCtxPath + '/drbfm/single/uploadDemand.do?relDemandId=' + relDemandId + "&belongSingleId=" + belongSingleId,
