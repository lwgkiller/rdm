...
<div id="detailToolBar" class="topToolBar">
    <div>
        <a id="commitData" class="mini-button" onclick="commitData()">保存</a>
        ...
        <form id="testTaskForm" method="post">
            ...
            <table class="table-detail grey" cellspacing="1" cellpadding="0">
                <caption style="font-weight: bold;font-size: 20px !important;">
                    常规附带验证任务编辑页面
                    <span style="color: red;font-size: 15px">(注：产品所填写验证结果)</span>
                </caption>
                <tr>
                    <td style="width: 20%">验证任务编号：<br>(保存后自动生成)</td>
                ...
                <tr>
                    ...
                    <td colspan="3">
						<textarea id="testContent" name="testContent" class="mini-textarea rxc"
                                  ...
                                  allowinput="true"
                                  emptytext="请输入验证内容..." mwidth="80" wunit="%" mheight="150" hunit="px"> </textarea>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left;width: 20%;height:350px">指标及验证数据：<span style="color:red">*</span></td>
                    <td colspan="3" >
                        <div class="mini-toolbar" style="margin-bottom: 5px" id="testTaskListToolBar">
                            <a class="mini-button" id="addTestTaskRow" plain="true" onclick="addTestTaskRow">新增</a>
                        ...
                        <div id="testTaskGrid" class="mini-datagrid"
                            ...
                            <div property="columns">
                                ...
                                <div id="sjStandardIds" field="sjStandardIds" width="200"
                                     ...
                                     align="center"
                                >设计标准<br><span style="color: red">(指标未锁定状态下，可在此处完善)</span>
                                    <input
                                           property="editor" class="mini-buttonedit"
                                           showClose="true"
                                           allowInput="false"
                                ...
                                <div id="testStandardIds" field="testStandardIds"  width="200"
                                     ...
                                     align="center"
                                >测试标准<br><span style="color: red">(指标未锁定状态下，可在此处完善)</span>
                                    <input
                                           property="editor" class="mini-buttonedit"
                                           showClose="true"
                                           allowInput="false"
                                ...
                                <div id="evaluateStandardIds" field="evaluateStandardIds"
                                     ...
                                     headerAlign="center"
                                     align="center"
                                >评价标准<br><span style="color: red">(指标未锁定状态下，可在此处完善)</span>
                                    <input
                                           property="editor" class="mini-buttonedit"
                                           showClose="true"
                                           allowInput="false"
                ...
                <tr>
                    <td style="width: 20%;height: 200px">验证方案及报告：（验证报告必传）<span style="color:red">*</span></td>
                    <td colspan="3">
                        <div class="mini-toolbar" style="margin-bottom: 5px" id="fileListToolBar">
                            ...
                            <span style="color: red">注：添加附件前，请先点击上方“保存”按钮</span>
                        </div>
                ...
                <tr>
                    ...
                    <td colspan="3" height="80px">
                        <div class="mini-toolbar" style="margin-bottom: 5px" id="nextWorkListToolBar">
                            ...
                            <span style="color: red">注：添加前，请先点击上方“保存”按钮</span>
                        </div>
...
<script type="text/javascript">
    ...
    function getData() {
        ...
        if (formData.SUB_nextWorkListGrid) {
            delete formData.SUB_nextWorkListGrid;
        }
    ...
    function addTestTaskFile() {
        ...
        mini.open({
            title: "文件上传",
            url: jsUseCtxPath + "/drbfm/testTask/openUploadWindow.do?applyId=" + applyId + "&belongSingleId" + singleId,
            width: 850,
            height: 450,
            showModal: false,
            allowResize: true,
    ...
    function commitData() {
        ...
        $.ajax({
            url: jsUseCtxPath + '/drbfm/testTask/noFlowTestTaskSave.do',
            type: 'post',
            async: false,
                ...
                if (returnData) {
                    ...
                    mini.showMessageBox({
                        ...
                        callback: function (action) {
                            if(action=="ok" && returnData.success){
                                var url=jsUseCtxPath + "/drbfm/testTask/testTaskEditPage.do?action=edit&applyId=" + returnData.data +"&testType=常规附带";
    ...
    function validTestTask() {
        ...
        if (demandGridData.length == 0) {
            mini.alert("请增加“指标及验证数据”");
            return;
        }
        for (var i = 0; i < demandGridData.length; i++) {
            if (!demandGridData[i].relQuotaId) {
                return {"result": false, "message": "请填写指标名称"};
            }
            if (!demandGridData[i].quotaTestValue) {
                return {"result": false, "message": "请填写指标实测值"};
            }
            if (!demandGridData[i].testResult) {
