...
<div id="fileUploadDiv" class="mini-panel" style="width: 100%; height: 100%" showfooter="false" bodystyle="padding:0" borderStyle="border:0"
    ...
    <div class="mini-toolbar">
        <a class="mini-button file-select" iconCls="icon-search" >browse files</a>
        <a class="mini-button file-upload" iconCls="icon-upload" name="multiupload">Batch upload</a>
        <a class="mini-button file-clear" iconCls="icon-remove" name="removeAll">clear list</a>
    </div>
    <div id="multiuploadGrid" class="mini-datagrid"  allowSortColumn="false" multiSelect="false" idField="id"
        ...
        <div property="columns">
            ...
            <div field="fileName" headerAlign="center" width="110" >fileName
                <input property="editor" class="mini-textbox" readonly/>
            </div>
            <div field="fileSize" width="50" headerAlign="center" align="center">fileSize
                <input property="editor" class="mini-textbox" readonly/>
            </div>
            <div field="complete" width="80" headerAlign="center" align="center" renderer="onProgressRenderer">complete
            </div>
            <div field="status" width="60" headerAlign="center" align="center">status
                <input property="editor" class="mini-textbox" readonly/>
            </div>
            <div field="action" width="30" headerAlign="center" align="center">action
            </div>
        </div>
    </div>
</div>
