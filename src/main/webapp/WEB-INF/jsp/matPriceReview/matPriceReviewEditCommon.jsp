...
<html>
<head>
	<title>采购物料价格审批</title>
	<%@include file="/commons/edit.jsp"%>
	<script src="${ctxPath}/scripts/matPriceReview/matPriceReviewEditCommon.js?version=${static_res_version}"
	...
	<div class="form-container" style="margin: 0 auto">
		<form id="materielApplyForm" method="post">
			...
			<table class="table-detail grey" cellspacing="1" cellpadding="0" style="height: 200px">
				...
				<tr>
                    ...
                    <td >
                        <input id="applyCategory" name="applyCategory" class="mini-combobox" style="width:98%;"
                               ...
                               data="[ {'key' : '新增','value' : '新增'},{'key' : '涨价','value' : '涨价'},{'key' : '降价','value' : '降价'}]"
                        />
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 7%">价格执行时间：</td>
                    <td style="width: 18%">
                        <input name="jgExcuteStart"  id="jgExcuteStart" class="mini-datepicker" format="yyyy-MM-dd" style="width:46%;" />
                        至
                        <input name="jgExcuteEnd" id="jgExcuteEnd"  class="mini-datepicker" format="yyyy-MM-dd" style="width:46%;" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <input id="priceDesc" name="priceDesc" class="mini-textarea" style="width:98%;height:110px"
                               emptytext="具体填写规范：1、采购原因；2、价格变动情况，涨降幅等；3、采购价格对比，同类商品对比和不同供应商价格对比；4、价格执行时间；5、其他说明。"/>
                    </td>
                    <td >附件：</td>
                    <td colspan="3">
                        <a id="uploadFile" class="mini-button" style="margin-bottom: 5px;margin-top: 5px;" onclick="addMatPriceReviewFile">附件列表</a><br>
                        <span>附件上传：1、价格审批表明细清单。2、供应商报价单（多次）。3、《徐工挖机价格审批同类产品对比表》。4、《徐工挖机价格审批供应商比价表》。5、其他资料。</span>
                    </td>
		...
		<div id="materielGrid" class="mini-datagrid"  allowResize="false" url="${ctxPath}/matPriceReview/core/getMatDetailList.do?reviewId=${matPriceReviewObjId}"
			...
			<div property="columns">
				...
				<div field="sbjg" width="90px" headerAlign="center" align="center" >申报价/原执行价格<br>(含税)</div>
				<div field="pzjghs"  width="70px" headerAlign="center" align="center" >批准价<br>(含税)</div>
				<div field="pzjgbhs" width="70px"  headerAlign="center" align="center" >批准价<br>(不含税)</div>
				<div field="yfcdf" width="85px"  headerAlign="center" align="center" >运费承担方</div>
				<div field="jzdsjgbhs" width="90px"  headerAlign="center" align="center" >竞争对手价格<br>(不含税)</div>
				<div field="zjf" width="70px" headerAlign="center" align="center" >涨降幅</div>
        ...
        <form id="matDetailForm" method="post">
            ...
            <table cellspacing="1" cellpadding="0" class="table-detail column-six grey" style="width: 99%">
                ...
                <tr>
                    ...
                    <td align="center" style="width: 10%">申报价/原执行价格(含税)：<span style="color:red">*</span></td>
                    <td align="center" style="width: 40%">
                        <input id="sbjg" name="sbjg" class="mini-textbox" style="width:98%;height:34px;"/>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="width: 10%">批准价(含税)：<span style="color:red">*</span></td>
                    <td align="center" style="width: 40%">
                        <input id="pzjghs" name="pzjghs" class="mini-textbox" style="width:98%;height:34px;"/>
                    </td>
                    <td align="center" style="width: 10%">批准价(不含税)：<span style="color:red">*</span></td>
                    <td align="center" style="width: 40%">
                        <input id="pzjgbhs" name="pzjgbhs" class="mini-textbox" style="width:98%;height:34px;"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="center" style="width: 10%">竞争对手价格(不含税)：</td>
                    <td align="center" style="width: 40%">
                        <input id="jzdsjgbhs" name="jzdsjgbhs" class="mini-textbox" style="width:98%;height:34px;"/>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="width: 10%">涨降幅：</td>
                    <td align="center" style="width: 40%">
                        <input id="zjf" name="zjf" class="mini-textbox" style="width:98%;height:34px;"/>
                    </td>
