...
<head>
    ...
    <script src="${ctxPath}/scripts/xcmgjssjk/jssjkFileUpload.js?version=${static_res_version}" type="text/javascript"></script>
...
<body>
    ...
    <div class="mini-fit" style="height: 100%;">
        <div id="targetFileInfoGrid" class="mini-datagrid" style="height: 100%;" allowResize="false"
            ...
            <div property="columns">
                <div field="PRID"  headerAlign="left" visible="false">id</div>
                <div type="indexcolumn" headerAlign="center">序号</div>
                <div field="FJMC" align="center" headerAlign="center" width="150">文件名</div>
                <div field="FJDX" align="center"  headerAlign="center"  width="60" >文件大小</div>
                <div field="GGCJRID" align="center"  headerAlign="center" width="80" >创建人</div>
                <div field="GGCJSJ" align="center" dateFormat="yyyy-MM-dd HH:mm:ss" headerAlign="center"  width="120">创建时间</div>
    ...
    <script type="text/javascript">
        ...
        var url=jsUseCtxPath+"/jssj/core/config/getFileList.do?standardId="+standardId + "&fjlx=" + fjlx;
        ...
        function uploadCompleteFile() {
            mini.open({
                title: "文件上传",
                url: jsUseCtxPath + "/jssj/core/config/openUploadWindow.do",
                width: 650,
                height: 350,
                showModal:false,
                allowResize: true,
