    ...
    <div class="searchBox">
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                ...
                <li style="margin-right: 15px;display: none"><span class="text" style="width:auto">审批状态: </span>
                    <input id="businessStatus" name="businessStatus" class="mini-combobox" style="width:98%"
                           ...
                           data="[{'key': 'A-editing', 'value': '提交缺词物料信息'},
                                  {'key': 'AchineseReviewing', 'value': '建议中文初审'},
                ...
                <li style="margin-left: 10px">
                    <f:a alias="multiLanguageBuild-searchFrm" onclick="searchFrm()" showNoRight="false" style="margin-right: 5px">查询</f:a>
                    <a class="mini-button btn-red" style="margin-right: 5px" plain="true" onclick="clearForm()">清空查询</a>
                    <f:a alias="multiLanguageBuild-addBusiness" onclick="addBusiness()" showNoRight="false" style="margin-right: 5px">新增</f:a>
                    <f:a alias="multiLanguageBuild-removeBusiness" onclick="removeBusiness()" showNoRight="false"
...
<div class="mini-fit" style="height: 100%;">
    <div id="businessListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         ...
         url="${ctxPath}/serviceEngineering/core/multiLanguageBuild/dataListQuery.do">
        <div property="columns">
            <div type="checkcolumn" width="20"></div>
            <div type="indexcolumn" width="35" headerAlign="center" align="center">序号</div>
            <div name="action" cellCls="actionIcons" width="80" headerAlign="center" align="center" renderer="onActionRenderer"
                 cellStyle="padding:0;">操作
            </div>
            <div field="designModel" width="130" headerAlign="center" align="center" allowSort="true" renderer="render">设计型号</div>
            <div field="applyUser" width="40" headerAlign="center" align="center" allowSort="true" renderer="render">发起人</div>
            <div field="chReviewer" width="40" headerAlign="center" align="center" allowSort="true" renderer="render">中文审核人</div>
            <div field="enReviewer" width="40" headerAlign="center" align="center" allowSort="true" renderer="render">英文审核人</div>
            <div field="multilingualReviewer" width="40" headerAlign="center" align="center" allowSort="true" renderer="render">多语言翻译人</div>
            <div field="currentProcessUser" sortField="currentProcessUser" width="40" align="center" headerAlign="center"
                 allowSort="false" renderer="render">当前处理人
            </div>
            <div field="currentProcessTask" width="60" align="center" headerAlign="center">当前流程任务</div>
            <div field="status" width="60" headerAlign="center" align="center" renderer="onStatusRenderer">流程状态</div>
            <%--<div field="businessStatus" width="80" headerAlign="center" align="center" renderer="onBusinessStatusRenderer">审批状态</div>--%>
            <div field="applyDate" width="50" headerAlign="center" align="center" allowSort="true" renderer="render"
...
<!--导出Excel相关HTML-->
<form id="excelForm" action="${ctxPath}/serviceEngineering/core/multiLanguageBuild/exportList.do" method="post" target="excelIFrame">
...
<script type="text/javascript">
    ...
    function addBusiness() {
        var url = jsUseCtxPath + "/bpm/core/bpmInst/multiLanguageBuild/start.do";
    ...
    function businessDetail(businessId, status) {
        var action = "detail";
        var url = jsUseCtxPath + "/serviceEngineering/core/multiLanguageBuild/editPage.do?action=" + action +
    ...
    function removeBusiness(record) {
        ...
        mini.confirm("确定删除选中记录？", "提示", function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/serviceEngineering/core/multiLanguageBuild/deleteBusiness.do",
                    method: 'POST',
                    showMsg: false,
    ...
    //..状态渲染
    function onBusinessStatusRenderer(e) {
        var record = e.record;
