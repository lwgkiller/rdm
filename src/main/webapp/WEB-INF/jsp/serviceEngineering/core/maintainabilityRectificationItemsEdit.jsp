...
<div class="mini-fit">
    <div class="form-container" style="margin: 0 auto; width: 80%;">
        <form id="formMaintainabilityRectificationItems" method="post">
            ...
            <input id="approverUserId" name="reviewerUserId" class="mini-hidden"/>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <div id="fileListGrid" class="mini-datagrid" style="width: 100%; height: 85%" allowResize="false"
                             idField="id" url="${ctxPath}/serviceEngineering/core/maintainability/rectificationitems/getFileList.do?businessId=${businessId}"
                             autoload="true"
...
<script type="text/javascript">
    ...
    var formMaintainabilityRectificationItems = new mini.Form("#formMaintainabilityRectificationItems");
    ...
    //..
    $(function () {
        var url = jsUseCtxPath + "/serviceEngineering/core/maintainability/rectificationitems/getDetail.do";
        $.post(
            url,
            {businessId: businessId},
            function (json) {
                formMaintainabilityRectificationItems.setData(json);
                if (action == 'detail') {
                    formMaintainabilityRectificationItems.setEnabled(false);
    ...
    //..流程引擎调用此方法进行表单数据的获取
    function getData() {
        var formData = _GetFormJsonMini("formMaintainabilityRectificationItems");
    ...
    function saveBusinessInProcess() {
        ...
        $.ajax({
            url: jsUseCtxPath + '/serviceEngineering/core/maintainability/rectificationitems/saveBusiness.do',
            type: 'post',
            async: false,
    ...
    function addBusinessFile() {
        ...
        mini.open({
            title: "文件上传",
            url: jsUseCtxPath + "/serviceEngineering/core/maintainability/rectificationitems/fileUploadWindow.do?businessId=" + businessId,
            width: 750,
            height: 450,
            showModal: false,
            allowResize: true,
    ...
    function operationRenderer(e) {
        ...
        if (action == 'edit' || (action == 'task' && isBianzhi == 'yes')) {
            var deleteUrl = "/serviceEngineering/core/maintainability/rectificationitems/delFile.do"
    ...
    function returnPreviewSpan(fileName, fileId, formId, coverContent) {
        ...
        if (fileType == 'other') {
            ...
            var url = '/serviceEngineering/core/maintainability/rectificationitems/PdfPreview.do';
            s = '<span  title="预览" style="color:#409EFF;cursor: pointer;" onclick="previewPdf(\'' + fileName + '\',\'' + fileId + '\',\'' + formId + '\',\'' + coverContent + '\',\'' + url + '\')">预览</span>';
        } else if (fileType == 'office') {
            var url = '/serviceEngineering/core/maintainability/rectificationitems/OfficePreview.do';
            s = '<span  title="预览" style="color:#409EFF;cursor: pointer;" onclick="previewDoc(\'' + fileName + '\',\'' + fileId + '\',\'' + formId + '\',\'' + coverContent + '\',\'' + url + '\')">预览</span>';
        } else if (fileType == 'pic') {
            var url = '/serviceEngineering/core/maintainability/rectificationitems/ImagePreview.do';
