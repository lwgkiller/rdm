...
<script type="text/javascript">
    ...
    var url = jsUseCtxPath + "/serviceEngineering/core/bucketConfiguration/getFileListInfos.do?businessId=" +
    ...
    function uploadFile() {
        ...
        url = "/serviceEngineering/core/bucketConfiguration/openFileUploadWindow.do?businessId=" + businessId +
    ...
    function fileRenderer(e) {
        ...
        var cellHtml = '';
        var previewUrls = {
            pdf: "/serviceEngineering/core/bucketConfiguration/pdfPreview.do",
            office: "/serviceEngineering/core/bucketConfiguration/officePreview.do",
            pic: "/serviceEngineering/core/bucketConfiguration/imagePreview.do"
        };
