...
<div class="mini-panel" id="fileUploadDiv" style="width: 100%; height: 100%" showfooter="true" bodystyle="padding:0" borderStyle="border:0"
    ...
    <div class="mini-toolbar">
        ...
        <a class="mini-button file-upload" iconCls="icon-upload" name="multiupload">批量上传</a>
...
<script type="text/javascript">
    ...
    function initUpload() {
        $('#fileUploadDiv').Huploadify({
            ...
            uploadFileList: grid,
            url: jsUseCtxPath + '/serviceEngineering/core/decorationManualTopic/fileUpload.do',
