...
<div class="mini-fit" style="height: 100%;">
    <div id="businessListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false" allowCellWrap="true"
         ...
         url="${ctxPath}/serviceEngineering/core/replacementRelationship/dataListQuery.do">
        <div property="columns">
            ...
            <div field="replaceType" width="160" headerAlign="center" align="center" allowSort="true">替换类型</div>
            <div field="replaceTypeOri" width="140" headerAlign="center" align="center" allowSort="true">信息源替换类型</div>
            <div field="applicableModels" width="160" headerAlign="center" align="center" allowSort="true">适用机型</div>
            <div field="WIPHandlingComments" width="160" headerAlign="center" align="center" allowSort="true">制品处理意见</div>
            <div field="informationSources" width="160" headerAlign="center" align="center" allowSort="true">信息来源</div>
...
<script type="text/javascript">
    ...
    function addBusiness() {
        var url = jsUseCtxPath + "/bpm/core/bpmInst/replacementRelationship/start.do";
    ...
    function businessDetail(businessId, status) {
        var action = "detail";
        var url = jsUseCtxPath + "/serviceEngineering/core/replacementRelationship/editPage.do?action=" + action +
    ...
    function removeBusiness(record) {
        ...
        mini.confirm('确定删除选中记录', '提示', function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/serviceEngineering/core/replacementRelationship/deleteBusiness.do",
                    method: 'POST',
                    showMsg: false,
