...
<div class="mini-fit" style="height: 100%;">
    <div id="businessListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false" allowCellWrap="true"
         ...
         url="${ctxPath}/serviceEngineering/core/mixedinput/discardDataListQuery.do">
...
<script type="text/javascript">
    ...
    function addBusiness() {
        var url = jsUseCtxPath + "/bpm/core/bpmInst/mixedinputDiscardApply/start.do";
    ...
    function businessDetail(businessId, status) {
        var action = "detail";
        var url = jsUseCtxPath + "/serviceEngineering/core/mixedinput/discardEditPage.do?action=" + action +
    ...
    function removeBusiness(record) {
        ...
        mini.confirm('确定删除选中记录', '提示', function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/serviceEngineering/core/mixedinput/deleteBusinessDiscard.do",
                    method: 'POST',
                    showMsg: false,
