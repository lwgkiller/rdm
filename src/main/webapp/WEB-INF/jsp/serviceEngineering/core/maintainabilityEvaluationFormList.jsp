        ...
        <form id="searchForm" class="search-form" style="margin-bottom: 25px">
            <ul>
                ...
                <li style="margin-left: 10px">
                    <f:a alias="evaluationForm-searchFrm" onclick="searchFrm()" showNoRight="false">查询</f:a>
                    <a class="mini-button btn-red" style="margin-right: 5px" plain="true" onclick="clearForm()">清空查询</a>
                    <f:a alias="evaluationForm-addBusiness" onclick="addBusiness()" showNoRight="false">新增</f:a>
                    <f:a alias="evaluationForm-removeBusiness" onclick="removeBusiness()" showNoRight="false">删除</f:a>
                </li>
            </ul>
        </form>
...
<div class="mini-fit" style="height: 100%;">
    <div id="maintainabilityEvaluationFormListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         allowCellWrap="false"
         ...
         url="${ctxPath}/serviceEngineering/core/maintainability/evaluationform/dataListQuery.do">
...
<script type="text/javascript">
    ...
    var maintainabilityEvaluationFormListGrid = mini.get("maintainabilityEvaluationFormListGrid");
    ...
    function addBusiness() {
        var url = jsUseCtxPath + "/bpm/core/bpmInst/evaluationForm/start.do?";
        var winObj = window.open(url);
        var loop = setInterval(function () {
            if (winObj.closed) {
                clearInterval(loop);
                if (maintainabilityEvaluationFormListGrid) {
                    maintainabilityEvaluationFormListGrid.reload()
                }
            }
        }, 1000);
    }
    ...
    function businessDetail(businessId, status) {
        var action = "detail";
        var url = jsUseCtxPath + "/serviceEngineering/core/maintainability/evaluationform/editPage.do?action=" + action +
    ...
    function removeBusiness(record) {
        ...
        if (record) {
            ...
            rows = maintainabilityEvaluationFormListGrid.getSelecteds();
        }
        if (rows.length <= 0) {
        ...
        mini.confirm("确定删除选中记录？", "提示", function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/serviceEngineering/core/maintainability/evaluationform/deleteBusiness.do",
                    method: 'POST',
                    showMsg: false,
...
<redxun:gridScript gridId="maintainabilityEvaluationFormListGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>