...
<script type="text/javascript">
    ...
    function initUpload() {
        $('#fileUploadDiv').Huploadify({
            ...
            sendFileAttr: ["fileName", "fileSize", "fileDesc", "outFileNum", "outRate", "outDesc"],
            uploadFileList: multiuploadGrid,
            // url: jsUseCtxPath + '/zhgl/core/nbgg/upload.do?applyId=' + applyId + "&detailId=" + detailId ,
            url: jsUseCtxPath + '/serviceEngineering/core/scxxfk/upload.do?applyId=' + applyId + "&detailId=" + detailId,
            ...
            onUploadStart: function (file) {
                ...
                //         if (demandGridData[i].outFileNum == undefined || demandGridData[i].outFileNum == "") {
                //             return {success: false, message: "请填写外发字符数"};
                //         }
                //         if (demandGridData[i].outRate == undefined || demandGridData[i].outRate == "") {
                //             return {success: false, message: "请填写外发重复率"};
                //         }
                //     }
                //
                // }
