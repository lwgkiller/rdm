...
<div class="mini-fit" style="height: 100%;">
    <div id="wgjzlsjSupplierGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         allowCellWrap="true"
         ...
         url="${ctxPath}/serviceEngineering/core/wgjzlsj/supplierReportListQuery.do">
        <div property="columns">
            <div type="indexcolumn" width="35" headerAlign="center" align="center">序号</div>
            <div field="supplier" name="supplier" headerAlign="center" align="center">供应商</div>
...
<script type="text/javascript">
    ...
    var wgjzlsjSupplierGrid = mini.get("wgjzlsjSupplierGrid");

    //必须为要合并的列增加name属性
    wgjzlsjSupplierGrid.on("load", function () {
        wgjzlsjSupplierGrid.mergeColumns(["supplier"]);
    })
    //所有非特殊文本都变成这个格式
    function render(e) {
...
<redxun:gridScript gridId="wgjzlsjSupplierGrid" entityName="" winHeight="" winWidth="" entityTitle="" baseUrl=""/>
</body>
</html>