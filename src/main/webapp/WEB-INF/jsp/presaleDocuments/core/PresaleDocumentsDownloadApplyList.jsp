...
<div class="mini-fit" style="height: 100%;">
    <div id="businessListGrid" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="false"
         ...
         url="${ctxPath}/presaleDocuments/core/downloadapply/dataListQuery.do">
        <div property="columns">
            ...
            <div field="businessNo" width="110" headerAlign="center" align="center" allowSort="true">申请编号</div>
...
<script type="text/javascript">
    ...
    function addBusiness() {
        var url = jsUseCtxPath + "/bpm/core/bpmInst/PresaleDocumentDownloadApply/start.do";
    ...
    function businessDetail(businessId, status) {
        var action = "detail";
        var url = jsUseCtxPath + "/presaleDocuments/core/downloadapply/editPage.do?action=" + action +
    ...
    function removeBusiness(record) {
        ...
        mini.confirm("确定删除选中记录？", "提示", function (action) {
            if (action != 'ok') {
                ...
                _SubmitJson({
                    url: jsUseCtxPath + "/presaleDocuments/core/downloadapply/deleteBusiness.do",
                    method: 'POST',
                    showMsg: false,
