...
<head>
    ...
    <script src="${ctxPath}/scripts/multiFileUpload/h5uploadFile.js?version=${static_res_version}"
            type="text/javascript"></script>
    <script src="${ctxPath}/scripts/standardManager/standardMegFileUpload.js?version=${static_res_version}"
            type="text/javascript"></script>
...
<div class="mini-panel" id="fileUploadDiv" style="width: 100%; height: 100%" showfooter="true" bodystyle="padding:0"
    ...
    <div id="multiupload1" class="mini-datagrid" allowSortColumn="false" multiSelect="false" idField="id"
        ...
        <div property="columns">
            ...
            <div field="typeId" width="100" displayField="typeName" headerAlign="center">附件类别<span style="color:red">*</span>
                <input id="typeSelect" property="editor" class="mini-combobox" style="width:90%;"
                       textField="typename" valueField="id" emptyText="请选择..."
...
<script type="text/javascript">
    ...
    var fileGrid = mini.get("multiupload1");
    var typeInfos =${typeInfos};
    var stageKey = "${stageKey}";
    var applyId = "${applyId}";

    fileGrid.on("cellbeginedit", function (e) {
        console.log("数据", e)
        console.log("typeInfos", typeInfos)
        if ( e.editor != null){
            if(stageKey=='cash'){
                mini.get("typeSelect").setData("[{id:'13',typename:'标准草案标准化意见稿'},{id:'14',typename:'标准征求意见稿'}]");
            }else {
