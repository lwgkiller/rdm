...
<div id="fileUploadDiv" class="mini-panel" style="width: 100%; height: 100%" showfooter="false" bodystyle="padding:0" borderStyle="border:0"
    ...
    <div id="multiuploadGrid" class="mini-datagrid"  allowSortColumn="false" multiSelect="false" idField="id"
        ...
        <div property="columns">
            ...
            <div field="description" width="90" headerAlign="center">备注说明
            <input property="editor" id="description" name="description" class="mini-textarea rxc"  style="width:98%;height:100px;line-height:25px;"
...
<script type="text/javascript">
    ...
    function initUpload(){
        $('#fileUploadDiv').Huploadify({
            ...
            url:jsUseCtxPath+'/standardManager/core/standardFileInfos/upload.do',
