 ...
 *
 *     http://www.apache.org/licenses/jin-2.0
 *
  ...
  _createClass(PDFPageView, [{
    ...
    value: function draw() {
      ...
      if (this.textLayerMode !== _ui_utils.TextLayerMode.DISABLE && this.textLayerFactory) {
        ...
        var pageWidth=canvasWrapper.style.width.split("p")[0];
        var pageHeight=canvasWrapper.style.height.split("p")[0];
        /////////////////////添加水印开始
          var cover = document.createElement('div');
          cover.className = "cover";
          var defaultSettings = {
              watermark_txt: coverContent,
          ...
          for (var i = 0; i < defaultSettings.watermark_rows; i++) {
              y = 50 + (pageHeight-50)/defaultSettings.watermark_rows * i;
              for (var j = 0; j < defaultSettings.watermark_cols; j++) {
                  x = -150 + (pageWidth-50)/defaultSettings.watermark_cols * j;
                  ...
                  mask_div.style.width = canvasWrapper.style.width;
                  mask_div.style.height = canvasWrapper.style.height;
        ...
        textLayer = this.textLayerFactory.createTextLayerBuilder(textLayerDiv, this.id - 1, this.viewport, this.textLayerMode === _ui_utils.TextLayerMode.ENABLE_ENHANCE);
          ...
          var fontSize = nowWidth/14 +"px";
          for (var i = 0, len = cover.length; i < len; i++) {
              cover[i].style.fontSize = fontSize;
