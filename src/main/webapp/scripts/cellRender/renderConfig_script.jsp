...
<body>
	...
	<form id="miniForm">
		<div >
			插入行值变量
			<input class="mini-combobox" name="paramFields"
			...
			<ul id="popVarsMenu" style="display: none" class="mini-menu">
				...
				<li  onclick="appUrlParam('curTenantId')">当前机构Id</li>
			</ul> <a class="mini-menubutton " menu="#popVarsMenu">插入变量</a>
...
//其中F_TOTAL为表单变量
if(!isExport){//导出Excel
    if(F_TOTAL>100){ return "超额"; }
	else{ return "正常"; }
}else{//HTML输出
    if(F_TOTAL>100){ return "<span color='red'>超额</span>"; }
	else{ return "<span color='green'>正常</span>"; }
}
	</pre>
</div>
	</form>
