	...
	<div class="mini-fit" >
		<div style="width:100%;text-align: center">
			<div style="margin-left:auto;margin-right: auto;padding:5px;">
				<form id="miniForm">
					<table class="table-detail column-four table-align" cellpadding="1" cellspacing="0">
						<tr>
							<td width="120">值来源</td>
						...
						<tr class="url_row" style="display:none">
							<td width="15%">
								JSON URL
							</td>
						...
						<tr class="url_row" style="display:none">
							<td>文本字段:</td>
							<td><input id="url_textfield" class="mini-textbox" name="url_textfield"  required="true"></td>
							<td>数值字段:</td>
							<td><input id="url_valuefield" class="mini-textbox" name="url_valuefield" required="true"></td>
						</tr>
						...
						<tr class="selfSQL_row" style="display: none">
						...
						<tr class="selfSQL_row" style="display: none">
							<td>文本字段:</td>
							<td><input id="sql_textfield" name="sql_textfield" class="mini-combobox" style="width: 100px;"  data=""  valueField="fieldName"  textField="comment"  required="true" allowInput="false" enabled="false" /></td>
							<td>数值字段:</td>
							<td><input id="sql_valuefield" name="sql_valuefield" class="mini-combobox" style="width: 100px;" valueField="fieldName"  textField="comment"  value="" required="true" allowInput="false" enabled="false" /></td>
						</tr>
