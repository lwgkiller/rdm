    ...
    $.fn.colorpicker = function(options) {
        ...
        return this.each(function(){
            ...
            obj.bind(opts.event,function(){
                ...
                $("#CT tr td").css("borderColor","#fff");
                $("#CT tr ").find("td:first").css("borderLeftColor","#409EFF");
                $("#CT tr").find("td:last").css("borderRightColor","#409EFF");
                $("#CT tr:last ").find("td").css("borderColor","#409EFF");
        ...
        function initColor(){
            ...
            colorTable='<table width=253 border="0" cellspacing="0" cellpadding="0" style="border:1px solid #409EFF;">'
            +'<tr height=30><td colspan=21 bgcolor=#fff>'
            +'<table cellpadding="0" cellspacing="1" border="0" style="border-collapse: collapse">'
            +'<tr><td width="3"><td><input type="text" id="DisColor" size="6" disabled style="border:solid 1px #ccc;background-color:#ffff00"></td>'
            +'<td width="3"><td style="color: #999;"><input type="text" id="HexColor" size="7" style="border:1px solid #ccc;font-family:Arial;margin-right: 20px;" value="#000000"><a href="javascript:void(0);" id="_cclose" style="color: #f56c6c;">关闭</a> | <a href="javascript:void(0);" id="_creset" style="color: #f56c6c;">清除</a></td></tr></table></td></table>'
            +'<table id="CT" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse;cursor:pointer;" bordercolor="000000"  >'
            +colorTable+'</table>';
