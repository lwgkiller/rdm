				...
				<table class="table-detail column-four table-align" cellspacing="1" cellpadding="1">
					...
					<tr>
						...
						<td colspan="3">
							...
							长：<input id="mwidth" name="mwidth" class="mini-spinner" style="width:80px" value="300" minValue="0" maxValue="1200"/>
							...
							高：<input id="mheight" name="mheight" class="mini-spinner" style="width:80px" value="60" minValue="0" maxValue="1200"/>
