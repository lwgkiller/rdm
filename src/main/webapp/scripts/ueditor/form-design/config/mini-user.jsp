			...
			<form id="miniForm">
				<table class="table-detail column-four table-align" cellspacing="1" cellpadding="1">
					...
					<tr>
						<td>指定用户范围</td>
						<td colspan="3">
						    <span id="orgSpan" >指定用户组:<input id="orgId" name="groupid" class="mini-buttonedit icon-dep-button" style="width:140px;" textField="name" valueField="groupId" required="true"  allowInput="false" onbuttonclick="_DepDlgFromIds(e)"/></span>&nbsp;
							<span id="dimShow">维度：<input class="mini-combobox"  id="initDim" textField="name" valueField="dimId" showNullItem="true" url="${ctxPath}/sys/org/osDimension/getAllDimansion.do" onvaluechanged="listRankLevel" emptyText="默认为全部人员"/></span>&nbsp;
