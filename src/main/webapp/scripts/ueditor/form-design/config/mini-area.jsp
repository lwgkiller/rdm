...
<div class="form-outer">
    <form id="miniForm">
        ...
        <table class="table-detail table-align column_2_m" cellpadding="1" cellspacing="0">
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <div>
                    高：<input id="mheight" name="mheight" class="mini-spinner" style="width:80px" value="34"
...
<script type="text/javascript">
    ...
    function addChidrenNode(keyNameValue,labelValue) {
        ...
        provinceNodeChidren.style.marginRight = 6 +"px";
        ...
        cityNodeChidren.style.marginRight = 6 +"px";
