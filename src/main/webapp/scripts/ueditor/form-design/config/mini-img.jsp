...
<body>
			...
			<form id="miniForm">
					...
					<tr>
						...
						<td colspan="3">
							<div class="mini-radiobuttonlist" repeatItems="5" repeatLayout="table"
								 textField="text" valueField="id" value="false" name="isone"
				...
				<%--	<tr>
						<td colspan="3" style="white-space: normal;text-align: left">
							注意：最好不要给图片设置高度，让它自动以原始比例适应；如果硬要加高度，那么宽高的比例要跟你需要上传的图片的比例一致；
						</td>
					</tr>--%>
				</table>
			</form>
	...
	<script type="text/javascript">
		...
		var oNode = null,
		thePlugins = 'mini-img';
		var imgtype =mini.get('imgtype');
		var imgLengthHide =$('#imgLengthHide');
		imgLengthHide.hide();
		...
		dialog.onok = function (){
			...
			oNode.setAttribute("imgsType",imgtype.getValue());
            if(isCreate){
