 ...
 * 新增或者更新的保存
 */
function saveAts(awardId) {

    var formData = formStandard.getData();

    var formValid = validAtsMessage();
    if (!formValid.result) {
    ...
    if (xhr.upload) {
        ...
        // 开始上传
        xhr.open('POST', jsUseCtxPath + '/zhgl/core/awardTalents/saveAts.do?awardId='+awardId, false);
