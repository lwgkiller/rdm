...
function initZrszChart() {
    ...
    for (var i = 0; i < resultData.length; i++) {
        xAxisData[i] = resultData[i].responsorName;
    ...
    zrszChartOption.series[1].data = seriesData2;
    zrszChartOption.series[2].data = seriesData3;
    zrszChartOption.series[3].data = seriesData4;
    zrszChart.setOption(zrszChartOption);
}


function getZrszData(yearMonth) {
    var resultDate = {};
    $.ajax({
        url: jsUseCtxPath + '/rdmZhgl/core/ndkfjh/plan/reportZrszData.do?yearMonth=' + yearMonth,
        type: 'POST',
        async: false,
