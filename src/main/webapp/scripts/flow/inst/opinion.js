...
function getAttachMents(attachments){
	...
	for(var i=0;i<attachments.length;i++){
		...
		if(("xls"==type ||"xlsx"==type) && !_enable_openOffice){
			aryFile.push("<br><img src='"+__rootPath+"/styles/icons/excel.png' /><a  target='_blank' href='"+__rootPath+"/sys/core/file/download/"+fileId+".do'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
		}else if(("doc"==type||"docx"==type) && !_enable_openOffice){
			aryFile.push("<br><img src='"+__rootPath+"/styles/icons/doc.png' /><a  target='_blank' href='"+__rootPath+"/sys/core/file/download/"+fileId+".do'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
		}else if(("ppt"==type||"pptx"==type) && !_enable_openOffice){
			aryFile.push("<br><img src='"+__rootPath+"/styles/icons/ppt.png' /><a  target='_blank' href='"+__rootPath+"/sys/core/file/download/"+fileId+".do'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
			...
			aryFile.push("<br><img src='"+imgPath+"' /><a target='_blank' href='"+__rootPath+"/sys/core/file/download/"+fileId+".do'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
		}else if("png"==type||"jpg"==type||"gif"==type||"jpeg"==type||"bmp"==type){
			aryFile.push("<br><img src='"+__rootPath+"/styles/icons/picture.png' /><a target='_blank' href='"+__rootPath+"/sys/core/file/download/"+fileId+".do'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
		}else if("txt"==type){
			aryFile.push("<br><img src='"+__rootPath+"/styles/icons/txt.png' /><a target='_blank' href='"+__rootPath+"/sys/core/file/download/"+fileId+".do'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
		}
		else{
			aryFile.push("<br><img src='"+__rootPath+"/styles/icons/file.png' /><a target='_blank' href='"+__rootPath+"/sys/core/file/download/"+fileId+".do'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
		}
