    ...
    getHtml:function(){
        ...
        if(browserType==0){
            html='<object id="'+this.getName()+'_OCX" classid="clsid:A39F1330-3322-4a1d-9BF0-0BA2BB90E970" \
    			codebase="'+__rootPath+'/iWebOffice/OfficeControl.cab#Version=5,0,3,1" width="100%" height="100%">\
            ...
            html='<object id="'+this.getName()+'_OCX" clsid="{A39F1330-3322-4a1d-9BF0-0BA2BB90E970}" \
			 type="application/ntko-plug" codebase="'+__rootPath+'/iWebOffice/OfficeControl.cab#version=5,0,3,1" \
