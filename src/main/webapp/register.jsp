        ...
        <div style="padding:5px;">
            ...
            <table class="table-detail column_2_m" cellspacing="1" cellpadding="0">
                ...
                <tr>
                    <th>公司：</th>
                    <td>
                        <input name="nameCn" class="mini-textbox" required="true" vtype="maxLength:256"
                               emptyText="请输入公司名" style="width:80%"/>
                    </td>
                </tr>
                <tr>
                    <th>手机：</th>
                    <td>
                        <input name="phone" required="true" class="mini-textbox" vtype="float;minLength:11;maxLength:11"
                               style="width:200px"/>
                    </td>
                </tr>
                ...
                <tr>
                    <th>验证码</th>
                    <td>
                        <input name="validCode" class="mini-textbox" id="validCode" vtype="maxLength:4" width="100"
                               required="true"/>
                        <img src="${ctxPath}/captcha-image.do" width="75" height="35" id="kaptchaImage"
                             style="cursor:pointer" onclick="refreshCode()"/>
                    </td>
                </tr>
            </table>
        </div>
