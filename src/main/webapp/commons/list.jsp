...
<link href="${ctxPath}/styles/commons${index}.css?static_res_version=${static_res_version}" rel="stylesheet" type="text/css" />
...
<script src="${ctxPath}/scripts/common/commonTools.js?version=${static_res_version}" type="text/javascript"></script>
<script type="text/javascript" src="${ctxPath}/scripts/i18n/language_${localeLanguage}.js?static_res_version=${static_res_version}"></script>
<script src="${ctxPath}/scripts/mini/miniui/locale/${localeLanguage}.js?static_res_version=${static_res_version}" type="text/javascript"></script>
<script src="${ctxPath}/scripts/mini/fixheight.js?static_res_version=${static_res_version}" type="text/javascript"></script>