...
<link rel="stylesheet" type="text/css" href="${ctxPath}/styles/commons.css?static_res_version=${static_res_version}">
<link rel="stylesheet" type="text/css" href="${ctxPath}/styles/commons${index}.css?static_res_version=${static_res_version}">
...
<script src="${ctxPath}/scripts/index/indexShare.js?static_res_version=${static_res_version}" type="text/javascript"></script>